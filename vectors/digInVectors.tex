...
$\left\langle \cos(\theta),\sin(\theta) \right\rangle$ for some angle $\theta$.

\begin{theorem}
  Unit vectors that make an angle of $\theta$ radians with the $x$-axis are given by
  \[
  {\mathbf{\hat{u}}} = \left\langle \cos(\theta),\sin(\theta) \right\rangle.
  \]
\end{theorem}
...
\begin{example}
  ...
  \begin{explanation}
    ...
    $\left\langle \answer[given]{0},\answer[given]{-50} \right\rangle$.  Let $\overset{\rightharpoonup}{\mathbf{F}}_1$
    ...
    \begin{image}
      ...
      \draw [left] (0,-.5) node {\scriptsize $\overset{\rightharpoonup}{\mathbf{F}}_W = \left\langle 0,-50 \right\rangle$};
    \end{tikzpicture}
  \end{image}
    Thus,
    \[
...
\begin{image}
  ...
  \begin{axis}[
      ...
      %grid = major,
          ...
          \node[above] at (axis cs:2, 1) [penColor] {$\left\langle a,b \right\rangle$};
        \end{axis}
\end{tikzpicture}
\end{image}
