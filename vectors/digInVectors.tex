...
boldface, decorated with a harpoon (like $\vec{v}$ or
$\vec{w}$). Other authors may simply use a boldface (like
...
\begin{example}
  ...
  \begin{explanation}
    ...
    with the horizontal axis, and let $\vec F_2$ represent the force from the
    other chain.
    \begin{image}
      \begin{tikzpicture}
