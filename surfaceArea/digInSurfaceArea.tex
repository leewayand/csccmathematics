...
Consider the surface of revolution found by revolving $f(x) = \sqrt{x}$ from $x=1$ to $x=4$ around the $x$-axis.  We set up an integral with respect to $x$ and an integral with respect to $y$ that gives its surface area.
  ...
  \begin{explanation}
    ...
    \choice[correct]{$ds =  \sqrt{1+\left(\frac{dy}{dx} \right)^2} dx$}
    \choice{$ds =  \sqrt{1+\left(\frac{dx}{dy} \right)^2} dy$}
    \end{multipleChoice}
...
\begin{explanation}
 In order to do this, we choose:
    ...
    \begin{multipleChoice}
    \choice{$ds =  \sqrt{1+\left(\frac{dy}{dx} \right)^2} dx$}
    \choice[correct]{$ds =  \sqrt{1+\left(\frac{dx}{dy} \right)^2} dy$}
    \end{multipleChoice}
