...
\choice{$ \lim_{a \rightarrow 0^+} \int_a^{\infty} \dfrac{17x-12}{(3x+4)(x^2+4)} dx$}
\choice[correct]{$\lim_{b\rightarrow \infty} \int_{0}^{b} \dfrac{17x-12}{(3x+4)(x^2+4)} dx $}
\choice{$ \lim_{a \rightarrow 0^+} \int_a^{1} \dfrac{17x-12}{(3x+4)(x^2+4)} dx+\lim_{b\rightarrow \infty} \int_{1}^{b} \dfrac{17x-12}{(3x+4)(x^2+4)} dx $}
\end{multipleChoice}
