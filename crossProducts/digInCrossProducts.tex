...
\begin{definition}
  Given a $3\times 3$ matrix, the \textbf{determinant} is denoted by the following.
  \[
  \det\begin{bmatrix}
  a_1 &  a_2 & a_3 \\
  b_1 &  b_2 & b_3 \\
...
\begin{image}[3in]
  \begin{tikzpicture}
    ...
    \node at (-.27,-2) {\scalebox{.7}{
        $\begin{bmatrix}
          \boldsymbol{\hat{\imath}} & \bullet & \bullet\\
          \bullet & a_2 & a_3\\
          \bullet & b_2 & b_3
        \end{bmatrix}$}};
    ...
    \node at (1.61,-2) {\scalebox{.7}{
        $\begin{bmatrix}
          \bullet & \boldsymbol{\hat{\jmath}} & \bullet\\
          a_1 & \bullet & a_3\\
          b_1 & \bullet & b_3
        \end{bmatrix}$}};
    ...
    \node at (3.58,-2) {\scalebox{.7}{
        $\begin{bmatrix}
          \bullet & \bullet & \boldsymbol{\hat{k}}\\
          a_1 & a_2 & \bullet\\
          b_1 & b_2 & \bullet
        \end{bmatrix}$}};
  \end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \node at (0,1) {$\boldsymbol{\hat{\imath}}$};
  \node at (-.87,-.5) {$\boldsymbol{\hat{\jmath}}$};
  \node at (.87,-.5) {$\boldsymbol{\hat{k}}$};
\end{tikzpicture}
\end{image}
...
\path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
  (51.2201,166.8365) node[above right] (text4204) {\scalebox{4}{$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}}$}};
\path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
  (89.7117,303.4817) node[above right] (text4208) {\scalebox{4}{$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$}};
\path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
  (364.9268,59.0600) node[above right] (text4212) {\scalebox{4}{$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}} \boldsymbol\times \overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$}};
\end{tikzpicture}
\end{image}
...
\begin{question}
  ...
  \begin{image}
    \begin{tikzpicture}
      \draw[->,ultra thick,penColor] (0,0) -- (5,1);
      \draw[->,ultra thick,penColor2] (0,0) -- (2,3);
      \node[above,penColor] at (2.5,.5) {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}}$}; %% <a,b>
      \node[below right,penColor2] at (1,1.5) {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$}; %% <c,d>
    \end{tikzpicture}
  \end{image}
...
\node[right,penColor] at (axis cs: 1.5,2,1.5) {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}}$};
\node[below,penColor2] at (axis cs: 2,2,1.5) {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$};
\end{axis}
\end{tikzpicture}
  \end{image}
  $|\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}} \boldsymbol\times \overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}|$ computes the area of the parallelogram
  spanned by $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}}$ and $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$.
  \begin{explanation}
  ...
  \draw (.8,0) -- (.8,.2) -- (1,.2);
    ...
    parallelogram. Two vectors $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}}$ and $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$ define a
    parallelogram when drawn from the same initial point, as follows.
    \begin{image}[2in]
  ...
  \node[left,penColor] at (.5,.75) {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{a}}$};
        \node[below,penColor2] at (1,0) {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{b}}$};
      \end{tikzpicture}
    \end{image}
...
\begin{definition}
  The torque $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{t}}$ obtained by applying a force $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{F}}$ to a
  lever arm with position vector $\overset{\boldsymbol{\rightharpoonup}}{\mathbf{r}}$ is given by
  \[
...
\begin{question}
  A pipe of length $3 \mathrm{m}$ has a force of magnitude $2 \mathrm{N}$
  ...
  \begin{image}
    ...
    % grid = major,
        ...
        \node at (axis cs:0.6, 0.7) [penColor] {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{r}}$};
        \node at (axis cs:0.6, 2.4) [penColor2] {$\overset{\boldsymbol{\rightharpoonup}}{\mathbf{F}}$};
      \end{axis}
    \end{tikzpicture}
  \end{image}
...
\begin{itemize}
\item \link[\textit{Matrices and determinants}, J.J.
  O'Connor and E.F.\ Robertson, Mac Tutor History
of Mathematics archive]{http://www-groups.dcs.st-and.ac.uk/history/HistTopics/Matrices_and_determinants.html}.
\item \link[\textit{Cross Products of Vectors in Higher Dimensional Euclidean Spaces},
  W.S.\ Massey, The American Mathematical Monthly, December
  1983]{http://www.jstor.org/discover/10.2307/2323537}.
\end{itemize}
