...
\begin{multipleChoice}
\choice{$\bar{r}(t)=\frac{F(0)-F(t)}{t}\mathrm{gal/m}$}
\choice{$\bar{r}(t)=F(0)-F(t)\mathrm{gal/m}$}
\choice{$\bar{r}(t)=\frac{F(0)}{t}\mathrm{gal/m}$}
\choice{$\bar{r}(t)=\frac{F(t)}{t}\mathrm{gal/m}$}
\choice[correct]{$\bar{r}(t)=\frac{F(t)-F(0)}{t}\mathrm{gal/m}$}
\choice{$\bar{r}(t)=\frac{F(t)}{t}\mathrm{gal/m}$}
\end{multipleChoice}
%% \begin{hint}
...
\begin{multipleChoice}
\choice{$\bar{r}_\Delta(t,\tau)=\frac{F(t)-F(\tau)}{\tau-t}\mathrm{gal/m}$}
\choice{$\bar{r}_\Delta(t,\tau)=F(t)-F(\tau)\mathrm{gal/m}$}
\choice{$\bar{r}_\Delta(t,\tau)=\frac{F(t)}{\tau}\mathrm{gal/m}$}
\choice{$\bar{r}_\Delta(t,\tau)=\frac{F(\tau)}{t}\mathrm{gal/m}$}
\choice[correct]{$\bar{r}_\Delta(t,\tau)=\frac{F(\tau)-F(t)}{\tau-t}\mathrm{gal/m}$}
\choice{$\bar{r}_\Delta(t,\tau)=\frac{F(\tau)}{\tau}\mathrm{gal/m}$}
\end{multipleChoice}
\begin{exercise}
