...
The given rate is
 ...
 \[
 \frac{d\answer{D}}{dt}= 2 \frac{\textrm{units}}{\textrm{s}}.
  \]
  
  The rate to be determined is
  
   \[
 \left[ \frac{d\answer{V}}{dt}\right]_{D=6}
  \]
...
\begin{hint}
  ...
  \[
  \frac{dV}{dt} = \frac{1}{4} \pi D^2 \frac{dD}{dt}.
  \]
\end{hint}
...
\begin{hint}
  ...
  \[
 \Bigl[ \frac{dV}{dt}{t} \Bigr]_{D=6}= \frac{1}{4} \pi (6)^2 (2) = 18\pi\frac{\textrm{units}^3}{\textrm{s}}.
  \]
\end{hint}

\begin{prompt}
  \[
 \Bigl[ \frac{dV}{dt}{t} \Bigr]_{D=6} = \answer{18\pi}\frac{\textrm{units}^3}{\textrm{s}}
  \]
\end{prompt}
