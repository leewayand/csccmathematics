...
\[
1\mathrm{J} = 1\mathrm{kg}\cdot \mathrm{m}^2/\umathrmnit{s}^2 = 1\mathrm{N}\cdot\mathrm{m}. 
\]
...
\begin{question}
  ...
  \begin{selectAll}
    ...
    \choice[correct]{a car applying breaks to come to a stop over a distance of $100\mathrm{ft}$}
...
\begin{image}
  \begin{tikzpicture}[scale=2,every node/.style={transform shape}]
    \node at (0,0) {
      $\color{green!70!black!70!blue}\int_{s_0}^{s_1}\color{purple!50!blue!90!black}F(s) \color{green!70!black!70!blue} ds\color{black} = \color{blue!70!green}\frac{m\cdot v_1^2}{2} - \frac{m\cdot v_0^2}{2}$
      };
  \end{tikzpicture}
\end{image}
