...
\begin{definition}\hfil
  ...
  \begin{itemize}
    ...
    \item $\text{arccot}(x) = \theta$ means that $\cot(\theta) = x$ and
      $0< \theta< \pi$. The domain of $\text{arccot}(x)$ is
      $-\infty<x<\infty$.
    \item $\text{arcsec}(x) = \theta$ means that $\sec(\theta) = x$ and
      $0\le \theta\le \pi$ with $\theta\ne \pi/2$. The domain of
      $\text{arcsec}(x)$ is all $x$ with absolute value greater than $1$.
    \item $\text{arccsc}(x) = \theta$ means that $\csc(\theta) = x$ and
      $-\frac{\pi}{2}\le \theta\le \frac{\pi}{2}$ with $\theta \ne 0$. The
      domain of $\text{arccsc}(x)$ is all $x$ with absolute value greater
      than $1$.
  \end{itemize}
\end{definition}
