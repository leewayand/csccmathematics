...
\begin{warning} \textbf{\textcolor{red!70!black}{Leading Coefficient}}
...
\textbf{Note:} Reasons for each conclusion.  The quickest reason is to cite the category of the function, because we know lots of characteristics for functions in each category.  This makes it very helpful to study categories of functions. 
