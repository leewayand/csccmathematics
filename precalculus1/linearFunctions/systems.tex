...
If you have two linear functions that share a common pair, then they are the same function.
...
\begin{fact} \textbf{\textcolor{red!75!green!50}{Replacement}} 
...
\begin{fact} \textbf{\textcolor{red!75!green!50}{Operations}} 
...
Then we have $2A = 3B + 5$. We can multiply both sides by $\answer{2}$ to get $4 A = 6 B + 10$.  \\
