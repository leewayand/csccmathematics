...
We might collect some linear equations and group them together. This collection is called a \textbf{system of linear equations}. And, as above, we might lok for common solutions.  The process of looking for common solutions is called \textit{solving the system}.
...
We can subtract $6y$ from both sides and subtract $\answer{11}$ from both sides
...
Our common solution to the two original equations is $x = 2$ and $y = 1$.  You you graphed the two lines, then $(2, 1)$ would be the intersection point.
