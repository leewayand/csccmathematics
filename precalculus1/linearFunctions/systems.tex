...
That is \textbf{\textcolor{purple!85!blue}{RIGOR}}.  
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Proof}} 
...
For EVERY possibility, either $m_1 \ne m_2$ or $m_1 = m_2$.  \\
These two ``cases'' account for EVERYTHING.
...
If the rates of change are equal, then  $m_1 - m_2 = 0$.
...
As a consequence, if you have two lines and you know they share two points, then they must share all of their points and they must be the same function.   

This is why we only need two points to draw a line.


If you have two linear functions that share two common pairs, then they are the same linear function.
...
We might collect some linear equations and group them together. This collection is called a \textbf{system of linear equations}. And, as above, we might look for common solutions to all of the equations.  The process of looking for common solutions is called \textit{solving the system}.
...
\begin{fact} \textbf{\textcolor{red!75!green}{Replacement}} 
...
\begin{fact} \textbf{\textcolor{red!75!green}{Operations}} 
...
We can multiply both sides of $2A = 3B + 5$ by $\answer{2}$ to get $4 A = 6 B + 10$.  

$2 A = 3 B + 5$ and $4 A = 6 B + 10$ are equivalent equations. 
...
We now have two expressions both equal to $4A$, then they must be equal.


\[   6 B + 10 =  \answer{7 B + 11}   \]
...
We now know that $B = -1$ and we know that $4 A = 7 B + 11$.  That tell us that 
