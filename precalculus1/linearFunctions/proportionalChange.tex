...
There are many examples of relationships between measurements that exhibit proportional changes.  
...
Two measurements share a \textbf{constant rate of change} of $\tfrac{A}{B}$ if whenever measurement \#1 changes by $B$, then measurement \#2 changes by $A$ and vice versa, and this rate is not dependent on the amount of each measurement present.  The rate is the same throughout the situation.  It is a constant.
