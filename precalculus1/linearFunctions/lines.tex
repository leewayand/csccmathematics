...
\begin{itemize}
\item You might know the domain number and you are looking for its function value. This is called evaluation and we use function notation for it.
...
\begin{itemize}
\item The $y$-axis is now the vertical axis.
\item The $t$-axis is now the horizontal axis.
\end{itemize}
...
\begin{itemize}
\item The $t$-axis is now the vertical axis.
\item The $y$-axis is now the horizontal axis.
\end{itemize}


In either case, the function formula matches the ``$y = m \, x + b$'' template.  

$\answer{m}$ is the slope of the line as well as the rate of change of the function.
