...
Consider the linear equation  $3 x + 2 y = 12$.


Let's select $x$ to be the first variable and $y$ the second variable.

With this agreement, $(4, 0)$ is a solution to the equation.   $(4,0)$ can be viewed as a point and poltted as a dot.
...
In the example above, $3 x + 2 y = 12$ can be rewritten as $y = \answer{\frac{-3}{2}} x + \answer{6}$.
...
We could just as easily have chosen $y$ as the domain variable and $x$ as the function variable.  In this case, $3 x + 2 y = 12$ can be rewritten as $x = \answer{\frac{-2}{3}} y + \answer{4}$.  We might write this as $x(y) = \tfrac{-2}{3} y + 4$
