...
Vertical lines do not have slope. The formula for slope looks like $\frac{r}{0}$.


Since, the graph is vertical, there are points with the same horizontal coordinate but different vertical coordinates. Interpreting this into function language, we have a domain number with multiple function values. This is not allowed for functions.
