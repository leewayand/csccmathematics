...
Since $5$ is the only root of $K(t)$, we know that $(\answer{5}, \answer{0})$ is the only $t$-intercept of the corresponding line.  In either form, the coefficient of $t$ is $\answer{3}$, the rate of change of $K$ and the slope of the line.
