...
If we had the derivative, then we could identify this critical number exactly. But we can use a method seen earlier to algebraically discover this critical number.
