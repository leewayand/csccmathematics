...
The graph will have vertical asymptotes $f=-5$ and $f=-2$.  $B$ will change signs over $f=-5$, since the multiplicity is \wordChoice{\choice[correct]{odd} \choice{even}} .  $B$ will not change signs over $f=2$, since the multiplicity is \wordChoice{\choice{odd} \choice[correct]{even}}.

$B$ is a rational function and the dergee of the denominator is \wordChoice{\choice[correct]{greater than} \choice{less than}} the degree of the numerator. Therefore, 
