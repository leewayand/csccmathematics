...
Rational functions combine all power functions together, whereas polynomials only combined those power funcitons with positive powers.  We can pull $H(w)$ apart to see the power functions.


\[    H(w) = \frac{(w-1)}{(w+3) (w-4)}  = \frac{4}{7} \frac{1}{w+3}  + \frac{3}{7} \frac{1}{w-4}    \]
