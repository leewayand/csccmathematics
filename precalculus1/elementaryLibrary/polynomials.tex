...
$\blacktriangleright$ Polynomials are sums of special power functions, so let's begin with power functions.
...
\textbf{Pronounced:} \textit{The limit of $k \, x^p$ as x tends towards infinity equals zero}.
...
\textbf{Pronounced:} \textit{The limit of $k \, x^p$ as x tends towards negative infinity equals zero}.
...
\textbf{Pronounced:} \textit{The limit of $k \, x^p$ as x tends towards zero from the left equals negative infinity}.
