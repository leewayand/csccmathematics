...
While polynomials and rational functions only deal with positive powers on their terms, we have seen that power functions, by themselves, include any real number power.  The noninteger powers belong to a category called \textbf{roots and radicals}.



\begin{definition} \textit{Roots}
...
\begin{definition} \textit{Radicals}
...
Negative numbers raised to even powers result in positive numbers, like positive numbers raised to even power.  This makes going backwards a problem.  We are forces to choose between two even roots.  We pick positive numbers  The domain and range of even roots are both $[0, \infty)$.
