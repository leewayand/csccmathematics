...
The absolute value function, $|x|$, gives the distance between a number, $x$, and $0$.  Since distance cannot be naegative, it appears that the function just "makes numbers positive".
...
Technically speaking, $|-3| = -(-3)$ and then $-(-3) = 3$.  The absolute value function negatives negative numbers.
