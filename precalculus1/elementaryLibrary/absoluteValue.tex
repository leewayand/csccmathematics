...
The absolute value function, $|x|$, gives the distance between a number and $0$.  Since distance cannot be naegative, it appears that the function just "makes numbers positive".
...
Technically speaking, $|-3| = -(-3)$ and then $-(-3) = 3$.  The absolute value function nnegatives negative numbers.


\textbf{Note:} just becasue you see a negaitve sign doesn't mean you have a negative number.
