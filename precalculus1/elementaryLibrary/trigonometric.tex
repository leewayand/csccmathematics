...
Cosine is a function of $\theta$. The value of the cosine function is the horizontal coordinate of the point on the unit circle at the given angle, $\theta$. The shorthand for this function looks like $cos(\theta)$. When we graph the cosine function the horizontal axis is measuring the angle $\theta$, since that is the domain of cosine.
