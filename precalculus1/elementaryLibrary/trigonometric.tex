...
Cosine is a function of $\theta$. The shorthand for this function loks like $cos(\theta)$. When we graph the cosine function the horizontal axis is measuring the angle $\theta$, since that is the domain of cosine.
...
The unit circle is dexcribed bythe equaiton $x^2 + y^2 = 1$.  From this we can calculate a few more values of sine and cosine.
...
If both coordinates are equal, then our circle equaiton gives us 
