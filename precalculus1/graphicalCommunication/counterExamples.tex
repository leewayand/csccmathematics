...
In the example above, $f(1) = -1$ is not the counterexample. Just the domain number $1$ is the counterexample.

The counterexample is a a single item from the set under consideration that shows the statement is false. 


In the example above, $1$ is the counterexample, because $f(1) = -1$.
