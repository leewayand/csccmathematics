...
The IF-THEN statement claims that if all of the assumptions are true, then it is automatically true that the consequence is also true.
...
The IF-THEN statement could be true or false.
...
Claim: If the domain of a function is $(-\infty, \infty)$, then the function is contiuous.
