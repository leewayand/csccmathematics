...
We know the author of the graph knows that these symbols are not optional. So, when the symbols are missing, then we know that was intentional.  The missing symbol communicates infomration about the function.
