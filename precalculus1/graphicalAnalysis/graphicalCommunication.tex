...
We use big solid dots (discs) to illustrate an endpoint is a part of the drawing. We use big hollow dots (circles) when the actual last point is not included. 
