...
The arrows tell the reader that the curve continues its current pattern of a line indefinitely.  The domain is $(-\infty, \infty)$.
...
Arrows at the ends of curves signal that the curve continues with its current pattern. However, this may not not be enough.  Many functions have curves that continue moving up and to the right, however, their movement to the right has a boundary. We use dashed lines to indicate that a curve is approaching this line pattern - getting closer
...
The arrows tell the reader that the curve continues its current pattern, for example the right piece of the curve continues to move up and to the left.  The dashed asymptote tells us that the leftward movement does not go past $3$.  The curve continues to go up indefinitely while getting closer and closer to the asyptte, without hitting the asymptote. 
