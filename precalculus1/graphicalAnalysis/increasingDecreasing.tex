...
\begin{itemize}
\item $g$ is decreasing on the interval $(-8,-3)$.  
\item $g$ is increasing on the interval $[-1,3)$. 
\item $g$ is decreasing on the interval $[4, 8)$. 
\end{itemize}
\end{example}


Of course, in the example above, $g$ is decreasing on any subinterval of $(-8,-3)$. 
...
A \textbf{counterexample} is one example where all of the conditions of a stement are met, yet the conclusion is not true.  One single  counterexample shows a stetment to be false.
