...
We use functions to compare information(measurements). One aspect we are interest in is how one measurement changes compared to the other. 
...
The function $f$ increases on the set $S$, if for EVERY pair of numbers such that $a < b$ in $S$, we have  $f(a) < f(b)$. \\
