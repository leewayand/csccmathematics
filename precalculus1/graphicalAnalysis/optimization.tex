...
\begin{itemize}
\item $f(c)$ is a \textbf{local maximum value} of the function $f$ if there exists an $0 < \epsilon$ such that $f(x) \leq f(c)$ for all domain numbers, $x$, within a distance of $\epsilon$ of $c$. 
...
\item $f(c)$ is a \textbf{local minimu value} of the function $f$ if there exists an $0 < \epsilon$ such that $f(c) \leq f(x)$ for all domain numbers, $x$, within a distance of $\epsilon$ of $c$. 
...
Let $0 < \epsilon = 0.3$.  $g(0.9) \leq g(k)$ for all $k$ in the domain within a distance of $0.3$ of $0.9$, which would be the interval $(\answer{0.6}, \answer{1.2})$.

Let $0 < \epsilon = 0.4$.  $g(k) \leq g(-4.9)$ for all $k$ in the domain within a distance of $0.4$ of $-4.9$, which would be the interval $(\answer{-5.3}, \answer{-4.6})$.

Let $0 < \epsilon = 0.5$.  $g(-8) \leq g(k)$ for all $k$ in the domain within a distance of $0.5$ of $-8$, which would be the interval $[\answer{-8}, \answer{-7.5})$.
...
Let $0 < \epsilon = 0.6$.  $B(1.4) \leq B(w)$ for all $w$ in the domain within a distance of $\answer{0.6}$ of $\answer{1.4}$, which would be the interval $(0.8, 2)$.

Let $0 < \epsilon = 0.25$.  $B(-5.9) \leq B(w)$ for all $w$ in the domain within a distance of $\answer{0.25}$ of $\answer{-5.9}$, which would be the interval $(0.6, 1.2)$.

Let $0 < \epsilon = 0.5$.  $B(w) \leq B(-3)$ for all $w$ in the domain within a distance of $\answer{0.5}$ of $\answer{-3}$, which would be the interval $(-3.5, -2.5)$.
