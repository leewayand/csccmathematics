...
Questions express our curiosity into the structure of how collections of things are connected. Our mathematical word for these connected collections is a \textbf{relation}. \\
...
\begin{example} \textbf{\textcolor{gray!90}{Examples}} \\

This text presents many examples.  However, many more examples can be found on the \link[Examples Page]{https://ximera.osu.edu/csccmathematics/precalculus1/precalculus1/relations/examples/exampleList}.

\end{example}



\begin{summary} \textbf{\textcolor{blue!75!black}{More Examples}} \\
