...
All of these questions assume the same structure.  Questions assume there are two sets or collections of things and that the items in each set are connected or associated with one another.
