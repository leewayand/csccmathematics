...
\begin{itemize}
\item \textbf{[Type 1]} You know the domain item and want the corresponding codomain items.
\item \textbf{[Type 2]} You know the codomain item and want the corresponding domain items.
\end{itemize}
...
\begin{question}
\textbf{Question Type 1 :} What are Linda's favorite flavors? 
...
\begin{question}
\textbf{Question Type 2 :} Whose favorite flavor is Chocolate? 
