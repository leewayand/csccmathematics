...
The idea is for mathematics to describe how we view the world, so we would like to give relations the characteristic of order. Therefore, relations come prepackaged with a feeling that the information is connected \textbf{\textcolor{purple!85!blue}{from}} the domain \textbf{\textcolor{purple!85!blue}{to}} the codomain.
...
Parentheses are useful for describing domain and codomain pairings.  
...
The idea is that we will be investigating our world and discovering structure.  The structure probably is a connection between two measurements. Relations are our way of \textbf{\textcolor{blue!55!black}{modeling}} this connection.

We then use the relation model to think about the connection.  We draw conclusions about the relation model. These conclusions are structure about the relation model, inside mathematics.
