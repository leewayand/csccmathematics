...
These three sets packaged together make up a relation. 
...
\begin{template} \textbf{\textcolor{purple!65!blue}{Ordered Pairs}}  
...
\begin{warning} \textbf{\textcolor{red!70!black}{Did You Notice?}}  
\begin{itemize}
...
This would translate into each domain member is always connected to a \textbf{\textcolor{purple!85!blue}{single}} codomain member.
