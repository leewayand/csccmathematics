...
Relations are just about the vaguest, thinnest structure any two sets could possibly have. \\
...
Which item(s) from the codomain is(are) paired with 'The Fly', from this domain?
...
Which item(s) from the domain is(are) paired with 'Al Pacino', from this codomain?
\begin{multipleChoice}
	\choice{Casablanca}
	\choice{House of Wax}
...
Of course, we will have many relations, which could get confusing.  Let's help ourselves out with names.  The name of the relation above will be \textit{AppearedIn}.


\begin{example} The \textit{AppearedIn} Relation\\
\begin{itemize}
