...
\begin{center}
\textbf{\textcolor{green!50!black}{>>>>>=-=-=-=-=-=-=-=-=-=-=-=-=ooooo=-=-=-=-=-=-=-=-=-=-=-=-=<<<<<}} \\

More examples can be found by following this link\\ \link[Section Examples Page]{https://ximera.osu.edu/csccmathematics/precalculus1/precalculus1/relations/examples/exampleList}
