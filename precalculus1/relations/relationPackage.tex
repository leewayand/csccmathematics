...
The idea is for mathematics to describe how we view the world, so we give relations an ordering characteristic.
...
This text presents many examples.  However, many more examples for this section can be found on the \link[Section Examples Page]{https://ximera.osu.edu/csccmathematics/precalculus1/precalculus1/relations/examples/exampleList}.
