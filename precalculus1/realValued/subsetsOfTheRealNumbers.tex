...
We have whittled our investigation down to a study of real-valued functions.  These are functions whose domain and range are both subsets of the real numbers.  Basically, \textbf{Precalculus 1} is a study of the real numbers.
...
\begin{itemize}
\item For finite intervals, write the two numbers in the order they would occur on the number line, separated by a comma.  These are called \textbf{endpoints} of the intervals.
