...
We will reserve the word ``point'' for graphical descriptions and ``number'' for algebraic communication.
...
\begin{question}
WWhich is a valid statement?
    \begin{multipleChoice}
    \choice {$-3 \in [1, \infty]$}
    \choice [correct]{$3 \in [1, \infty)$}
    \end{multipleChoice}
\end{question}
...
Select all valid statements.
    ...
    \choice [correct]{$-5 \in (-\infty, -4]$}
    \choice {$10 \in [-\infty, 7)$}
