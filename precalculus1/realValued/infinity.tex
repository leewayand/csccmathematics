...
\[ \infty \notin \mathbb{R} \]
\textbf{\textcolor{red!70!black}{Infinity is not a real number.}}
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$ }} You \textbf{\textcolor{red!70!black}{CANNOT}} perform arithmetic with $\infty$.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$ }} You \textbf{\textcolor{red!70!black}{CANNOT}} form fractions with $\infty$.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$ }} You \textbf{\textcolor{red!70!black}{CANNOT}} evaluate functions at $\infty$.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$ }} $\infty$ \textbf{\textcolor{red!70!black}{CANNOT}} be a function value.
...
\begin{definition} \textbf{\textcolor{green!50!black}{$\infty$}}
...
However, for us, it is shorthand communication that describes the \textbf{SIZE} of a set we are analyzing or the \textbf{SIZES} of values inside the set we are analyzing.
...
\begin{example} Using $\infty$ in interval notation


\begin{itemize}
\item The interval $(5, \infty)$ describes the set of all real numbers greater than $5$.  \\
$\infty$ tells us that there is no number greater than all of the numbers in this set.



\item The interval $(-\infty, 4)$ describes the set of all real numbers less than $4$.  \\
$-\infty$ tells us that there is no number less than all of the numbers in this set.
\end{itemize}
...
With functions, we will investigate the relationships between sets of information (domain and range).  We will be particularly interested in how the values of the function change in the range compared to how domain values change. 

One aspect of this is how the function values change as the domain values become unbounded and ``approach'' $\infty$ or `tend'' $\infty$. 

We will need language to talk algebaically and rigorously about $\infty$. We have such language.  


Our mathematical language is called \textbf{\textcolor{purple!85!blue}{limits}} and we will use limits extensively to communicate about unbounded situations.  
