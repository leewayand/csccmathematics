...
\textbf{Fractions} are notational packages.  We use them to communicate.
...
All of the representations for $1$ follow the same pattern - both the numerator and the denominator are the same nonzero number. 
