...
We have two symbols from the Greek  language that we traditionally use to mean ``a small number''. \\
...
$\epsilon$ and $\delta$ are used to mean ``a very small number''. \\  
...
$\epsilon$ and $\delta$ are used to represent very small numbers, but not specific small numbers. \\


So, $\epsilon$ and $\delta$ are used as constants - small constants.
