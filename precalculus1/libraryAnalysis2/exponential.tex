...
\begin{example} Exponential Function Analysis
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth,samples=200,domain=(-1.2:9),<->] {0.2*(0.333)^(-2*x+1)};
          \addplot [line width=1, gray, dashed,domain=(-9:9),<->] ({x},{0});
...
\textbf{Domain:}  The domain of every exponential funciton is $(-\infty, \infty )$.
...
\textbf{End-Behavior:} Exponential functions approach $0$ in the direction that makes the exponent negative. Here, the exponenti is $-2x+1$, which is become negative in the positive $x$-direction. 
...
\textbf{Behavior:} Exponential functions are either increasing or decreasing functions.  The end-behavior shows us that $f$ is decreasing.
...
\begin{itemize}
\item Let $E(t) = 3^t$, an increasing Core exponential function.
\item Let $L_{in}(u) = -2 \, u + 1 $, a decreasing linear function.
\item Let $L_{out}(v) = \frac{1}{5} \, v$, an increasing linear function.
\end{itemize}
...
\textbf{Global Maximum and Minimum:} Exponential functions do not have a global minimum or maximum.




\textbf{Local Maximums and Minimums:} Exponential functions do not have local minimums or maximums.


\textbf{Range:} The sign of the leading coefficient tells us that the range is $(0, \infty)$.
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth,samples=200,domain=(-9:2.5),<->] {-2*(0.666)^(-3*x+4)};
          \addplot [line width=1, gray, dashed,domain=(-9:9),<->] ({x},{0});
...
\begin{itemize}
\item Let $E(t) = \left( \frac{2}{3} \right)^t$, a decreasing Core exponential function.
\item Let $L_{in}(u) = -3u+4 $, a decreasing linear function.
\item Let $L_{out}(v) = -2 \, v $, a decreasing linear function.
\end{itemize}
...
\textbf{Range:} The sign of the leading coefficient tells us that the range is $(-\infty, 0)$.
...
\begin{summary}\textbf{\textcolor{red!70!yellow}{Exponential Analysis}}
...
\textbf{End-Behavior:} In one direction, exponential functions become unbounded. In the other direction, exponential functions tend to $0$.


When the base is greater than $1$,
\begin{itemize}
\item In the domain, when you move in the direction that makes the exponent unbounded negative, the function tends to $0$.
...
\item In the domain, when you move in the direction that makes the exponent unbounded positive, the function tends to $0$.
\end{itemize}




\textbf{Behavior (Increasing and Decreasing):} Exponential functions are either increasing or they are decreasing.

The Chain Rule can tell you which.

\textbf{Global Maximum and Minimum:}  Exponential functions do not have a global maximum or global minimum.

\textbf{Local Maximums and Minimums:} Exponential functions do not have local maximums or minimums.

\textbf{Range:} The range of an exponential function is either $(-\infty, 0)$ or it is $(0, \infty)$.
