...
\begin{itemize}
\item Let $E(t) = r^t$ be a core exponential function.
...
\textbf{End-Behavior:} Exponential functions approach $0$ in the direction that makes the exponent negative. Here, the exponent is $-2x+1$, which becomes negative in the positive $x$-direction. 
