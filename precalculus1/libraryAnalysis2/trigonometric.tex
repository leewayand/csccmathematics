...
\begin{summary}\textbf{\textcolor{red!70!yellow}{Core Sine Analysis}}
...
\textbf{Local Maximums and Minimums:}  The global maximum and minimum are the obly local extrema.




\textbf{Range:} The range of the Core sine funciton is $[-1, 1]$.
