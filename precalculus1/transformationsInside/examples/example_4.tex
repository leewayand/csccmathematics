...
Suppose the function $p$ is defined through the equation $B(w) = V\left( \frac{w}{2} \right)$. \\


What is the induced domain of $B$?



\[
\left[ \answer{-12}, \answer{-4} \right] \cup  \left( \answer{-4}, \answer{8} \right]  \cup \left( \answer{8}, \answer{12} \right)
\]
