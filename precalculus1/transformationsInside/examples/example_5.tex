...
Suppose the function $p$ is defined through the equation $f(x) = V\left( \frac{1}{3} x + 1 \right)$. \\


What is the induced domain of $f$?



\[
\left[ \answer{-21}, \answer{-9} \right] \cup  \left( \answer{-9}, \answer{9} \right]  \cup \left( \answer{9}, \answer{15} \right)
\]
