...
Suppose the function $T$ is defined through the equation $T(k) = V(k-2)$. \\
...
\[
\left[ \answer{-4}, \answer{0} \right] \cup  \left( \answer{0}, \answer{6} \right]  \cup \left( \answer{6}, \answer{8} \right)
\]
