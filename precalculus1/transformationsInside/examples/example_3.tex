...
Suppose the function $p$ is defined through the equation $p(m) = V(m+5)$. \\


What is the induced domain of $p$?



\[
\left[ \answer{-11}, \answer{-7} \right] \cup  \left( \answer{-7}, \answer{-1} \right]  \cup \left( \answer{-1}, \answer{1} \right)
\]
