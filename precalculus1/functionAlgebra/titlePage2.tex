...
The identity is extremely important for each operation.  The identity can be viewed as the center of the operational structure.  We like to know how to move from it and move toward it with the operation.  Pairs of items which produce the identity are called \textbf{\textcolor{purple!85!blue}{inverses}}.
