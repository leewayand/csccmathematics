...
With this restriction, the inverse of sine is called \textbf{arcsine}, abbreviated \textbf{arcsin}.  Of course you can also use the general inverse notation: $sin^{-1}(x)$.
...
$\blacktriangleright$  The domain of $arcsin(y)$ is $[-1,1]$, but the range is $\left[ -\frac{\pi}{2}, \frac{\pi}{2} \right]$.
...
With this restriction, the inverse of sine is called \textbf{arccosine}, abbreviated \textbf{arccos}.  Of course you can also use the general inverse notation: $cos^{-1}(x)$.


\begin{itemize}
\item The domain of arccosine is $[0, 1]$.  
...
With this restriction, the inverse of tangent is called \textbf{arctangent}, abbreviated \textbf{arctan}.  Of course you can also use the general inverse notation: $tan^{-1}(x)$.
