...
With this restriction, the inverse of cosine is called \textbf{arccosine}, abbreviated \textbf{arccos}.  Of course you can also use the general inverse notation: $cos^{-1}(x)$.
