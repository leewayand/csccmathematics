...
If you think of a number line, then you start at the domain number and move down (or left) until you arrive at an integer.  If your domain number is already an integer, then you don't need to go anywhere.
...
Graph of $y = \lfloor x\rfloor$ is below, except the steps keep going up to the right and down to the left.  The extra 3 dots are a graphical symbol telling us that the pattern continues.
\begin{image}
\begin{tikzpicture}
  \begin{axis}[
            domain=-3:5,
