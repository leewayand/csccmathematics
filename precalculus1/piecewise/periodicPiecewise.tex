...
Different sawtooth functions are made by varying the height and width of the tooth.  The single tooth that was repeated is called the \textbf{wave} of the periodic function.  The width of the wave is called the \textbf{period}. And, the height of the wave is called the \textbf{amplitude}.
...
Therefore, we only need memorize the numbers in the first quadrant and then move them around the circle with the appropriate signs.
