...
Sawtooth functions are piecewise defined functions but there is really one pieces that just repeats.  We would like to express this idea in a formula. We define a formula for the initial piece and then state the period.
