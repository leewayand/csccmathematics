...
We are tracining individual domain numbers through functions as our first look into function composition.  When there is only one formula, then following the trail requires no decisions.  Now we turn to piecewise defined functions where we need to pick the appropriate formula.
