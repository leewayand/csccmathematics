...
We are tracing individual domain numbers through function chains to help us think about function composition.  When each function uses only one formula, then following the trail requires no decisions.  Now we turn to piecewise defined functions where we need to pick the appropriate formula.
