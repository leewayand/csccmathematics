...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor2, smooth, samples=200, domain=(-9:9),<->] {4*(x^2)*sin(deg(x-4))*2.7^(-(0.35*x)^2)+3};
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth, samples=200, domain=(-9.4:9.5),<->] {0.05*(x+6)*(x+1)*(x-5)*cos(deg(0.5*x))+3};
