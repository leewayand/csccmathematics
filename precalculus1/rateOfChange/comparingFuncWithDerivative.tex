...
We can decide the same thing about functions, by using the slopes of tangent lines.


\begin{quote}

If the graph of the function $f$ has tangent lines with greater slopes than tangent lines on the graph of the function $g$, then the graph of $f$ rises faster than the graph of $g$.
