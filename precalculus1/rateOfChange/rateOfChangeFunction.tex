...
This rate-of-change is the \textbf{constant} rate-of-change that would be needed in order to get from one endpoint of the interval to the other.  Of course, we can see from the graph that the  rate-of-change really varies over the interval. 
...
A tangent line to a graph at a point, is first a line. Second it intersects the graph at the given point. Third, it does the best job of pretending to be the graph at that point. \\




If you zoom in on the intersection point, then parabola will slowwly appear to become a line. The tangent line is the line the graph is becoming. 
...
If we make a really small interval at $-3$, then the slope of the secant line should give an even better approximation for the slope of the tangent line.
...
This function whose values are the rates-of-change of another function is called the \textbf{derivative} of the other function, because it was derived from it.
...
Through the slope of the tangent line, we have invented a way of talking about the \textbf{\textcolor{purple!85!blue}{instantaneous rate of change}} of a function at a number. \\
