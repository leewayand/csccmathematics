...
A tangent line to a graph at a point, is first a line. Second it intersects the graph at a given point, called the \textbf{point of tangency} or the \textbf{tangent point}. Third, it does the best job of pretending to be the graph \textbf{\textcolor{red!90!darkgray}{at that point}}. \\
