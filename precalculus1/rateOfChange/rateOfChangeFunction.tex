...
This rate-of-change is the constant rate-of-change that is needed in order to get from one endpoint of the interval to the other.  Of course, we can see from the graph that the rate-of-change does indeed change over the interval. 
