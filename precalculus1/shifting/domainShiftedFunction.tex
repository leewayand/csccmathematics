...
Let's create a new function called, $B(k)$. This is a new function we are creating, but its definition is based on $T(v)$.
...
In $T(k + 3)$,  $k+3$ is representing the domain values of $T$.  \\
...
But, the structure of the function hasn't changed.  The same type of formulas are in use.  
...
The individual maximal intervals become $[-5, -1]$, $\left(\answer{-1}, \answer{5}\right]$, and $[5, 7)$.
...
Let $g(w)$ be defined as a shifted domain version of $P(t)$.  

The domain of $g(w)$ is $[-7, -3) \cup \{ -2 \} \cup [0,7) \cup (8, 11] \cup \{ 12 \} \cup [13, 14)$.
