...
$k$ must be in a similar set, but shifted to the left by $3$, becasue we need to subtract $3$ from $k+3$ to get $k$.


\[     k \in      (-7,\answer{-4}] \cup [\answer{-2},4)     \]
...
\item When $k \in (-7,-4]$, then $k+3 \in \left(\answer{-4},\answer{-1}\right]$.  $v=k+3$, so $v \in \left(\answer{-4},\answer{-1}\right]$ and we are using the formula $2v-1$ with $v=k+3$. 

All together, when $k \in (-7,-4]$, then $B(k) = 2(k+3)-1 = \answer{2k+5}$.

\item When $k \in [-2,4)$, then $k+3 \in \left[\answer{1},\answer{7}\right)$.  $v=k+3$, so $v \in \left[\answer{1},\answer{7}\right)$ and we are using the formula $-v+3$ with $v=k+3$.

All together, when $k \in [-2,4)$, then $B(k) = -(k+3)+3 = \answer{-k}$.
...
However, $x$ represents the domain values of $f$.   If $x - 1 \in [-6, 6)$, then $x \in \left[\answer{-5}, \answer{7}\right)$.  This is the domain for $f$.  It is shifted up $1$ or to the right $1$ from the domain of $V$.  The individual maximal intervals become $[-5, -1]$, $\left(\answer{-1}, \answer{5}\right]$, and $[5, 7)$.
...
Then,  $w = \answer{t+4}$ \, \text{ and } \, $t = \answer{w-4}$.  \\
