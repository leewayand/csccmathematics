...
$\blacktriangleright$ \textbf{Arithmetic:} A new function can be created as the sum, difference, product, quotient, or composition of two known functions. 

$\blacktriangleright$ \textbf{Inverse:} A new function can be created by reversing all of the pairs. 
