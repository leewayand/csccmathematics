...
Now we can approximate $C(x) \approx approxC(x) = 17.132(x-6.8)+5.359$ on $(6.6, 7.0)$.  That would save a lot of time and energy and not give up too much accuracy - as long as we stay in this interval.
...
\item $p(-1) = 6$ and $p'(-1) = 2$ give $\answer{2(x+1)+6}$
