...
The horizontal asymptote is communicating end-behavior.  It is tells us that as we move further out the domain, onm either side, the function approaches the value $2$.
...
The graph of $H$ does not have horizontal asymptote.  That is meaningful.  The fact that the horizontal asymptote is not included in the drawing tells us thatthe function does not settle down, getting closer to $2$.  Otherwise, there would have been a horizontal asymptote.\\
...
The graphs suggests that this unbounded growth might be very slow, but $H$ becomes unbounded.
...
$K$ does not have an end-bhavior as the domain moves towards $-\infty$, because the domain doesn't move towards $-\infty$.
