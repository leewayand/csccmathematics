...
This settled down pattern in the tails is called the \textbf{\textcolor{blue!55!black}{end-behavior}} of the function. \\
...
The horizontal asymptote is communicating end-behavior.  It is tells us that as we move further out the domain, one either side, the function approaches the value $2$.
