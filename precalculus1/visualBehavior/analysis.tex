...
For us, just starting out, the domain is a description of all real numbers that have been paired with a function value (another real number). 
...
We prefer domains to be described with interval notation.
...
Our language for describing end-behavior will be called \bftext{limits}.
...
We prefer the range to be described with interval notation.
