...
We will being with the idea that contunuity is where there are no discontinuities or singularities.  Later, in Calculus, we will work on better language to describe continuity.
...
\begin{explanation}  \textbf{\textcolor{red!75!green}{Discontinuities and Singularities}} 
...
Singularities are non-domain numbers around which the function is behaving ``weird'' or ``missing'' domain numbers.   


We will need to invent some language to describe this ``weird'' behavior.  Our language will be called \bftext{limits}.
...
\begin{explanation}  \textbf{\textcolor{red!75!green}{Extrema}} 
