...
Linear functions have a special property that other functions do not have.  No matter what interval you select, the rate of change over that interval is always the same. 
...
We will use this fact to help us understand how function values change for any function.
