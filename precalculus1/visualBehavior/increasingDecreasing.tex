...
\textbf{Note:} You cannot merely test the endpoints of an interval to show a function is increasing.  It has to increase for EVERY pair of numbers in the set.
...
\textbf{Note:} You cannot merely test the endpoints of an interval to show a function is decreasing.  It has to decrease for EVERY pair of numbers in the interval. 
