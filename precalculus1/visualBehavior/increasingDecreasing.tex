...
\begin{itemize}
    \item If the function values become greater as we step forwards through the domain numbers, then we say the function \textbf{increases}.  
    \item If the function values become lesser as we step forwards through the domain numbers, then we say the function \textbf{decreases}.  
\end{itemize}
...
\begin{itemize}
    \item If the function values become greater as we step backwards through the domain numbers, then we say the function \textbf{decreases}.  
    \item If the function values become lesser as we step backwards through the domain numbers, then we say the function \textbf{increases}.  
\end{itemize}
