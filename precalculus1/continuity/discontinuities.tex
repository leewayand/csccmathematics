...
Secondly, for \textbf{\textcolor{purple!85!blue}{all}} domain numbers close to $5$, the function values are not \textbf{\textcolor{purple!85!blue}{all}} close to $f(5)$. There is empty space between the function value at the discontinuity and \textbf{\textcolor{purple!85!blue}{some}} of the surrounding function values - \textbf{\textcolor{red!70!black}{no matter how close you get to the discontinuity in the domain}}. 


In the function above, no matter how close you get to $5$ in the domain, where $f$ has the value $4$, there are still domain numbers very close to $5$ where $f$ has values around $6$, not $4$. You cannot get close enough to $5$ in the domain to get away from function values around $6$.
...
No matter how close you get to $5$, no matter how small you select $\delta$, the open interval $(5 - \delta, 5 + \delta)$ contains the domain number $5-\frac{\delta}{2}$, where the function $f$ has a value outside $(3.5, 4.5)$.
...
$T$ is $0$ everywhere, except at reciprocals of natural numbers.

$0$ is not a natural number, so $T(0)=0$. However, the reciprocals of natural numbers get as closer to $0$ than any distance you can think up. $T$ equals $1$ at these numbers.  $T$ jumps a lot!
...
Second, for any small $0.1 > \epsilon > 0$ choosen, the interval $(-\epsilon, \epsilon)$ is an open interval around $f(0) = 0$ in the codomain. 
