...
\item For every $\epsilon > 0$ defining an open interval around $f(a)$, namely $I = (f(a) - \epsilon, f(a) + \epsilon)$, there exists a corresponding $\delta > 0$, such that the image of the open interval $(a - \delta, a + \delta)$ is a subset of $(f(a)-\epsilon, f(a)+\epsilon)$.
\end{itemize}
...
It is going to take some experience to organize our thoughts around \textbf{every}, \textbf{all}, and \textbf{there exists}.
