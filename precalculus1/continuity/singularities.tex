...
Calculus will extend this idea of a singularity.
...
Since, we do not have a function value for a singularity, we cannot compare to the singularity's function value. Instead, we need to compare the function values near the singularity.

We'll slowly build upon this idea.
