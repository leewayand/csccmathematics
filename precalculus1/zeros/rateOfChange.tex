...
\begin{explanation} \textbf{\textcolor{red!75!green}{with some help from Calculus}} 
...
\textbf{Note:}  Sometimes these are called \textbf{critical points}, especially when you investigate multivariable functions.  But, we are just getting started.  So, we are trying to separate \textit{numbers} in the domain from \textit{points} on the graph. 
