...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} Basic exponential functions don't have zeros.  Core logarthmic functions have a zero when the inside of the formula equals $1$. For more complicated exponential and logarithmic functions, we can use transformations and the algebra rules. 
...
Generally speaking, we have only two ways to solve equaitons, which gives us twomethods to finding zeros for a function.


\begin{enumerate}
\item If you know what to do, then do it.
\item If you con't know what to do, then get everything on one side and $0$ onm the other side of the equation and factor. USe the Zero Product Property.
\end{enumerate}
