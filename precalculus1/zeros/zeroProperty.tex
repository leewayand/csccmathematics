...
\item If you con't know what to do, then get everything on one side and $0$ on the other side of the equation and factor. Use the Zero Product Property.
\end{enumerate}
...
The function $f(t) = e^t$ has no zeros, since it is an exponential function.
