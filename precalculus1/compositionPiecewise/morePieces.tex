...
\subsection*{Range of $g$ $\subseteq$ Domain of $T$}


\textbf{\textcolor{red!75!green}{Intersection}} 
...
\textbf{Piece \#1:} $\left[ -\frac{3}{2}, 2 \right]$
\begin{itemize}
\item $g\left( -\frac{3}{2} \right) = -2 \left( -\frac{3}{2} \right) - 3 = 0 $
\item $g(2) = -2 (2)-3 = -7$
\end{itemize}
...
\textbf{Piece \#2:} $(2, 8)$
\begin{itemize}
\item $g(2) = \frac{7}{4} \cdot 2 - 8 = -\frac{9}{2} $
\item $g(8) = \frac{7}{4} \cdot 8 - 8 = 6 $
\end{itemize}
The range of piece \#2 is $\left( -\frac{9}{2}, 6 \right)$.


\textbf{Note:} The range of $g$ is $[-7, 0] \cup \left( -\frac{9}{2}, 6 \right) = [-7, 6)$.  However, we need to see what each piece is doing, so we'll leave the range separated as a union. 
...
\textbf{\textcolor{red!75!green}{Preimage of $(-4,-1]$}} 
...
\textbf{\textcolor{red!75!green}{Now for the other interval in the domain of $T$.}} 
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Now for the formulas}} 
