...
For instance, $-\frac{3}{2}$ is in the domain of $g$, and $g\left(-\frac{3}{2}\right) = 0$, $0$ is not in the domain of $T$.
...
First, let's map the domain of $T$ back to the range of $g$. We need to see what each piece is doing.  SO, we'll plot the domain of $T$ on the vertical axis of the graphof $g$.
...
We get the preimages of $-4$, $-1$, $1$, and $6$ in the $g$ function.  $g$ has two pieces.



All four numbers have preimages through $g(x) = \frac{7}{4}x-8$. Only $-4$ and $-1$ have preimages through $g(x) = -2x-3$.
...
On $\left(-1, \frac{1}{2}\right]$, we will have $T(v) = -v + 3$.  \\

$(T \circ g)(c) = -(-2c-3) + 3 = 2c +9$ \\
