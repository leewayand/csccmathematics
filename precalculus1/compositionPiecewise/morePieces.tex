...
\begin{tikzpicture}
  \begin{axis}[
            domain=-10:10, ymax=10, xmax=10, ymin=-10, xmin=-10,
            axis lines =center, xlabel=$z$, ylabel={$y=g(x)$}, grid = major,
            ytick={-10,-8,-6,-4,-2,2,4,6,8,10},
          	xtick={-10,-8,-6,-4,-2,2,4,6,8,10},
...
For instance, $0$ is in the range of $g$ and not in the domain of $T$. $-\frac{3}{2}$ is in the domain of $g$, and $g\left(-\frac{3}{2}\right) = 0$, $0$ is not in the domain of $T$.
...
Focusing on the interval endpoints (included or excluded), we get the preimages of $-4$, $-1$, $1$, and $6$ in the $g$ function.  \\
