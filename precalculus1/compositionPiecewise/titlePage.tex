...
We have already peeked at this. We took a single output number of one function and used it as the input to another function.  We can extend this idea to the whole domain of a function.
