...
For another instance, $-\frac{32}{7}$ is in the domain of $g$, and $g\left(-\frac{32}{7}\right) = 0$. $-\frac{32}{7}$ has to be removed from the domain of $g$.
...
It looks like we can use the interval $\left[ \answer{1}, \answer{6} \right)$.   $6$ i snot included, so we'll have to keep this in mind as we investigate the domain of $g$.
