...
\begin{explanation} \textbf{\textcolor{red!75!green}{Chaining $T$ and $g$}} 
...
Therefore we need to restrict the domain of $g$, so that the range is just $[1, 6)$. We need to find the \textbf{preimages} of $6$ and $1$ in the domain of $g$.
...
\begin{explanation} \textbf{\textcolor{red!75!green}{$T \circ g$}} 
