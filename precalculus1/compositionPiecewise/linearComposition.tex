...
\[   r(v) = k(h(v)) = 2 (\frac{3}{2} v + n_0) + 1  = 3v + 2 n_0 + 1\]


We need $2 n_0 + 1 = -2$.  Therefore, $n_0 = -\frac{3}{2}$.
...
\[   r(v) = h(k(v)) = \frac{3}{2} (2 v + 1) + n_0 =  3 v + \frac{3}{2} + n_0\]


We need $\frac{3}{2} + n_0 = -2$.  Therefore, $n_0 = -\frac{7}{2}$.
...
We need to find the preimages of $6$ and $1$ in the domain of $g$.
...
We need to restrict the domain of $g$ to $\left[\frac{36}{7}, 8\right)$
...
$(T \circ g)(c) = -\left(\frac{7}{4}c - 8\right) + 3 =  -\frac{7}{4}c + 3$ \\

It's domain is $\left[\frac{36}{7}, 8\right)$.
