...
Suppose the function $p$ is defined through the equation $B(w) = 2 V(w) - 3$. \\


The point $(-2, -1)$ is on the graph of $V$.  What is the corresponding point on the graph of $B$?


\[
\left( \answer{-2}, \answer{-5}  \right)
\]
