...
\begin{definition}  \textbf{\textcolor{green!50!black}{Formula Variable}} (for function notation) 
...
Or, the inside of the parentheses may hold an expression, which involves the variable.  In this case, the variable is not representing the domain values. The whole expression is representing the domain values.
