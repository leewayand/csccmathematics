...
Or, the inside of the parenthses may hold an expression, which involves the variable.  In this case, the variable is not representing the domain values. The whole expression is representing the domain values.
