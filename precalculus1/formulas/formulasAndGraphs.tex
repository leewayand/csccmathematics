...
In particular, we have the \textbf{\textcolor{purple!85!blue}{Zero Product Property}}.  This states that the \underline{only} way a product of two real numbers is zero is if one of the numbers is $0$.
