...
Linear functions have a constant growth rate while \textbf{exponential functions} have a constant percentage growth rate, as we will see later.  This results in a formula of the form $E(t) = a r^t$, where $a$ is a nonzero real number and $0 < r$.
...
The graph of an exponential function attempts to level off at a height of $0$.  This follows the idea that $0.8$ raises to larger and larger powers will result in a smaller and smaller value.
...
$\blacktriangleright$ IIf $(a, 0)$ is a point on the graph of $f$, then $f(a) = 0$ and $a$ is a zero of $f$.
