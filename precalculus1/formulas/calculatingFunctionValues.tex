...
$[-8, 16)$ is interval notation representing the possible values of $P$ for those possible values of $k$ in $[-2, 6)$.  
...
A formula is not a function.  A function is a package containing three sets, following one rule.  A formula is a tool used to describe the connection between the domain and range numbers (function values).
