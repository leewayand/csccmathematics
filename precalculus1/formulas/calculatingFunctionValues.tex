...
\begin{enumerate}
\item You know the domain number and you want the range partner or function values.  This questions is answerws with evaluation. Either you evalute the formula or you track the funciton value down inside a graph.

\item You know the funciton value and you want the associated domain values.  This questions is usually phrased in terms of an equation to solve.  The solution set include more than one domain number.
\end{enumerate}
