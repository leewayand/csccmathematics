...
Note:  $\answer{\sqrt{3}}$ is not in domain, therefore $3 - h^2 \ne 0$. Therefore, we can multiply both sides by it.  
...
The above example illustrates a common theme in function analysis.  Functions have values $\large{\textcolor{purple!50!blue!90!black}{AT}}$ domain numbers.  This theme will continue through Calculus.  We will describe characteristics and features of functions by their range values and then identify places in the domain $\large{\textcolor{purple!50!blue!90!black}{WHERE}}$ the behavior $\large{\textcolor{purple!50!blue!90!black}{OCCURS}}$. 
