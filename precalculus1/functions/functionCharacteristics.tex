...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$ Same with functions.}}  



A major goal of this course is to develop a list of function properties and define sets of functions via these properties, which we will call \textbf{function categories}.  Once we know a function belongs to a particular category, then we get a lot of free information about the function. This classification is often our reasoning for conclusions we draw when analyzing functions. 
