...
Each domain item is paired with \textbf{\textcolor{red!50!blue!50!}{EXACTLY}} one codomain item.  Not 0. Not 2.  Not 3.  Exactly 1!  Thus, when you pick a domain item, you have automatically selected its partner in the codomain.  We could certainly hunt it down inside the codomain.  But, we can also just talk about "the domain member's partner in the codomain."  We have function notation for this thought.
...
functionName(d) is called "the value of functionName \textbf{\textcolor{red!50!blue!50!}{AT}} d". \\
functionName(d) is pronounced as "functionName \textbf{\textcolor{red!50!blue!50!}{OF}} d".
\end{notation}
