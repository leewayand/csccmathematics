...
\begin{warning}
When function values depend on how you write numbers, that is a pretty good clue that the function is not well-defined.
\end{warning}
\end{example}
...
\textit{functionName(d)} is called ``the \textbf{\textcolor{purple!85!blue}{VALUE}} of functionName \textbf{\textcolor{purple!85!blue}{AT}} d''. \\
\textit{functionName(d)} is called ``the \textbf{\textcolor{purple!85!blue}{IMAGE}} of d under functionName''. \\
