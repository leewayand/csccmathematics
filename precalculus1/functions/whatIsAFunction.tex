...
We finally found a well-defined function. That one little rule actually narrows the pool of relations quite a bit.
...
Each domain item is paired with \textbf{\textcolor{purple!85!blue}{EXACTLY}} one codomain item.  Not 0. Not 2.  Not 3.  Exactly 1!  Thus, when you pick a domain item, you have automatically selected its partner in the codomain.  We could certainly hunt it down inside the codomain.  But, we can also just talk about "the domain member's partner in the codomain."  We have function notation for this thought.

\begin{notation} Function Notation \\

Let \textit{functionName} be the name of a function. \\
Let \textit{d} represent a domain item.
...
\textbf{Note:} The rule doesn't refer to the range.
