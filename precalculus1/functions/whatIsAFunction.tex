...
The \textbf{preimage} of $T$ under $f$ is the collection of domain members whose values are inside $T$.
...
Two functions are \txtebf{equal} provided they satisfy all three of the following:
