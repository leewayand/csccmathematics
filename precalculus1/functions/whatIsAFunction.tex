...
\textit{SuperBowlWinner}(Superbowl 13) represents the winning team from Superbowl 13, which is the Pittsburgh Steelers.  The following equality is communicating this connection with an equation.
...
$f^{-1}$ is the symbol for the reverse of $f$. $f^{-1}$ pairs members of the codomain with members of the domain.  It is just reading the function $f$ backwards or in reverse.
...
We leave it up to the context in which the notationm appears to tell us which interpretation is correct.
