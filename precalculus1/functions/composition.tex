...
\includegraphics{pics/16.png} is in the domain of $F$.

The image of \includegraphics{pics/16.png} in the $F$ funciton is \includegraphics{pics/2.png}

However, \includegraphics{pics/2.png} is not in the domain of $G$.

Therefore, \includegraphics{pics/16.png} cannot be included in the domain of the composition, $G $\circ$ F$.
...
\begin{center}
\includegraphics{comp_full_2.png}
\end{center}
...
When forming a composition function, we often must restrict the domain. We remove some items of the domain of the inner function, which cannot map through the assembly steps. Remember, to be a function, ALL of the domain items must appear in a pair, must have a function value.
