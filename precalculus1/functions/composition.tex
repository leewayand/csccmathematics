...
Notice that $Inner($\includegraphics{pics/c_20.png})$ = $\includegraphics{pics/c_2.png}

And, \includegraphics{pics/c_2.png} is not in the domain of $Outer$.


Therefore, \includegraphics{pics/c_20.png} cannot be in the domain of the composition.
...
We had to remove both \includegraphics{pics/c_20.png} and \includegraphics{pics/c_19.png}. They both had \includegraphics{pics/c_2.png} as their image in the $Inner$ function.

This also affected the range.

Anything paried with \includegraphics{pics/c_2.png} is no longer in the range of the composition.
