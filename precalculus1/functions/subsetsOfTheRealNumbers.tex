...
\begin{itemize}
\item For finite intervals, write the two numbers in the order they would occur on the number line, separated by a comma.  These are called \textbf{endpoints}.
...
\end{example}
Or course, we could have extended it to the maximal interval it sits inside, $(-3, 1) \subset [-4, 1)$.
