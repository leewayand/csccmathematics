...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [line width=0.1cm, penColor2, smooth,samples=100,domain=(-5:5),<-] ({x},{0});
          \addplot [line width=0.1cm, penColor2, smooth,samples=100,domain=(7:10)] ({x},{0});
          \addplot [line width=0.1cm, penColor2, smooth,samples=100,domain=(13:14),->] ({x},{0});

          \node at (axis cs:5,0) [penColor2] {$]$};
          \node at (axis cs:7,0) [penColor2] {$($};
          \node at (axis cs:10,0) [penColor2] {$]$};
          \node at (axis cs:13,0) [penColor2] {$($};
