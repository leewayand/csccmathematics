...
The graph of $y = R(t) = -2 \sqrt{4 t - 5} + 1 $
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth, samples=200, domain=(1.25:8),->] {-2*x^(4*x-5)}+1;
          \addplot[color=penColor,fill=penColor,only marks,mark=*] coordinates{(1.25,1)};
