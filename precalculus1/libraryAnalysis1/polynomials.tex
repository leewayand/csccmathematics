...
\begin{idea} \textbf{\textcolor{blue!55!black}{Polynomials}} 
...
\textbf{\textcolor{blue!55!black}{Product Form}} 
...
As we saw with quadratics, this factorization into linear factors often requires complex numbers, which we are leaving for the next course. We are only using real numbers now.  Therefore, our factorizations will include linear factors as well as irreducible quadratic factors (quadratics with nonreal/complex roots).
...
The polynomial function has three distinct zeros: $-4$, $1$, and $3$. 

In between these zeros, the values of the polynomial function has a positive or negative sign. It can't change in between the zeros, because the only places where a function can change signs is at zeros, discontinuities, or singularities and polynomials do not have discontinuities or singularities.
...
For polynomials, critical numbers are domain numbers corresponding to flat/horizontal places in the graph.  These include tops of hills and bottoms of valleys. Critical numbers include places where extreme values occur.
