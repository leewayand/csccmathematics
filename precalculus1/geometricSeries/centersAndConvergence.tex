...
Another way to view this is that the convergence interval is centered around the zero of $f(x)$, which has been $0$ up to this point.  What is a different domain number is a zero of $f$?
...
The intervla of convergence is $\left( \frac{7}{2}, \frac{13}{2}\right)$, as predicted.
