...
\begin{itemize}
\item The natural or implied domain of $f$ is $\mathbb{R}$, because $f$ is a shifted exponential function. \\

\item $f$ is always increasing, because the base is greater than $1$, and the leading coefficient of the function and the leading coefficient of the exponent have the same sign. \\

\item $f$ has no maximums or minimums, because shifted exponential functions don't have global or local maximums or minimums. \\
...
\item This end-behavior gives us a range of $(-7, \infty)$. \\
...
\begin{itemize}
\item The natural or implied domain of $B$ is $\mathbb{R}$, because $B$ is a shifted exponential function. \\
...
\item $B$ has no maximums or minimums, because shifted exponential functions don't have global or local maximums or minimums. \\
...
\item This end-behavior gives us a range of $(-\infty, 4)$. \\
...
\begin{itemize}
\item The natural or implied domain of $K$ is $\mathbb{R}$, because $K$ is a shifted exponential function. \\
...
\item $K$ has no maximums or minimums, because shifted exponential functions don't have global or local maximums or minimums. \\
...
\item This end-behavior gives us a range of $(-5, \infty)$. \\
