...
The defining characteristic of a linear function is that it has a constant growth rate or constant rate of change.
...
Exponential functions have a similar growth characteristic. 
...
It doesn't matter where you start.  The value of $d$ doesn't matter. Only the change matters, $D$.
