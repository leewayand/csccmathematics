...
\begin{itemize}
\item The natural or implied domain of $f$ is $\mathbb{R}$, because $f$ is an exponential function. \\

\item $f$ is always increasing, because the leading coefficient of the function and the leading coefficient of the exponent have the same sign. \\

\item $f$ has no maximums or minimums, because exponential functions don't have global or local maximums or minimums. \\
...
This end-behavior gives us a range of $(0, \infty)$. \\
...
Finally, we have a horizontal shift from our basic exponential:
...
Our exponent is $3 - t = -t + 3$.  Our anchor point for graphing is associated with the exponent equaling $0$.



$3-t=0$ when $t=3$. Our one anchor point is shifted over to $3$.  Multipying by $-2$, means the dot is $2$ away from the horizontal asymptote.
...
\begin{itemize}
\item The natural or implied domain of $B$ is $\mathbb{R}$, because $B$ is an exponential function. \\

\item $B$ is always decreasing, because the base is less than $1$, and the leading coefficient of the function and the leading coefficient of the exponent have the same sign. \\

\item $B$ has no maximums or minimums, because exponential functions don't have global or local maximums or minimums. \\
...
This end-behavior gives us a range of $(-\infty, 0)$. \\
...
\begin{itemize}
\item The natural or implied domain of $K$ is $\mathbb{R}$, because $K$ is an exponential function. \\

\item $K$ is always decreasing, because the base is greater than $1$, and the leading coefficient of the function and the leading coefficient of the exponent have opposite signs. \\

\item $K$ has no maximums or minimums, because exponential functions don't have global or local maximums or minimums. \\
