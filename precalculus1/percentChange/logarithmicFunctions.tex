...
The horizontal axis is an asymptote for the basic exponential function. Now, the veritcal axis is an asymptote for the basic logarithmic function.
...
$\blacktriangleright$ The inside of the logarithm is $4-x$ and this equals $0$ when $x=4$.  This has to be the verical asymptote.
