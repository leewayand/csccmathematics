...
An example of a basic core exponential function is $E(t) = 2^t$.  
...
We can also think of this story in reverse.
\begin{itemize}
\item $E(t) = 4$
\item $E(t) = {\tfrac{1}{4}} $
\item $E(t) = 16 $
...
\begin{observation}  \textbf{\textcolor{-red!75}{Backwards}}
...
This range characteristic is called \textbf{one to one}.
...
Thinking of an exponential function in reverse sounds like a new function. It is. 

We call it a \textbf{\textcolor{purple!85!blue}{logarithmic function}}.
...
What's the expression for a logarithmic function? 
...
The pairs in the logarithm base $2$ function look like 
...
$\blacktriangleright$ \textbf{Remember:} $(b, \log_2(b))$ is the reverse of the exponential pair, $(a, 2^a)$.  
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Logarithm Function base $r$ : $log_r(t)$}}



\begin{center}
\textbf{\textcolor{red!75!green}{$\log_r(t)$ is the number you raise $r$ to, to get $t$.}} 
\end{center}
...
$M(t)$ is a logarithmic function, so it must have a partner (inverse) exponential function, posibly shifted.  The pairs for $M$ look like $(t, M(t))$ or just $(t,M)$. The pairs for the (inverse) exponential function would look like $(M, t)$.  The roles of $M$ and $t$ would be switched. $M$ would be the variable in the formula. $t$ would be the function value.
...
\begin{itemize}
  \item Let $L(t) = \log_3(t)$, an increasing core logarithmic function.
