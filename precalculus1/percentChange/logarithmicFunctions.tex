...
Thinking of an exponential function in reverse sounds like a new function. It is. We call it a \textbf{logarithmic function}.
...
$\blacktriangleright$  $\log_2(b)$ is the exponent, $a$, so that $2^a = b$ \\
