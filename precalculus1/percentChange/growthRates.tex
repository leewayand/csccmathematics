...
\textbf{Note:}  We have two forms for exponential functions:
...
This is not a problem since they are equivalent.


\[
A \, R^{B\,x+C} = A \, R^{B\,x} \, R^C = (A \, R^C)\, (R^B)^x = a \, r^x
\]
...
\begin{example} General Percentage Change
...
Here is a graph of $y = e(x)$.


\begin{image}
\begin{tikzpicture}
  \begin{axis}[
            domain=-5:100, ymax=4, xmax=100, ymin=-1, xmin=-5,
          ...
          \addplot [line width=1, gray, dashed, samples=200, domain=(-10:90), <->] {2.7};
	%\addplot [draw=penColor,very thick,smooth,domain=(-4:-1)] {2*x-1};
	\addplot [draw=penColor2,very thick,smooth,domain=(1:95)] {(1+1/x)^x};
...
\textbf{What's is so special about $e$?}

We'll see what is special about $e$ in Calculus.  

But here is a peek ahead.


Let's consider the exponential function $E(x) = e^x$.

This is an exponential function, which means it has a constant percentage growth rate.

But, let's look at its growth rate or rate of change. Let's look around $0$. And, we'll look closer and closer to $0$.


$\frac{E(0.5)-E(0)}{0.5} \approx 1.297$

$\frac{E(0.25)-E(0)}{0.25} \approx 1.13$

$\frac{E(0.1)-E(0)}{0.1} \approx 1.05$

$\frac{E(0.05)-E(0)}{0.05} \approx 1.025$

$\frac{E(0.1)-E(0)}{0.1} \approx 1.05$

$\frac{E(0.01)-E(0)}{0.01} \approx 1.005$

$\frac{E(0.001)-E(0)}{0.001} \approx 1.0005$

$\frac{E(0.0001)-E(0)}{0.0001} \approx 1.00005$

The growth rate of $e^x$ near $1$ is $1$.

Since $e^0 = 1$, The growth rate of $e^x$ near $e^0$ 


Let's try that for some other numbers.


$\frac{E(2.0001)-E(2)}{0.0001} \approx 7.389 \approx e^2$


$\frac{E(3.0001)-E(3)}{0.0001} \approx 20.0855 \approx e^3$
...
This will prove to be VERY useful in Calculus.
