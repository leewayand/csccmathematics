...
\begin{tikzpicture}
  \begin{axis}[
            ...
            \addplot [line width=2, penColor2, smooth,samples=100,domain=(-4:5),<->] {x+3};
...
\end{tikzpicture}
\end{image}
Here $h(2)$ does exist.  The graph tells us that $h(2) = -2$.  However, the pattern ``around'' $2$ suggests that $h(2)$ ``should'' be $5$. That would have fit our pattern better.  The ``behavior'' ``around'' $2$ leads one to expect $h(2)=5$.
