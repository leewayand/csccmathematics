...
There are several similar situations where are expectations are not met.
...
Here, we are only looking at the left side of $2$, because there is no domain to the right.  The left side ``around'' $2$ lead us to think that $K(2) = 5$.  Instead, $K(2) = -3$. \\
...
\begin{quote}
 \textbf{\textcolor{blue!55!black}{For domain numbers really really really close to $2$, the function values for those domain numbers are not close to the actual function value at $2$.}} 
\end{quote}
...
\textbf{\textcolor{red!90!darkgray}{$\blacktriangleright$}} We need a way of representing ``really close'', algebraically.  \\
