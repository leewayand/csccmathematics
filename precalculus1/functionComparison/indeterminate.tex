...
%\begin{definition}[End Behavior Indeterminant Forms]
%	A limit
%	\[
%			\lim\limits_{a \to \infty}\frac{n(a)}{d(a)}
%	\]
%	is said to be of the form $\dfrac{\infty}{\infty}$ if 
%	\[
%			\lim\limits_{a \to \infty}n(a)=\infty \qquad \text{and} \qquad \lim\limits_{a \to \infty}d(a)=\infty
%	\]
%	and is said to be in the form $\dfrac{0}{0}$ if 
%	\[
%	\lim\limits_{a \to \infty}n(a)=0 \qquad \text{and} \qquad \lim\limits_{a \to \infty}d(a)=0
%	\]
%\end{definition}
