...
This goes for functions appraoching $\infty$, or approaching $0$ as well. 
...
We have been examining functions that approach infinity (or $0$) similarly. When we combine similar functions into a new quotient function, this new function might have a contant end-behavior. 
