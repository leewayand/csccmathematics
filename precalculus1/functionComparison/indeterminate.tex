...
This goes for functions approaching $\infty$, or approaching $0$ as well. 
...
We have been examining functions that approach infinity (or $0$) similarly. When we combine similar functions into a new quotient function, this new function might have a constant end-behavior. 
...
\[
\frac{S(t)}{L(t)} = \frac{\sqrt{2t^3 - 5}}{t\sqrt{9t+4}} \, \text{ looking like } \, \frac{\infty}{\infty}
\]
