...
\begin{tikzpicture}
  \begin{axis}[
            ...
            \addplot [line width=2, penColor2, smooth,samples=100,domain=(0.2:8), <->] {ln(x)/x};
...
\textbf{Thinking:} If this function approaches $0$, then it must get below and stay below $2$, eventually. How far out in the domain do you need to go before this function eventually dips and stays below $2$.
...
As $t$ becomes unbounded negatively, we have a different story.  $\lim\limits_{t \to -\infty} e^t = 0$. Therefore, in this case, the constant terms dominate.
