...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot [draw=penColor, very thick, smooth, samples=200,domain=(-7.5:2.88), <->] {1/(x-3) + 2};
...
\item $-5$ is a discontinuity of $f(x)$.  For the second condition, let $d = 0.5$. Any open interval of real numbers containing $c = -5$ must also contain an interval of the form $(-5-\epsilon, -5+\epsilon)$, where $0 < \epsilon < 0.000001$.    Such an interval would \textbf{ALWAYS} contain the domain number $e = -5-\frac{\epsilon}{2}$.
