...
$\blacktriangleright$ Endpoints make an exact definition of discontinuity messy, because we want to say there are ALWAYS domain numbers on one or both sides of the discontinuity no matter how close you get to the discontinuity. 

How are we going to talk about ``no matter how close you get'', algebraically?



\textit{Open interval} are our way of talking about `no matter how close you get''. 
...
The second condition in the definition is our algebraic way of saying, ``\textit{no matter how close you get}''.
