...
\textbf{Not Continuous} does not automatically mean there is a discontinuity. 


A function is not continuous at a singularity, but a singularity is not a discontinuity.


A function is not continuous at any number outside its domain, whether it is a singularity or not.
...
So, it is possible for a function to be noncontinuous at a real number and yet the real number is not a discontinuity. (It isn't in the domain.)
