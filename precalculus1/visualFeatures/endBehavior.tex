...
When we think of analyzing functions, we envision the real line to have three pieces. 





There is the \textbf{\textcolor{red!70!black}{left tail}}, which is the part with all of the very very very very large negative numbers. There is the \textbf{\textcolor{red!70!black}{right tail}}, which is the part with all of the very very very very large positive numbers. Then, there is the \textbf{\textcolor{purple!85!blue}{middle}} part. 
...
This is called \textbf{Limit Notation}.
...
\textbf{Discontinuties and Singularities}
...
We would like to describe these expectations and discrepencies.
