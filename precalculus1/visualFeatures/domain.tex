...
Here is the complete graph of the function $y=G(x)$. 
...
The left piece of the graph includes two arrows, which tell us that the first coordinates fill up the interval $(-\infty, 3)$.
...
Now smash all of the points vertically down to the horizontal axis.

That gives us a picture of the domain.
...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot[color=penColor2,fill=penColor2,only marks,mark=*] coordinates{(-1,0)};
         ...
         \addplot[color=penColor2,fill=penColor2,only marks,mark=*] coordinates{(4,0)};
         \addplot[color=penColor2,fill=white,only marks,mark=*] coordinates{(8,0)};
