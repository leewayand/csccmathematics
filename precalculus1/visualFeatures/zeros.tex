...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot [draw=penColor, very thick, smooth, domain=(-9:9), ->] {0};
...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot [draw=penColor, very thick, smooth, domain=(0:9), ->] {x^0.5};
        \addplot [draw=penColor2, very thick, smooth, domain=(-8:8), <->] {x^0.333};
...
\begin{tikzpicture}
     \begin{axis}[
        ...
        %\addplot [draw=penColor, very thick, smooth, domain=(-9:2), <->] {2.7^x};

        %\addplot [draw=penColor2, very thick, smooth, domain=(-3,9), <->] {0.5^x};
...
\begin{tikzpicture}
     \begin{axis}[
         ...
         \addplot [draw=penColor, very thick, smooth, domain=(-8,-0.01), <->] {ln(-x)};

        \addplot [draw=penColor2, very thick, smooth, domain=(0.01:8), <->] {ln(x)};

        \addplot [line width=0.5, gray, dashed,samples=100,domain=(-9:9)] ({0},{x});
