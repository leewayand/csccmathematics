...
\textbf{\textcolor{red!90!darkgray}{$\blacktriangleright$}} Vertical Tangent Lines \\
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth,samples=100,domain=(-6:3),<-] {4*(x-3)^(1/4)-3};
          \addplot [line width=2, penColor, smooth,samples=100,domain=(3:8),->] {4*(3-x)^(1/4)-3};
...
\textbf{\textcolor{red!90!darkgray}{$\blacktriangleright$}} Corners \\
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth,samples=100,domain=(-6:8),<-] {abs(x-3) - 5};
...
\textbf{\textcolor{red!90!darkgray}{Candidates for locations of extrema values are domain where the derivative is $0$ or Does Not Exist.}}
