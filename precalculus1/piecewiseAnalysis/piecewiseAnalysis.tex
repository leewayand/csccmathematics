...
$V$ is near $1$ on $(-2 - \epsilon, -2)$.

This also means that $V$ is not near $2$. $V(h) < 1$ on $(-2 - \epsilon, -2)$.



We can see this by remembering that $\epsilon$ is a very small postive number.  Certainly, $\epsilon < \frac{1}{2}$, so for sure $1 + 2 \epsilon < 2$. 


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $(-2 - \epsilon, -2)$, $2 \geq V(h) \geq 1$.
...
On $(-2, -2 + \epsilon)$, we have $V(h) \geq  \frac{9}{2}$.
