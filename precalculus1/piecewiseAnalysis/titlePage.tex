...
When analyzing a function, we would like to know the function's domain; the function's zeros; discontinuities and singularities and behavior around them; intervals of continuity; end-behavior; intervals where the function is increasing and decreasing; global maximum and minimum values of the function; local maximum and minimum values of the function; and what the graph looks like. 
...
As we develop our library of elementary functions, we will collect information on these characteristics and features for each function family.  Currently, our library contains linear and quadratic functions.  
