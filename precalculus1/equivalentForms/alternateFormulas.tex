...
So, our strategy is to break up our expressions into expressions of these \textbf{\textcolor{blue!55!black}{easy forms}}.  The only way we know how to break up expressions is by factoring (distributive property).  And, factoring only works with the zero product property.
...
(1) If you know what to do, then do it. If you see what the solution should look like (a form), then start guessing and refine your guesses.\\
