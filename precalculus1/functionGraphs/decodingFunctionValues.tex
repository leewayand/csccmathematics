...
According to the graph for $y = m(x)$ above, $m(1.1)$  \wordChoice{\choice{$<$}\choice[correct]{$>$}}   $m(3.2)$.
...
Which of the expressions below best desccibes the domain of $T$?
...
Which of the expressions below best desccibes the range of $T$?
\begin{multipleChoice}
\choice [correct] {$[-6,6]$}
\choice  {$(-4, 1]$}
\choice  {$[-6,6] \cup (-4,1]$}
