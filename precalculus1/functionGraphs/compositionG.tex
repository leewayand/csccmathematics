...
You then turn your attention to the horizontal axis of the graph for the outer function. You locate the value of the inner function on the domain axis of the outer function.

Now you run through the evaluation proces once more.

From this domain number, you locate the value of the outer function via the points on the graph of the outer function.

This final number on the vertical axis of the outer funciton is the value of the composition.
...
The Chain Rule tells us when compositions are increasing and decreasing.
...
\begin{fact}  \textbf{\textcolor{red!75!green!50}{$inc \circ inc = inc$}} 
...
We have $f(a) < f(b)$ and $g$ is an increasing function. That give us $g(f(a)) < g(f(b))$
...
\begin{fact}  \textbf{\textcolor{red!75!green!50}{$dec \circ inc = dec$}} 
...
We have $f(a) < f(b)$ and $g$ is a decreasing function. That give us $g(f(a)) > g(f(b))$
...
\begin{fact}  \textbf{\textcolor{red!75!green!50}{$inc \circ dec = dec$}} 
...
\begin{fact}  \textbf{\textcolor{red!75!green!50}{$dec \circ dec = inc$}} 
