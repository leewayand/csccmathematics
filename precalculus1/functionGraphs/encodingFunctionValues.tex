...
Below is the graph of $h(f)$. We can create its domain, by collecting all of the first coordinates of all of the dots.  
...
\begin{tikzpicture} 
  \begin{axis}[
          ...
          \addplot [color=penColor,only marks,mark=*] coordinates{(-4,4) (0,1) (1,-6.5) (7,-3.5)};
