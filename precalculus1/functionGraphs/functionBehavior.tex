...
Increasing means the domain and range change the same: both become greater or both become lesser.
\end{idea}
...
Decreasing means the domain and range change oppositely: one becomes greater and the other becomes lesser.
\end{idea}
...
This story is a bit misleading.  Our story involved $\leq$.  Technically, the equal sign allows the function to steady, a constant function. 
