...
Currently, we are examining when a function suddenly takes on a value which is a drastic change from all of the function values around it.  Or, when a function just drops a value at a single domain number, which is certainly a drastic change as well.
