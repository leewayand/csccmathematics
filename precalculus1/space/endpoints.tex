...
We have one slight hiccup in our open interval version of closeness and that is endpoints in the interval.
...
If we want to examine the domain number $2$ and its weird function value $-3$, then our open interval is in trouble.  There is no space tothe left of $2$ in teh domain where we could carve out an open interval.\\
