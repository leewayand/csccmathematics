...
Let $D(y)$ be a function with its domain and range.

Let $K(r)$ be defined as $K(r) = 2 D(r)$ with its induced domain and range.


Then the domain of $K$ is

\begin{multipleChoice}
\choice {the domain of $D$ stretched by $2$}
\choice {the domain of $D$ compressed by $\tfrac{1}{2}$}
\choice[correct] {the same as for $D$}
\end{multipleChoice}

The induced domain of $K$ is equal to the domain of $D$.  The coefficient $2$ is multiplying the function values of $D$.
...
Suppose $K(r) = 2 D(r)$ and $D(4) = 6$.  Then which of the following is true?
...
$m$ two zeros: $-6$ and $\answer{5}$. These are represented by intercepts in the left and right line segments. \\
...
\item $P$ two zeros: $-6$ and $5$. These are represented by intercepts in the left and right line segments. Because, $2 \cdot 0 = 0$. \\
...
Multiply a function by a positive constant stetches the graph vertically.  Since stretching $0$ still gives $0$, the intercepts do not change.  Everythig is stetched from the intercepts. They stay pinned where they are.
...
\item $B$ two zeros: $\answer{-6}$ and $5$. These are represented by intercepts in the left and right line segments. Because, $-2 \cdot 0 = 0$. \\
