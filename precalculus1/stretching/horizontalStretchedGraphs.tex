...
It is like the domain of $T$ is on a rubberband and it shrunk to half its original size. Wherever you are evaluating $W$, you get the value by evaluating $T$ at twice the $W$ domain number.
...
The only oddity to the stretching idea happens for $0$.  Since $2 \cdot 0 = 0$, whenever $g = 0$, then $2g = 0$.  While the domain is being stretched, it is being stretched away from $0$. Stretching cannot move $0$. It gets pinned down where it is.
...
\subsection*{Composition : Inside = Domain = Horizontal}
