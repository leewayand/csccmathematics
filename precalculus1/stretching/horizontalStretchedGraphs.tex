...
It is like the domain of $T$ is on a rubberband and it shrunk in half. Wherever you are evaluating $W$, you get that value by evaluatinng $T$ at twice the $W$-domain number.
...
We multiplied $g$ by $2$, but $g$ is from the domain $W$.  The domain of $W$ is stretching.  We want to know what happened to the domain of $T$ and $k$ represents the domain of $T$.
...
It is like the domain of $T$ is on a rubberband and it shrunk in half and then rotated around the vertical axis.  As $r$ walks through the domain of $M$ from left to right, the corresponding walking in the domain of $T$ is from right to left.
