...
So, multiplication by $2$ compressed the domain.
...
We multiplied $g$ by $2$, but $g$ is from the domain $W$.  The domain of $W$ is stretching.  We want to know what "happened" to the domain of $T$.  $T$ is the old, original function and $k$ represents the domain of $T$.  What happened to $k$ is the question?
...
It is like the domain of $T$ is on a rubberband and it shrunk in half and then rotated around $0$.  As $r$ walks through the domain of $M$ from left to right, the corresponding walking in the domain of $T$ is from right to left.
