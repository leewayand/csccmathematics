...
$V$ has many features and characteristics, including $3$ and $\frac{32}{7}$ as zeros 
...
$m(w)$ has only one zero at $\answer{4}$.
...
Let $g(t) = V(t) - 1$ has three zeros.  One of these is zeros is $2 \sqrt{2}$.


In numeric order, the other two are $\answer{-2}$ and $\answer{\frac{36}{7}}$.
