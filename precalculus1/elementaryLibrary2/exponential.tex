...
We have Core Exponential function: $e^x$.  The Elementary Functions include a more general form constructed from a special function property.
...
Exponential functions can be thought of as compositions our our Core exponential funcitons with linear functions.

\begin{idea} \textbf{\textcolor{green!50!black}{Exponential Functions}}


Let $E(k) = e^k $ be our Core exponential function.

Let $L_{in}(t) = B \, t + C$ be a linear function.

Let $L_{out}(y) = A \, y$ be a linear function with no constant term.
...
\[
(L_{out} \circ E \circ L_{in})(x) = A e^{B \,x + C}
\]
...
\begin{idea} \textbf{\textcolor{red!70!black}{Practical Purposes}}
...
\begin{idea} \textbf{\textcolor{red!70!black}{Coefficients}}
...
\begin{idea} \textbf{\textcolor{green!50!black}{Shifted Exponential Functions}}
...
\[
(L_{out} \circ E \circ L_{in})(x) = A e^{B \,x + C} + D
\]
