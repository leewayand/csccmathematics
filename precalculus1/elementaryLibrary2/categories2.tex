...
All of the general templates for the Elementary Functions can be viewed as compositions of linear functions with the Core functions.

This composition view will be very helpful when we are determining the behavior of a function, because we have the \textbf{Chain Rule}.

The \textbf{Chain Rule} tells us how to glue the behavior of individual component functions together to get the behavior of the big function.
