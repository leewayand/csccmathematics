...
On the interval $\left (0, \frac{\pi}{2} \right)$, $\cos(\theta)$ is \wordChoice{\choice[correct]{positive} \choice{negative}}. \\
...
On the interval $\left (0\frac{\pi}{2}, \pi \right)$, $\cos(\theta)$ is \wordChoice{\choice{positive} \choice[correct]{negative}}. \\
...
On the interval $\left (\pi, \frac{3\pi}{2} \right)$, $\cos(\theta)$ is \wordChoice{\choice{positive} \choice[correct]{negative}}. \\
...
On the interval $\left (\frac{3\pi}{2}, 2\pi \right)$, $\cos(\theta)$ is \wordChoice{\choice[correct]{positive} \choice{negative}}. \\
