...
Our Core Functions that we use to describe periodic behavior are \textbf{Sine} and \textbf{Cosine}.  These functions are lifted from the unit circle.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}}  The coordinates are functions of the angle!
...
\subsection*{General Trigonometric Functions}


In general, trigonometric functions can be thought of as compositions of sine, cosing, and tangent with linear functions.




\begin{idea} \textbf{\textcolor{blue!55!black}{Sine Functions}}


Let $S(\theta) = \sin(\theta)$ be the Core sine function.
...
Sine functions are constructed by composing these component functions.


\[
(L_{out} \circ S \circ L_{in})(x) = A \sin(B \,x + C) + D
\]
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Cosine Functions}}


Let $C(\theta) = \sin(\theta)$ be the Core cosine function.
...
\[
(L_{out} \circ C \circ L_{in})(x) = A \cos(B \,x + C) + D
\]
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Tangent Functions}}


Let $T(\theta) = \sin(\theta)$ be the Core tangent function.
...
Tangent functions are constructed by composing these component functions.


\[
(L_{out} \circ T \circ L_{in})(x) = A \tan(B \,x + C) + D
\]
