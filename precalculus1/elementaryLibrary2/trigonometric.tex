...
Cosine is a function of the angle $\theta$. The value of the cosine function is the horizontal coordinate of the point on the unit circle at the given angle, $\theta$. The shorthand for this function looks like $\cos(\theta)$. 
