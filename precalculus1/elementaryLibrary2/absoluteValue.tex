...
Let $Abs(k) = |x| $ be the Core absolute value function.
...
Each piece is a linear function.  The leading coefficients tell us that


\begin{itemize}
\item $|x-3|$ is decreasing on $(-\infty, 0)$
\item $|x-3|$ is increasing on $(0, \infty)$
\end{itemize}
