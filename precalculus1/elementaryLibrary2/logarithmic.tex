...
What if we have a function value for an exponential function and we would like to know which domain numbers are associated with it?  In other words, if $g_0$ is a member of the range, then we would like to solve
...
\begin{center}
The number  you raise $a$ to, to get $b$ is called the \textbf{logarithm base a of b}.
\end{center}
...
\begin{center}
\textbf{\textcolor{red!75!green}{$\log_a(b)$ is  the number you raise $a$ to, to get $b$.}} 
\end{center}
...
\textbf{Magic Sentence:} $\log_a(b)$ is the number you raise $a$ to, to get $b$.
...
It sounds like we have a new category of functions (a core function).




\begin{idea} \textbf{\textcolor{blue!55!black}{Core Logarithmic Functions}}

Our \textbf{Core Logarithmic Function} is a function that \textbf{\textcolor{purple!85!blue}{can}} be represented by formulas of the form
...
Our Elementary Function version of logarithmic functions is the core function composed with linear functions.
...
We can think of these as compostions of our Core logarithmic functions with linear functions.


\begin{idea} \textbf{\textcolor{blue!55!black}{Logarithmic Functions}}


Let $Log(k) = \log_r(x) $ be a Core logarithmic function.
...
Logarithmic functions are constructed by composing these component funcitons.


\[
(L_{out} \circ Log \circ L_{in})(x) = A \log_r(B \,x + C) + D
\]
