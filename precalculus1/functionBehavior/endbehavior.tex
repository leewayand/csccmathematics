...
graph of $y = f(x) = \frac{x+1}{(x+3)(x-4)}$
...
\[ \frac{(w+8)(2w-7)(3w-1)}{(3w-5)(w+2)}    \sim   \frac{6w^3 + 11w^2}{3w^2 + w} = 2w+3  \]
...
\[ \frac{(w+8)(2w-7)(3w-1)}{(3w-5)(w+2)}    \sim    2w -\frac{49}{3}  \]



\begin{center}
\desmos{y4maszid1z}{400}{300}
\end{center}
