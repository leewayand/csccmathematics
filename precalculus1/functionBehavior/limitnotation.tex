...
\begin{itemize}
\item tending to or approaching infinity
\item tending to or approaching negative infinity
\end{itemize}
...
as $x$ becomes unbounded negatively in the domain, the function values also become unbounded positively. Our notation for that looks like 
...
$\infty$ is NOT a real number.  The function does reach $\infty$.  

$\lim\limits_{x \to \infty} f(x) = \infty$ is just notation telling us that all of the values of $f(x)$ become unbounded as we move out along the real line.  
