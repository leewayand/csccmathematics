...
We can examine the rate of change of $Q$ over any domain interval.


Let's examine $Q$ over the interval $[2, 5]$.
...
We are calling this slope of the tangent line the \textbf{\textcolor{purple!85!blue}{instantaneous rate of change}} of the function at the domain number corresponding to the tangent point.
...
We now have two formulas for $Q_{new}(x)$.
...
\end{conclusion}
This is for any point on this parabola. 

What about other parabolas, besides the basic core parabola? 
...
From above, we know this slope will be \textbf{$2 \, a \, (x_0 - h)$}.
...
The function $iRoC_Q(x)$ is defined to equal the slope of the tangent line at the point $(x, y)$ on the graph of $Q$.
