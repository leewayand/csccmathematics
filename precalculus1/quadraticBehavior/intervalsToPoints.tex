...
What is we push the secant over a little bit until it becomes a tangent line?
...
Now it is a picture of the rate of change over the interval $[\tfrac{7}{2}, \tfrac{7}{2}]$. \\
...
Let's consider the function $P(x) = Q(x) - T(x)$. \\
