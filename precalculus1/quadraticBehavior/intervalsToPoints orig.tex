...
Let's select a domain number of $Q$, call it $x_0$.   This corresponds to the point $(x_0, y_0)$ on the graph of $Q$.

Let's add a picture of the tangent line at $(x_0, y_0)$ to our graph of $Q$.
...
Let's consider a new function defined as $P(x) = Q(x) - T(x)$. \\
