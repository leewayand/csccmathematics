...
The graph has its own pattern and the secant lines have their pattern. Hopefully, these seprate patterns will converge to the same pattern at the tangent point.
