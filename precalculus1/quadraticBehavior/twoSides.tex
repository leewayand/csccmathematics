...
\item \textbf{Second}, the secant lines are smoothly turning into the tangent line at the tangent point on \textbf{both sides}. 
\end{itemize}
...
The points on the graph on both sides of the tangent point are both approaching the tangent point. 

The secant lines are approaching the tangent line on both sides.
...
To help us watch the moving secant lines, we are using special secant lines. 
...
To move the secant lines, we will continue selecting graph points that are getting ever closer to the tangent point. 
...
We would like a measurement of the slope of this tangent line.

We call the slope of this tangent line the derivative of the function. It is our measurement for the instantaneous rate of change of the function.
...
Everything is working just fine, however, the tangent line is a vertical line.  It has no slope.
