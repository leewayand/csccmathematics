...
The secant lines on the left smootly turn into the tangent line as you move to the right. \\
...
Similarly, we might have a one-side tangent line on thee right.  \\
...
The term `derivative" implies a two-sided derivative.  Otherwise, we would say `right' or `left'. \\
