...
\item We have a function, $f$, 
\item We have and a domain number, $t_0$, 
\item This domain number is inside an interval (half open) inside the domain of the form  $t_0 \in (a, t_)] \subset Domain$. 
\item The tangent lines on the left side of $(t_0, f(t_0))$ are smootlhy approach the same line.
\end{itemize}

Then, there is a tangent line to the graph of $f$ and the tangent lines on the left side are smootly turning into this tangent line at the tangent point $(t_0, f(t_))$. \\
