...
If there is a stated domain, then the range will be restricted appropriately. \\
 ...
 \textbf{\textcolor{blue!75!black}{Symmetry}}   \\
...
\end{definition}
\textbf{\textcolor{green!50!black}{$\blacktriangleright$}} Domain numbers where $iRoC_f$ doesn't exist are also places where a function's behavior can change drastically.
