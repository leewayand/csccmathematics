...
It presented a step-by-step procedure for applying algebra that would transform a quadratic polynomial in standard form to one in verxtex form.  The procedure gathers terms that could be rewritten as a square.  
...
Our goal is to convert the form $a \, x^2 + b \, x + c$ into the form $a \, (x - h)^2 + k$. 
...
\begin{itemize}
\item From the standard form, we know that the first coordinate of the parabola's vertex is $\frac{-b}{2 a}$.
\item From the vertex form, we know that the first coordinate of the parabola's vertex is $h$.
\end{itemize}
