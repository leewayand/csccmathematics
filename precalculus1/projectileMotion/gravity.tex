...
$\blacktriangleright$ The area under the velocity graph measures the distance travelled, which makes area \wordChoice{\choice{constant} \choice{linear} \choice[correct]{quadratic}}. \\
