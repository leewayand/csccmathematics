...
$\blacktriangleright$ The area under the velocity graph measures the distance travelled, which makes this area \wordChoice{\choice{constant} \choice{linear} \choice[correct]{quadratic}}. \\

$\blacktriangleright$ Distance travelled is a \wordChoice{\choice{constant} \choice{linear} \choice[correct]{quadratic}}. \\
