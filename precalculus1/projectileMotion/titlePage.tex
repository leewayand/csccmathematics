...
$\blacktriangleright$  If you throw the object at a $45^{\circ}$ angle to the ground, then the trajectory is a parabola in the air.  The height and horizontal distance change differently.  The height goes up and back down - a parabola.  However, its horizontal distance just keeps increasing - linearly. 


In this section we want to compare height, horizontal distance, and time for thrown objects. 
...
If you want, you can add in more details like gravity changes as the object gets higher. The air resistance changes as the air thins.
