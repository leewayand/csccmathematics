...
The real numbers don't hold a number equal to $\sqrt{-16}$.  Therfore, there are no real solutions.
...
In each of the examples above the number of solutions was determined by $\sqrt{b^2 - 4 a c}$.  $b^2 - 4 a c$ is called the \textbf{discriminant} and its sign tells us how many real solutions the equation has.
