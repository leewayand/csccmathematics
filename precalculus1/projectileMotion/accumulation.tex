...
$\blacktriangleright$ The value of $D(t)$ gives the area of the region under the graph of $v(t)$, and above the $x$-axis, between $0$ and $t$.
...
Of course, the constant function $v(t) = 20$ is also a linear function. Its rate of change is the constant function $0$.  We can view $v(t)$ as a function with a rate of change of $0$ or we can view it as the rate of change of some function, $D(t)$. This function, $D(t)$, is represented graphically by the area of teh region under the graph, and above the $x$-axis, of $v(t)$.
...
That is, we could view $D(t) = 20t$ as the rate of change of some function, $Q(t)$.  The function, $Q(t)$, would measure the area of the region under the graph of $y = D(t)$.
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Linear = Rate of Quadratic}} 


\textbf{\textcolor{blue!55!black}{Guess:}} The linear function $20(t-3)$ gives the rate of change of the quadratic function $10(t-3)^2$.
