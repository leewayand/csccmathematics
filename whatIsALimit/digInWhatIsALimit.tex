...
\outcome{Consider  values of a function  at inputs approaching a given domain number.}
...
\begin{definition}
  Intuitively,
   ...
   for the function $f$,  $L$ is the \textbf{limit from the right} as $x$ approaches $a$,
  ...
  Similarly,
   ...
   for  the function $f$, $L$ is the \textbf{limit from the left} as $x$ approaches $a$,
