...
\begin{definition}\index{critical point}
  Assume that a function $f$ is defined on an open interval I that contains a point $a$. Then we say that the  function $f$ has a \textbf{critical point} at $x=a$ if 
  \[
...
or down to up at $x=a$, then $f$ has an \textbf{inflection point} at
$x=a$.
\end{definition}
