...
$g$ has critical numbers at the $x$ values (from left to right) $\answer{0}$, $\answer{1}$, $\answer{3}$ and $\answer{5}$.


$g$ has critical numbers where $g'(x)=0$ at the $x=\answer{0}$.\\ 


$g$ has critical numbers where $g'(x)$ is \textbf{undefined} at the $x$ values (from left to right) $\answer{1}$, $\answer{3}$ and $\answer{5}$.


$g$ has a local max at $x=\answer{1}$ and $x=\answer{5}$ .
