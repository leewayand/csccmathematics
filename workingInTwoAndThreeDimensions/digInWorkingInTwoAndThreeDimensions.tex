...
To plot a point $(a,b,c)$ in $\mathbb{R}^3$, you move $a$ in the
...
\begin{itemize}
\item In $\mathbb{R}^2$, any equation involving $x$ and/or $y$ draws a \textbf{curve}.
\item In $\mathbb{R}^3$, any equation involving $x$, $y$, and/or $z$ draws a \textbf{surface}.  
\end{itemize}
...
\begin{theorem}
  Given two points $P=(x,y)$ and $Q=(a,b)$ in $\mathbb{R}^2$, the distance between
  them is given by:
  \[
  |PQ|=\sqrt{(x-a)^2 + (y-b)^2}
  \]
...
\begin{theorem}
  Given two points $P=(x,y,z)$ and $Q=(a,b,c)$ in $\mathbb{R}^3$, the distance between
  them is given by:
  \[
