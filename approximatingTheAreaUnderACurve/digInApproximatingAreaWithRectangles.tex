...
\begin{definition}
  When approximating an area with $n$ rectangles, the \textbf{grid points}
  \[
...
\begin{definition}
  When approximating an area with rectangles, a \textbf{sample point} is
...
\begin{definition}
  ...
  \]
  is called a \textbf{Riemann sum}, pronounced ``ree-mahn'' sum. 
\end{definition}
