...
\textcolor{red!70!black}{$\blacktriangleright$} $\cos(\theta + \phi)$ is the length of the adjacent side, which is 
...
\textcolor{red!70!black}{$\blacktriangleright$} $\sin(\theta + \phi)$ is the length of the opposite side, which is 
...
more examples can be found by following this link\\ \link[More Examples of The Unit Circle]{https://ximera.osu.edu/csccmathematics/precalculus/precalculus/theUnitCircle/examples/exampleList}
