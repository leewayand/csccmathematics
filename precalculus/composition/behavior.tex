...
If you move to the right on the number line, then the numbers are greater. 

If you move to the left on the number line, then the numbers are lesser. 
...
When the domain becomes greater, the function values also become greater.
...
When the domain becomes greater, the function values become lesser.
...
The \textbf{Chain Rule} tells us how to get the behavior of a composition from the individual behaviors of the component functions.


If we know 

\begin{itemize}
\item where $f$ increases and decreases
\item where $g$ increases and decreases
\end{itemize}

then, from that information we can deduce where $f\circ g$ increases and decreases.





\textbf{\textcolor{blue!55!black}{There are 4 possible combinations:}} 
...
\begin{warning} \textbf{\textcolor{red!70!black}{Both Ways}}
...
When the domain becomes greater, then the range becomes lesser.

It goes the other way as well.

When the domain becomes lesser, then the range becomes greater.
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Increasing}} 
...
\begin{idea}  \textbf{\textcolor{blue!55!black}{Decreasing}} 
