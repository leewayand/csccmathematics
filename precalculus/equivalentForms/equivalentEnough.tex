...
\begin{observation} \textbf{\textcolor{-red!75}{Equality}}
...
All this is due to the fact that the functions we are applying are not \textbf{one-to-one}.  More on that later.
