...
Given that $(a, b)$ is a pair in $L$, we know that $b = L(a)$.  And, if $(x, y)$ represents any other pair in $L$, we know that $y = L(x)$.  Replacing these in the equation for constant slope gives
