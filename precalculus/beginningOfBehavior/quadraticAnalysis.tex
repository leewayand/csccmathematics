...
\textcolor{gray!90}{\textbf{Graph Description:} Parabola opening down. Top point (vertex) at $(1,6.5)$. Intercepts are $(-4,0)$ and $(6,0)$.}
...
\textcolor{gray!90}{\textbf{Graph Description:} Parabola opening up. Bottom point (vertex) at $(-1,-6.5)$. Intercepts are $(-6,0)$ and $(4,0)$.}
...
\item the function either increases and then decreases or decreases and then increases depending on the sign of the leading coeffcient
\item the function either has a global maximum or minimum depending on the sign of the leading coeffcient
