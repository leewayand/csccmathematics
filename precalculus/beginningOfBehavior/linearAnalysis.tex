...
\begin{itemize}
     ...
     \text{    }$\circ$ discontinuities\\
     \text{    }$\circ$ singularities\\
     ...
     \text{    }$\circ$ intervals where increasing\\
     \text{    }$\circ$ intervals where decreasing\\
...
The graph above vividly suggests that linear functions are always increasing or always decreasing (unless they are constant).
