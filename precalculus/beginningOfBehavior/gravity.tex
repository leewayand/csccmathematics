...
If you want, we can add in more details like gravity changes as the object gets higher.
...
If we select a random point, $(x,y)$, on the parabola above, then the distance from this point to the focus has to equal the distance to the directrix.
