...
For \textbf{\textcolor{red!70!black}{EVERY}} open interval $I$ around $f(a)$, there exists a corresponding open interval around $a$, where \textbf{\textcolor{red!70!black}{ALL}} the function values are inside $I$.
...
$\blacktriangleright$ \textbf{Continuity:} For any and every selected interval around $f(a)$, you can find a corresponding interval around $a$, such that all their function values are inside the selected interval.
...
\textbf{ALL} the function values land inside the original $(2 - \epsilon, 2 + \epsilon)$ interval.
