...
For \textbf{\textcolor{red!70!black}{EVERY}} open interval $I$ around $f(a)$, there exists a corresponding open interval around $a$, where \textbf{\textcolor{red!70!black}{ALL}} of the function values are inside $I$.
