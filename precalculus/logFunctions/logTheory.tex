...
The basic logarithmic function just reverses the pairs in the basic exponential function.  If $(a, 2^a)$ is a pair in the exponential function, then $(2^a, a)$ is a pair in the corresponding logarithmic function.
...
\begin{tikzpicture}
  ...
  \begin{axis}[name=invexp,
          ...
          \addplot[color=penColor,fill=penColor2,only marks,mark=*] coordinates{(1,0)};

          \node[penColor2] at (axis cs:7,1) {$\log_{\tfrac{1}{2}}(x)$};
...
Unlike exponential functions, the $D$ can be absorded into the logarithm.
