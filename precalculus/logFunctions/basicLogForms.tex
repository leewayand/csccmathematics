...
\textbf{New Idea:} Logarithmic functions, are those functions which \textbf{\textcolor{red!80!black}{CAN}} be represented by formulas of the form $A \, \log_r(B \, x + C) + D$, where $r > 1$.  \\
...
\textbf{\textcolor{red!90!darkgray}{$\blacktriangleright$}}  Logarithmic functions, are those functions which \textbf{\textcolor{red!80!black}{CAN}} be represented by formulas of the form $A \, \ln(B \, x + C) + D$.  
...
\textbf{\textcolor{blue!55!black}{Basic Forms:}}  $\ln(x)$, $\ln(-x)$, $-\ln(x)$, $-\ln(-x)$ \\
