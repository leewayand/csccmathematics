...
\textbf{Question:} Do functions tend to infinity differently? 
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Approaching $\infty$}} 
...
\begin{summary} \textbf{\textcolor{red!70!yellow}{Order of Dominance}}
...
This goes for their positive powers as well. 
...
\[
\lim\limits_{x \to \infty} \frac{x^6}{e^x} = \answer{0}
\]
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Upside-down}}


When we talk about dominance, we phrase it in terms of approaching $0$.  The quotient might be approaching $0$ through positive numbers or negative numbers.  It doesn't matter because $-0 = 0$.


If  our quotient is upside-down and the dominate function is in the numerator, then we also need to think about the sign.
...
A \textbf{term} is an expression that is added or subtracted.
...
$\blacktriangleright$ As $t$ approaches $\infty$, $3e^t$ dominates $-5$. 

$\blacktriangleright$ As $t$ approaches $\infty$, $3^t$ dominates $1$. 




As $t$ approaches $\infty$, the exponential pieces will dominate the constant pieces in each expression.  
...
As $t$ approaches $-\infty$, we have a different story.   
