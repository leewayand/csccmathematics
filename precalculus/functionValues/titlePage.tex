...
$\blacktriangleright$ A \textbf{\textcolor{purple!85!blue}{graph}} is a visual tool that shows us a picture of all the pairs.  It is a global tool. However, graphs are produced with tools, like chalk, pencils, or ink.  Since points are dimensionless, we can't actually see them. Chalk and ink are huge blobs exaggerating the location of points so that our eyes can see them.  Because of this, a graph is inherently inaccurate.  There is nothing we can do about this. We can approximate, but we cannot get exact values.  


We use formulas and graphs for different purposes. They provide different views of a function.  On the other hand, they both essentially provide the same information, function values. And that is what we want from them.
...
\item  \textbf{\textcolor{blue!75!black}{How do I explain this to people?}}
\end{itemize} 
...
\begin{onlineOnly}
\begin{center}\textbf{\textcolor{green!50!black}{ooooo-=-=-=-ooOoo-=-=-=-ooooo}} \\
