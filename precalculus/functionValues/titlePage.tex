...
$\blacktriangleright$ A \textbf{\textcolor{purple!85!blue}{graph}} is a visual tool that shows us a picture of all of the pairs.  It is a global tool. However, graphs are produced with tools, like chalk, pencils, or ink.  Since points are dimensionless, we can't actually see them. Chalk and ink are huge blobs exaggerating the location of points so that our eyes can see them.  Because of this, a graph is inherently inaccurate.  There is nothign we can do about this. We can approximate, but we cannot get exact values.  
