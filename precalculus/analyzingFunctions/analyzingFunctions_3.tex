...
\textbf{\textcolor{red!75!green}{With these ideas from the graph, we can turn to algebra.}} 
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Singularity Behavior}} 
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Order}} 
...
\textbf{$\blacktriangleright$} On $\left( 2, \frac{1 + 2 \sqrt{10}}{3} \right)$, $R$ is increasing. 



\textbf{$\blacktriangleright$} On $\left( \frac{1 + 2 \sqrt{10}}{3} \right), 3$, $R$ is decreasing. 
...
\textbf{Hint:} We can see a gap in the graph. 
...
more examples can be found by following this link\\ \link[More Examples of Analyzing Functions]{https://ximera.osu.edu/csccmathematics/precalculus/precalculus/analyzingFunctions/examples/exampleList}
