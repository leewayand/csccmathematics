...
\begin{quote}
We need all the \textbf{\textcolor{purple!85!blue}{domain numbers}} that are close to our domain number under observation.
\end{quote}



We don't need all the \textbf{\textcolor{purple!70!blue}{real numbers}} that are close to our domain number under observation. We just need the real numbers that are actually members of the domain.
...
\textbf{Remember}, we are after some language that works ALL the time, even for endpoints.   



``Space'' will refer to \textbf{\textcolor{red!70!darkgray}{domain space}} that exists ``around'' our domain number under observation. 
