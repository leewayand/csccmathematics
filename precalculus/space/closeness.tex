...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}}  How do you talk about surrounding numbers within a distance of $0$, except not $0$?
...
\begin{fact}  \textbf{\textcolor{red!75!green!50}{$0$}} 
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Close}} 
...
Now consider \textbf{\textcolor{red!70!black}{ALL}} the intervals described by $(d - \delta, d + \delta)$ for \textbf{\textcolor{red!70!black}{ALL}} possible values of $\delta$.
...
\item They get as small as anyone might wish for any chosen level of ``closeness''.
\end{itemize}

These $\delta$-intervals handle all the closeness situations.  If someone wants a particular closeness, then there is a $\delta$-interval that matches their closeness.



\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} \textbf{\textcolor{purple!85!blue}{More Importantly:}} If we are not sure of the level of closeness, then we can talk about \textbf{\textcolor{red!70!black}{ALL}} the $\delta$-intervals and have \textbf{\textcolor{red!70!black}{ALL}} the possibilities covered at once.
...
\begin{example} Eventually


Consider the interval $(-0.5, 0.3)$.

\textbf{\textcolor{blue!55!black}{Q:}} Is \textbf{EVERY} interval of the form $(0.2 - \delta, 0.2 + \delta)$ completely contained inside $(-0.5, 0.3)$?


\textbf{\textcolor{blue!55!black}{A:}} Of course not.  Just take $\delta = 0.2$.  The interval $(0.2 - 0.2, 0.2 + 0.2) = (0, 0.4)$ is not inside $(-0.5, 0.3)$.



Now try $\delta = 0.05$.

The interval $(0.2 - 0.05, 0.2 + 0.05) = (0.15, 0.25)$ is  inside $(-0.5, 0.3)$.
And this remains true for \textbf{\textcolor{red!70!black}{EVERY}} value of $\delta < 0.05$.  They \textbf{\textcolor{red!70!black}{ALL}} work.


\textbf{\textcolor{red!70!black}{EVENTUALLY}}, there is a value for $\delta$ so that $(0.2 - \delta, 0.2 + \delta)$ is inside $(-0.5, 0.3)$ for \textbf{\textcolor{red!70!black}{ALL}} values less that this particular value of $\delta$.
...
We can use this idea to talk about numbers ``around'' the number $a$.  Given a real number $a$ and a distance $\delta$, we could describe all of the real numbers closer to $a$ than a distance of $\delta$.  They would be the numbers inside the interval $(a-\delta, a+\delta)$, which we could describe with absolute value.
...
If we are interested in our analysis working \textbf{\textcolor{red!70!black}{all}} the time, then let's just stick with open intervals.  They \textbf{must} provide space ``around'' \textbf{\textcolor{red!70!black}{all}} the numbers they contain. 

Choosing to work with open intervals avoids possible problems that closed intervals might cause.
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Image}}
...
The \textbf{image} of $T$ is the collection of all the function values from the domain numbers inside $T$.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} Actually, a range target interval is often too difficult to hit EXACTLY.  Instead, let's just try to land inside the target interval. 
...
To land near $6$ with $f(x) = 2x + 5 = 6$, our domain number, $x$, would need to be near $\frac{1}{2}$.  
...
\begin{definition}  \textbf{\textcolor{blue!55!black}{Preimage}}
...
However, if we get the preimage of this set, then we get
...
We may need to pay special attention to endpoints.
