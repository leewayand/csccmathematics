...
Now consider \textbf{\textcolor{red!70!black}{ALL}} of the intervals described by $(d - \delta, d + \delta)$ for \textbf{\textcolor{red!70!black}{ALL}} possible values of $\delta$.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} \textbf{\textcolor{purple!85!blue}{More Importantly:}} If we are not sure of the level of closeness, then we can talk about \textbf{\textcolor{red!70!black}{ALL}} of the $\delta$-intervals and have \textbf{\textcolor{red!70!black}{ALL}} of the possibilities covered at once.
...
\begin{definition} (from earlier) \textbf{\textcolor{green!50!black}{Image}}
...
\begin{definition} (from earlier) \textbf{\textcolor{green!50!black}{Preimage}}
