...
\item \textbf{singularities:} $\sec(\theta)$ has a singularity everywhere that $\cos(\theta)$ has a zero:  all of the half-$\pi$'s.
\end{itemize}
...
\begin{tikzpicture}[line cap=round]
  \begin{axis}[
          ...
          \draw [ultra thick, textColor] (axis cs:0,0) -- (axis cs:1.305,0);
          \draw [ultra thick, textColor] (axis cs:0.766,0.643) -- (axis cs:1.305,0);
          %\draw [ultra thick] (axis cs:0,1.557) -- (axis cs:1.305,0);
          %\draw [ultra thick] (axis cs:0,1.557) -- (axis cs:0,0);
          ...
          %\addplot [ultra thick,textColor] plot coordinates {(.766,0) (.766,.643)}; %% 40 degrees
          \addplot [ultra thick,textColor] plot coordinates {(0,0) (.766,0)}; %% 40 degrees
          ...
          %\addplot [very thick, penColor, smooth, domain=(0:40)] ({cos(x)},{sin(x)}); %% sector
          \node at (axis cs:.15,.07) [anchor=west] {$\theta$};
          %\node[textColor] at (axis cs:0.85,.27) {$b$};
          \node[textColor] at (axis cs:.383,0) [anchor=north] {$a$};
          %\node[penColor3, rotate=-90] at (axis cs:1.06,.322) {$\tan(\theta)$};
           \node[textColor] at (axis cs:0.37,0.4) {$1$};
