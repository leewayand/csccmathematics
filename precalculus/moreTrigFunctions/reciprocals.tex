...
\begin{warning} \textbf{\textcolor{red!70!black}{Warning}}
...
\begin{fact} \textbf{\textcolor{red!75!green}{Signs of Reciprocals}} 
...
Conside the two rational functions from the previous example.
...
The fraction for $f$ becomes greater and greater as the domain becomes greater. 

That means its reciprocal becomes lesser and lesser as the domain becomes greater. 

$g = \frac{1}{f}$ is a decreasing function.




\begin{fact}  \textbf{\textcolor{red!75!green}{Behavior of Reciprocals}} 
