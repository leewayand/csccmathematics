...
A \textbf{general secant function} is any function that \textbf{\textcolor{purple!85!blue}{CAN}} be represented with a formula of the form
...
A \textbf{general cosecant function} is any function that \textbf{\textcolor{purple!85!blue}{CAN}} be represented with a formula of the form
...
A \textbf{general cotangent function} is any function that \textbf{\textcolor{purple!85!blue}{CAN}} be represented with a formula of the form
...
This is a sine function, because it matches our template, $A \sin(B x + C) + D$.
...
The reason that this cannot happen is that $\sin(t) + 2$ can never equal $0$. That means that the domain of $\frac{1}{\sin(t) + 2}$ is all real numbers.
...
If we just stay with $0$ as constant terms, then the reciprocal of sine functions are cosecant functions.
...
\begin{warning} \textbf{\textcolor{red!70!black}{Reciprocals}} 
...
more examples can be found by following this link\\ \link[More Examples of Trig Functions]{https://ximera.osu.edu/csccmathematics/precalculus/precalculus/moreTrigFunctions/examples/exampleList}
