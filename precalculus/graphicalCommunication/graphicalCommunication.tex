...
\begin{itemize}
\item \textbf{Solid Dots} at endpoints, indicating that the enpoint is included in the graph.
\item \textbf{Hollow Dots} dots at endpoints, indicating that the enpoint is not included in the graph.
