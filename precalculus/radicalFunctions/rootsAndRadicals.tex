...
The nth-root is an exponent, so it follows all the exponent rules.
...
The Elementary Functions also include root and radical functions.
...
The leading coefficient tells us the end-behavior. Here the leading coefficient of $f$ is $\frac{1}{3}$, which is positive.
...
more examples can be found by following this link\\ \link[More Examples of Radical Functions]{https://ximera.osu.edu/csccmathematics/precalculus/precalculus/radicalFunctions/examples/exampleList}
