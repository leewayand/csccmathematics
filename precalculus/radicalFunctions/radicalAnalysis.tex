...
\begin{example} Radical Function

Completely (Algebraically) analyze
...
The inside is $5-2y$, which is a linear function with a negative leading coefficient.  That tells us that the value of $5-2y$ is nonnegative for numbers less than its zero, which is $\frac{5}{2}$.
...
\begin{itemize}
\item Let $L_{out}(v) = -3 \, v + 4$, a decreasing linear function
\item Let $SQ(t) = \sqrt{t}$, an increasing core square root function
\item Let $L_{in}(u) = 5 - 2 \, u$, a decreasing linear function
\end{itemize}

\[  R(y) = (L_{out} \circ SQ \circ L_{in})(y)  \]
