...
\textbf{Zeros:} If the constant function just happens to be the zero function and every value is $0$, then every number in the domain is a zero of the function.
...
\textbf{Domain:} The domain of the identity function is $(-\infty, \infty)$.
