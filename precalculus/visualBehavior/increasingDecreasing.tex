...
\textbf{Note:} You cannot merely test the endpoints of an interval to show a function is increasing throughout the interval.  It has to increase for EVERY pair of numbers in the interval.
...
\textbf{Note:} You cannot test the endpoints of an interval to show a function is decreasing throughout the interval.  It has to decrease for EVERY pair of numbers in the interval. 
