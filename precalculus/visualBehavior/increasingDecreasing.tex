...
When the domain values become greater, than the function values also become greater.  

When the domain values become lesser, the function values also become lesser.  
...
\textbf{Note:} You cannot merely test the endpoints of an interval to show a function is increasing throughout the interval.  It has to increase for EVERY possible pair of numbers in the interval.
...
When the domain values become greater, than the function values become lesser.  

When the domain values become lesser, the function values become greater.  
...
\begin{itemize}
    \item If the value of the numbers become greater as we step through the positions of the numbers, then we say the list (sequence) of numbers \textbf{increases}.  
    \item If the value of the numbers become lesser as we step through the positions of the numbers, then we say the list (sequence) of numbers \textbf{decreases}. 
\end{itemize}
...
A \textbf{counterexample} is one example where all of the required conditions of a statement are met, yet the conclusion is not true.  
