...
\begin{tikzpicture}
  \begin{axis}[
            ...
            axis lines =center, xlabel={$\theta$}, ylabel={$y = \arctan(x)$}, grid = major, grid style={dashed},
...
\begin{definition} \textbf{\textcolor{green!50!black}{$\arctan$}}


$\arctan(t)$ is defined to be the angle, $\theta$, in the interval $\left( -\frac{\pi}{2}, \frac{\pi}{2} \right)$ such that $\tan(\theta) = t$
...
We can deduce many characteristics about $\arctan$ from tangent.
