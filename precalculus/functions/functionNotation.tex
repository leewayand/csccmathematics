...
\item Mathematics is a language. We use it to describe and communicate our scientific discoveries.
\end{itemize}

As a language, mathematics has all the trappings, idioms, shorthand, and homographs as any other language. In Precalculus and Calculus, function notation is a part of the language, and it requires our fullest attention.  
...
And, just like letters forming words, we overuse these symbols in mathematics.  We use the same arrangement of symbols to mean different ideas. 

\textbf{Word Example:} bat 

Is a bat flying around in a cave or are you trying to hit a baseball with a bat? 
...
On the other hand, if $f$ is the name of a variable, then this is just multiplication and we can distribute.
...
For instance: defining $f(x) = \sqrt{7-x}$ and $g(x) = \frac{1}{4-x}$ is not a good idea.
...
This idea spills over into all our notation.
