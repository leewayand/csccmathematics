...
\textbf{Note:} This third set does not seem to have an official title.
\end{definition}
...
\textbf{Note:} The order in our notation is important. 
...
The overall idea is that while investigating our world, we discover some structure (connection) between collections of information.  The structure probably is a connection between two measurements. Relations are our way of mathematically \textbf{\textcolor{blue!55!black}{modeling}} this connection.


We then use the relation model to think about the connection, mathematically.  We draw conclusions about the relation model, inside mathematics. These conclusions describe structure about the relation model, inside mathematics.
...
That is basically all we ever do, address these two types of questions. The form the foundation of function analysis.
