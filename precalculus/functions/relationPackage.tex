...
The overall idea is that while investigating our world, we discover some structure (connection) between collections of information.  The structure probably is a connection between two measurements. Relations are our way of mathematically \textbf{\textcolor{red!80!black}{modeling}} this connection.
