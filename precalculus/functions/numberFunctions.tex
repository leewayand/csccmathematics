...
\begin{question} Effective Price
...
\begin{question} Squaring Function
...
\textbf{Note:} The identity funciton both a one-to-one and onto function.
...
For the most part, we view the domain as a static set from which the function selects numbers. But, the geometry of the domain influences how a function behaves.
