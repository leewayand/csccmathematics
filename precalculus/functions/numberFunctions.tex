...
\textbf{Note:} The identity function both a one-to-one and onto function.
...
For the most part, we view the domain as a static set from which the function selects numbers. However, we also view the real numbers as lining up to for a number line. This provides a geometrical viewpoint and the geometry of the domain can influence how a function behaves.
