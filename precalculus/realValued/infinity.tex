...
$\infty$ tells us that there is no number greater than all of the numbers in this interval/set.



\item The interval $(-\infty, 4)$ describes the set of all real numbers less than $4$.  \\
$-\infty$ tells us that there is no number less than all of the numbers in this interval/set.
\end{itemize}
...
We will need language to talk algebraically and rigorously about $\infty$. We have such language.  
