...
\begin{warning}  Size and Position
...
$7-3$ represents the distance between $7$ and $3$, whereas $3-7$ does not.

Of course  $3-7$ is just the negative of $7-3$. $7-3$ and $3-7$ are the same distance from $0$.  Therefore, the distance of either $7-3$ or $3-7$ from $0$ is the also the distance between $3$ and $7$.
...
Factoring out fractions thaty represent $1$ will work every time and avoid all of the trouble and frustration that comes with cancelling.
