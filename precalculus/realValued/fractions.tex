...
\begin{warning} \textbf{\textcolor{red!70!black}{the Fraction Bar}}
...
\begin{idea} \textbf{\textcolor{blue!55!black}{$1$}} 
...
\begin{warning}  \textbf{\textcolor{red!70!black}{$0$}}
...
Similar to the number $1$, All our fractional representations of $0$ follow a pattern.
...
\begin{idea} \textbf{\textcolor{blue!55!black}{$0$}} 
...
\begin{warning} \textbf{\textcolor{red!70!black}{Denominators}}
...
The $0$ in this denominator is ok.
...
The $0$ in this denominator is not ok.
...
$3$ is greater than $-5$, since $3$ is to the right of $-5$ on the number line.
...
We often think of subtraction as giving the distance between two numbers. However, this only works if the difference has a positive value, because distance cannot be negative.
...
Since the fractions of the form $\frac{small}{small}$  or  $\frac{big}{big}$ could represent big or small numbers, we know that we cannot immediately determine the overall size of the fractions.  We use the word ``\textbf{\textcolor{blue!55!black}{indeterminate}}'' for such expressions.
