...
We will be investigating functions that are defined on sets. Naturally, mathematics has symbols, notation, vocabulary, and pronunciation for sets. \\
...
\textbf{\textcolor{blue!55!black}{Subset:}}  The symbol $\subset$ means ``is a proper subset of''. A proper subset is a collection of members of a larger set, but not every memebe from the larger set.
