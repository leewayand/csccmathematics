...
\textbf{\textcolor{blue!55!black}{Subset:}}  The symbol $\subseteq$ means ``is a subset of''.  A subset is a collection of members of another set.
...
\textbf{\textcolor{blue!55!black}{Subset:}}  The symbol $\subset$ means ``is a proper subset of''. A proper subset is a collection of members of a larger set, but not every member from the larger set.
...
\textbf{Proper} means that the smaller subset is not equal to the larger set. Something is not included.
...
The union of two sets is another set.  The union contains all the members of the two original sets.
...
The intersection of two sets is another set.  The intersection contains all the members shared by the two original sets.
...
The empty set is a set.  Every member of the empty set is in the original set, because it contains no members.
...
\textbf{\textcolor{red!50!green}{epsilon:}}  $\epsilon$ 

\textbf{\textcolor{red!50!green}{delta:}}  $\delta$ 
...
$\epsilon$ and $\delta$ are how we often talk algebraically about ``close''. 





\begin{warning} \textbf{\textcolor{red!70!black}{Not Specific Numbers}} 
...
Separate from this are ``greater than'' and ``less than'', which are position words. 
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} ``Greater'' or ``greater than'' mean to the right of on the number line. These words describe relative position.
...
\begin{example} Smaller and Less Than
...
\begin{example} Bigger and Less Than
