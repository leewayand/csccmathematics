...
\textbf{\textcolor{blue!55!black}{Subset:}}  The symbol $\subset$ means ``is a proper subset of''. A proper subset is a collection of members of a larger set, but not every memeber from the larger set.
