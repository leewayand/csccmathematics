...
We are NOT pointing to the graph as our reasoning about function information. 


The two should agree!  Our algebra and the graph should agree.  We can use a graph to help us make decisions about using algebra.
...
\begin{observation}   \textbf{\textcolor{-red!75}{Tangent?}} 
