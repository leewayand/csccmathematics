...
All of the features and characteristics we discover will repeat with a period of $\frac{\pi}{2}$.
...
Since the values of $H$ come from the values of $Out$, we are first looking for zeros of $Out$.  

$Out(t) = 2t + 1$ is a linear function and has only one zero, $-\frac{1}{2}$. 
