...
Completely analyzing a rational function is impossible without the derivative. 
...
Here, $-7$, $-5$, and $2$ are zeros of the numerator.  However, $2$ is not in the domain, because it is also a zero of the denominator.
...
That means they are continuous on their domains. They have no discontinuities.
...
$(t+7)(t+5)$ is a quadratic function with a positive leading coefficient. Therefore, $(t+7)(t+5)$ is positive on $(-5, \infty)$, which contains $-4$.
...
The best we can do is approximate from the graph.
...
\textbf{Note:} We have seen that there is plenty of reasons not to totally believe our eyes when examining a graph.
...
\textbf{\textcolor{purple!85!blue}{Local Maximums and Minimums}} 
...
\textbf{\textcolor{purple!85!blue}{Global Maximum and Minimum}} 
