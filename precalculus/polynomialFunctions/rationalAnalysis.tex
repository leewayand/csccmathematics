...
Analyzing a rational function completely is impossible without the derivative. So, let's consider the situation where we have the function and its derivative. 
...
There are no other local extrema, since there are no other critical numbers.
...
$G$ only has one critical number, $-\frac{11}{2}$, which is the location of a local minimum.  To decide if it is a global minimum, we need to know if it is greater than or less than the end-bhavior value of $1$.
...
This is less than $1$, so this is the global minimum value of $G$. 
...
$G$ has three connected pieces, since the domain has three maximal intervals.  The range of $G$ is the union of the ranges on those three pieces. 





\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $( -\infty, -4)$, 

$G$ is continuous.

$\lim\limits_{t \to -4^-} G(t) = \infty$

$G$ has a minimum value of $-\frac{1}{3}$ at $-\frac{11}{2}$.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $(-4, 2)$, 
...
\[
\lim\limits_{t \to 2^-} G(t) = \lim\limits_{t \to 2^-} \frac{(t+7)(t+5)}{(t+4)^2} = \frac{63}{36}
\]




The range is $\left( \frac{63}{36}, \infty \right)$.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}}On $(2, \infty)$, 
...
The range is $\left( 1, \frac{63}{36} \right)$.
...
\[
\left[ -\frac{1}{3}, \infty \right) \cup \left( \frac{63}{36}, \infty \right) \cup  \left( 1, \frac{63}{36} \right) = \left[ -\frac{1}{3}, \infty \right)
\]
