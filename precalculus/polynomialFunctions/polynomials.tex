...
Polynomials are nice.  Their graphs have hills and valleys. Their graphs do not have corners or cusps or vertical tangents.


For polynomials, \textbf{critical numbers} are domain numbers, which correspond to points on the graph where the tangent line has slope $0$ (is horizontal).
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} Zeros, Factors, and Intercepts are different things but they all refer to the same information.
