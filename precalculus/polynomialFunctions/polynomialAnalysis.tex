...
Since our analysis rests on zeros of functions and zeros of their derivatives, the standard form for a polynomial is just not that helpful.  Our analysis prefers a factored form. 
...
\textbf{\textcolor{blue!55!black}{$\bullet$}} If our polynomial is a constant function, then it always has a $0$ derivative and $0$ rate of change.


\textbf{\textcolor{blue!55!black}{$\bullet$}} If our polynomial is a linear function, then it has a constant rate of change. The leading coefficient tells us if the linear function is always increasing or always decreasing.


\textbf{\textcolor{blue!55!black}{$\bullet$}} If our polynomial is a quadratic function, then it has a linear derivative. The leading coefficent tells us if the quadratic function increases and then decreases or the other way around.  This coincides with the sign of the derivative.
...
Another way to see this is by noting that $p'(w)$ is a quadratic with a negative leading coefficient, which means its values follow $pos - neg - pos$ pattern.
