...
These are called \textbf{Piecewise Defined} functions.
...
\begin{procedure} \textbf{\textcolor{purple!30!blue}{Building Piecewise Defined Functions}} 
...
Of course, we must make sure that we do not duplicate domain numbers, otherwise we will not have a function.  This new collection of pairs will automatically give us a domain by collecting all the first coordinates.
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Step Function}
}
\begin{onlineOnly}
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Function Behavior}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
