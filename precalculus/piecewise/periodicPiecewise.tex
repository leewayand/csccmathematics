...
\begin{definition} \textbf{\textcolor{green!50!black}{Periodic Function}}


A function $f$ is said to be \textbf{periodic} if there exists a real number $p \ne 0$ such that
...
Let's begin with a function whose graph looks like an iscosceles triangle.
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Tooth Function}
}
\begin{onlineOnly}
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Sawtooth Function}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
...
\begin{remark}  \textbf{\textcolor{yellow!35!black}{Etymology}}
...
The domain of \textit{sine} and \textit{cosine} are real numbers interpreted as angle measurements measured counterclockwise from the positive horizontal axis.  We have two units for measuring these angles.
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Cosine}}
\begin{itemize}
\item With Degrees: \\
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Sine}}
\begin{itemize}
\item With Degrees: \\
As the angle, $\theta$, rotates counter-clockwise the values of sine start at $0$, increases to $1$ at $90^\circ$, decreases to $0$ at $180^\circ$, keeps decreasing to $-1$ at $270^\circ$, increases to $0$ at $360^\circ$.  These values continue to repeat with a period of $360^\circ$.

\item With Radians: \\
As the angle, $\theta$, rotates counter-clockwise the values of sine start at $0$, increases to $1$ at $\frac{\pi}{2}$, decreases to $0$ at $\pi$, keeps decreasing to $-1$ at $\frac{3\pi}{2}$, increases to $0$ at $2\pi$.  These values continue to repeat with a period of $2\pi$.
\end{itemize}
\end{idea}
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Sine and Cosine}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
...
\begin{warning} \textbf{\textcolor{red!70!black}{Radians vs. Degrees}}
...
We call the interval $[0, 2\pi)$, the \textbf{principal interval} for sine and cosine. 

From the graphs we can see that Sine and Cosine have maximum and minimum values.



\begin{explanation}   \textbf{\textcolor{red!75!green}{Extreme Values}} 
\begin{itemize}
...
\begin{center}
\textbf{\textcolor{red!70!black}{Memorize this Circle}}
\end{center}
...
\textbf{\textcolor{blue!55!black}{On the Other Hand...}}


Take another look at the unit circle above. Each of the four quadrants have the same numbers for the easy angles, with a slight sign adjustment for the quadrant.

Therefore, we only need to memorize the numbers in the first quadrant and then move them around the circle with the appropriate signs.

Besides $0$ and $1$, there are three numbers to memorize


\begin{center}
$\frac{1}{2}$, $\frac{\sqrt{3}}{2}$, and $\frac{1}{\sqrt{2}}$
\end{center}


The angles $\frac{\pi}{4}$, $\frac{3\pi}{4}$, $\frac{5\pi}{4}$, and $\frac{7\pi}{4}$ all cut their quadrants in half.  The move up diagonally through each quadrant.  There coordinates on the unit circle all use $\frac{1}{\sqrt{2}}$, with the appropriane sign for the quadrant.

The angles $\frac{1}{2}$ and $\frac{\sqrt{3}}{2}$ always appear together, with the appropriate sign for the quadrant. One of the coordinates is a bigger number than the other and $\frac{1}{2} < \frac{\sqrt{3}}{2}$.  

With these three angles, we can investigate and of the ``easy'' angles in the unit circle.
