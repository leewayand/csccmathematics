...
We have many famous functions, which are piecewise defined functions.  We have already seen the step function.  It acts as a mathematical on/off switch.
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Absolute Value}
}
\begin{onlineOnly}
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Greatest Integer Function}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
