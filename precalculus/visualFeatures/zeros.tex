...
It might be useful information if the function was modeling some situation, so that the domain was an applied domain.
...
\begin{tikzpicture}
     \begin{axis}[
        ...
        %\addplot [draw=penColor, very thick, smooth, domain=(-8:-4),->] {-(x+8)*(x+5)+5};
        \addplot [draw=penColor, very thick, smooth, domain=(-4:4),<->] {sin(deg(x*6.28))};
        %\addplot [draw=penColor, very thick, smooth, domain=(4:6),->] {-2*x+15};
