...
\begin{itemize}
\item \textbf{\textcolor{blue!75!black}{Removeable:}}  The graph above has a very subtle break at $t=-6$. The graph is almost one piece, except one point has been shifted vertically. This type of break gets the name \textit{removeable}, because you could remove the break by just sliding that one point back in place. 
