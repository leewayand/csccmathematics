...
\end{itemize}
It turns out ``weird'' includes a lot of behavior.  It will take a while to state a \textbf{\textcolor{purple!85!blue}{rigorous}} definition of singularity, because it will involve the derivative.  In the mean time, we will keep noting weird behavior and building our feeling of weird.
...
\begin{example} Discontiuity and Singularity
