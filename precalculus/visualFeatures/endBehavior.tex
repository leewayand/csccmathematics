...
We have language for end-behavior. \\
...
We use graphic symbols on our graphs to communicate to readers how the function behaves in the two tails of thee domain.  These are horizontal asymptotes and are drawn as dashed horizontal lines on the graph.\\
...
The horizontal asymptote graphically gives the same information as 
...
The missing horizontal asymptote graphically gives the same information as 
...
If that wasn;t true, then the author of the graph would have included a horizontal asymptote, and they didn't.
