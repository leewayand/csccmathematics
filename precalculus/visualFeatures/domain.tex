...
The domain would be the collection of all the first coordinates of all the plotted points on the graph. 
...
If we drop all the points down to the horizontal axis, we get a picture of the domain. 
