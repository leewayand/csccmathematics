...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot [draw=penColor2, very thick, smooth, domain=(-10:10),<->] {0};
        %\addplot [draw=penColor, very thick, smooth, domain=(3:8), <->] {1/(x-3) + 2};
...
The domain of the function $p$ is $(-\infty, -6) \cup (-6,3) \cup (3,\infty)$. 
...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot [draw=penColor2, very thick, smooth, domain=(-9:8)] {0};
        %\addplot [draw=penColor, very thick, smooth, domain=(3:8), <->] {1/(x-3) + 2};
...
\begin{tikzpicture}
     \begin{axis}[
        ...
        \addplot[color=penColor2,fill=penColor,only marks,mark=*] coordinates{(-1,-1.5)};
         \addplot[color=penColor2,fill=white,only marks,mark=*] coordinates{(3,0.5)};
