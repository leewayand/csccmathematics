...
\subsection*{Core Cosine Function}
...
A point can be rotated counterclockwise (positive angles) and clockwise (negative angles) any number of rotations.
...
\begin{observation} \textbf{\textcolor{-red!75}{Cosine is the $x$-coordinate}}

The idea is that the core cosine function describes the $x$-coordinate as you travel counterclockwise around the unit circle.

The characteristics of the core cosine function hold steady during each quadrant, changing at the angles $0$, $\frac{\pi}{2}$, $\pi$, $\frac{3\pi}{2}$, and $2\pi$. From there, they keep repeating.
...
We can build more general cosine functions as we have been doing, through compositions.



\begin{idea} \textbf{\textcolor{blue!55!black}{General Cosine Functions as Compositions}} 


\begin{itemize}
\item Let $L_{out}(u) = A \, u + D$, a linear function
\item Let $C(\theta) = \cos(\theta)$, the core cosine function
\item Let $L_{in}(v) = B \, v + C$, a linear function
\end{itemize}


\[
A \, \cos(B \, t + C) + D = (L_{out} \circ C \circ L_{in})(t)
\]
...
\item Let $C(\theta) = \sin(\theta)$, the core cosine function
\item Let $L_{in}(v) = 2 \, v + \frac{\pi}{2}$, an increasing linear function
\end{itemize}


\[
f(x) = \cos\left( 2 x + \frac{\pi}{2} \right) = (L_{out} \circ S \circ L_{in})(x)
\]


The core cosine funtion increases and decreases as the angle passes through the four quadrants.
...
Since both linear functions in our composition are increasing linear functions, the behavior of the whole composition will be the same as the behavior of cosine.

\textbf{\textcolor{blue!55!black}{Behavior}} 



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (I):}} On $\left( -\frac{\pi}{4}, 0 \right)$, $f(x) = inc \circ dec \circ inc$. $f$ decreases from $1$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (II):}} On $\left( 0, \frac{\pi}{4} \right)$, $f(x) = inc \circ dec \circ inc$. $f$ decreases from $0$ to $-1$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (III):}} On $\left( \frac{\pi}{4}, \frac{\pi}{2} \right)$, $f(x) = inc \circ inc \circ inc$. $f$  increases from $-1$ to $0$.


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (IV):}} On $\left( \frac{\pi}{2}, \frac{3\pi}{4} \right)$, $f(x) = inc \circ inc \circ inc$. $f$  increases from $0$ to $1$.
...
The variable in $f(x) = \cos\left( 2 x + \frac{\pi}{2} \right)$ is $x$.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (I):}} On $\left( -\frac{\pi}{12}, \frac{\pi}{12} \right)$, $inc \circ dec \circ dec = dec$ : $g(t)$ increases from $0$ to $1$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (II):}} On $\left( -\frac{\pi}{4}, \frac{\pi}{4} \right)$, $inc \circ dec \circ dec = dec$ : $g(t)$ increases from $-1$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$(III):}} On $\left( -\frac{5\pi}{12}, -\frac{\pi}{4} \right)$, $inc \circ inc \circ dec = dec$ : $g(t)$ decreases from $0$ to $-1$.
...
All this repeats with a period of $\frac{2\pi}{3}$.
...
\textbf{Note:}  In the example above, the inside of the cosine function is a linear function with a negative leading coefficient.  That has reversed the behavior from the core cosine function.





\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} In addition to the leading coefficient of the inner linear function, the cosine function itself has a leading coefficient.  When it is negative, the behavior reverses again.
...
\item Let $C(\theta) = \cos(\theta)  \, u$, the core cosine function.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (I):}} On $\left( 3 \pi, \frac{9\pi}{2} \right)$, $dec \circ dec \circ inc = inc$ : $f(k)$ decreases from $1$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (II):}} On $\left( \frac{9\pi}{2}, 6 \pi \right)$, $dec \circ dec \circ inc = inc$ : $f(k)$ decreases from $0$ to $-1$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (III):}} On $\left( 6 \pi, \frac{15\pi}{2} \right)$, $dec \circ inc \circ inc = dec$ : $f(k)$ increases from $-1$ to $0$.


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (IV):}} On $\left( \frac{15\pi}{2}, 9 \pi \right)$, $dec \circ inc \circ inc = dec$ : $f(k)$ increases from $0$ to $1$.
...
Since cosine is continuous, the extreme values give a range of $[-2,2]$.
...
\begin{formula} \textbf{\textcolor{blue!55!black}{Core Cosine Function}}

The \textbf{Core Cosine Function} is any function that \textbf{\textcolor{purple!85!blue}{CAN}} be represented with the formula 
...
A \textbf{General Cosine Function} is any function that \textbf{\textcolor{purple!85!blue}{CAN}} be represented with a formula of the form
...
\[     C(x) = A \cos(B \, x + C) + D = (L_{out}(u) \circ C \circ L_{in})(x)          \]
