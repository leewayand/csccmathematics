...
Reading the graph of the basic cosine function from left, we see that the basic cosine function decreases across two quadrants then increases across two quadrants.


Reading the graph of the cosine function in the example above, from left we see that the cosine function decreases across two quadrants then increases across two quadrants.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (I):}} On $\left( 3 \pi, \frac{9\pi}{2} \right)$, $f(x)$ decreases from $1$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (II):}} On $\left( \frac{9\pi}{2}, 6 \pi \right)$, $f(x)$ decreases from $0$ to $-1$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (III):}} On $\left( 6 \pi, \frac{15\pi}{2} \right)$, $f(x)$ increases from $-1$ to $0$.


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (IV):}} On $\left( \frac{15\pi}{2}, 9 \pi \right)$, $f(x)$ increases from $0$ to $1$.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( 3 \pi, \frac{9\pi}{2} \right)$, $f(x)$ increases from $-2$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( \frac{9\pi}{2}, 6 \pi \right)$, $f(x)$ increases from $0$ to $2$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( 6 \pi, \frac{15\pi}{2} \right)$, $f(x)$ decreases from $2$ to $0$.
