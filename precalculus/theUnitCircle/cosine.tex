...
\textbf{Note:}  In the example above, the inside of the cosine function is a linear function with a negative leading coefficent.  That has reversed the behavior from the core cosine function.
...
\begin{formula} \textbf{\textcolor{blue!55!black}{Core Cosine Functions}}
