...
These are the values of $\frac{\pi}{4} - 2 t$.
...
We will mold these into functions later in the course, by restricting the range.  Restricting the range will comply with the one and only function rule.  These funcitons will be called \textbf{arcsine} and \textbf{arccosine}.
...
The point $(a,b)$ has a distance from the origin.  Let's call this angle $r$.
...
$\theta$ is an angle whose tangent is $\frac{12 \sqrt{3}}{-12} = -\sqrt{3}$.
