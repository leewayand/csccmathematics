...
Two such angle are the angles $\frac{7\pi}{6}$ and $\frac{11\pi}{6}$.
...
\[ 
3x - \pi = \frac{7\pi}{6} + 2 \pi k \, \text{ where } \, k \in \mathbb{Z}
\]


\[ 
3x = \frac{13\pi}{6} + 2 \pi k  \, \text{ where } \, k \in \mathbb{Z}
\]
