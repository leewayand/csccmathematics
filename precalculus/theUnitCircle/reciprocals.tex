...
If $f(x)$ is an increasing function, then when $x$ becomes greater, $f(x)$ also becomes greater.  But, then $\frac{1}{f(x)}$ becomes lesser.

If $f(x)$ is a decreasing function, then when $x$ becomes greater, $f(x)$ also becomes lesser.  But, then $\frac{1}{f(x)}$ becomes greater.
...
\begin{warning} \textbf{\textcolor{red!70!black}{Reverse vs. Reciprocal}} 


The reverse of a function and the reciprocal of a function are not the same thing.

They are completely and totally difference functions.
...
The unit circle is made of points $(x,y)$ whose coordinates satisfy the equation $x^2 + y^2 = 1$.

The points on the unit circle are all of the form $(\cos(\theta), \sin(\theta))$.

Therefore, sine and cosine are related through the unit circle.
...
One perspective we would like to change is addition or subtraction inside a square root, because roots (and powers) do not distribute over addition or subtraction.

Since square roots do not distribute over addition or subtraction, we have little useful algebra for those forms.  However, trigonometric relationships help us change our perspective.  They help us see addition and subtraction of squares as just squares.
...
These relationships help us view expressions of the form $A^2 + B^2$ or $A^2 - B^2$ as just $C^2$.
