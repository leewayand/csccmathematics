...
If we watch how the $y$-coordinates change as yhe point travels counterclockwise around the unit circle, then we will see exactly how the sine function behaves.
...
Our principal interval is $\left( -\frac{\pi}{4}, \frac{3\pi}{4} \right)$. These are teh values of $x$ that make a full circle of angles.
...
\textbf{Idea:} Negative leading coefficients reverse behavior.
...
Let $f(k) = \sin\left( \frac{k}{3} - \pi \right)$.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (I):}} On $\left( 3 \pi, \frac{9\pi}{2} \right)$, $f(k)$ increases from $0$ to $1$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (II):}} On $\left( \frac{9\pi}{2}, 6 \pi \right)$, $f(k)$ decreases from $1$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (III):}} On $\left( 6 \pi, \frac{15\pi}{2} \right)$, $f(k)$ decreases from $0$ to $-1$.


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (IV):}} On $\left( \frac{15\pi}{2}, 9 \pi \right)$, $f(k)$ increases from $-1$ to $0$.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (I):}} On $\left( 3 \pi, \frac{9\pi}{2} \right)$, $f(k)$ increases from $0$ to $1$, so $H(k)$ decreases from $0$ to $-2$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (II):}} On $\left( \frac{9\pi}{2}, 6 \pi \right)$, $f(k)$ decreases from $1$ to $0$, so $H(k)$ increases from $-2$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (III):}} On $\left( 6 \pi, \frac{15\pi}{2} \right)$, $f(k)$ decreases from $0$ to $-1$, so $H(k)$ increases from $0$ to $2$.


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ (IV):}} On $\left( \frac{15\pi}{2}, 9 \pi \right)$, $f(k)$ increases from $-1$ to $0$, so $H(k)$ decreases from $2$ to $0$.
