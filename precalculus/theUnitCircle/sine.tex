...
Our anlaysis follows the angle around the unit circle through the four quadrants.
...
Describe the behavior of   $g(t) = \sin\left( \frac{\pi}{2} - 3 t \right)$
...
The ``angle'' is $\frac{\pi}{2} - 3 t$.

We want to know when $\frac{\pi}{2} - 3 t$ has the values $0$, $\frac{\pi}{2}$, $\pi$, $\frac{3\pi}{2}$, and $2\pi$.
...
\begin{array}{l|l}
\text{angle}                  & t  \\ \hline
\frac{\pi}{2} - 3 t = 0        & t = \frac{\pi}{12}  \\
\frac{\pi}{2} - 3 t = \frac{\pi}{2}      &  t = -\frac{\pi}{12} \\
\frac{\pi}{2} - 3 t = \pi      & t = -\frac{\pi}{4}  \\
\frac{\pi}{2} - 3 t = \frac{3\pi}{2}     & t = -\frac{5\pi}{12}   \\
\frac{\pi}{2} - 3 t = 2\pi     & t = -\frac{7\pi}{12}
\end{array}
\]
...
This example has illustrated a fact about funciton behavior.
...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( 3 \pi, \frac{9\pi}{2} \right)$, $f(x)$ decreases from $0$ to $1$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( \frac{9\pi}{2}, 6 \pi \right)$, $f(x)$ increases from $1$ to $0$.



\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( 6 \pi, \frac{15\pi}{2} \right)$, $f(x)$ increases from $0$ to $-1$.


\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} On $\left( \frac{15\pi}{2}, 9 \pi \right)$, $f(x)$ decreases from $-1$ to $0$.
...
$\sin\left( \frac{k}{3} - \pi \right)$ has a maximum value of $1$ and a minimum value of $-1$.

$-2 \sin\left( \frac{k}{3} - \pi \right) + 1$ has a maximum value of $3$ and a minimum value of $-1$.





On our principal interval, $H(k)$ has a global and local maximum of $3$ at $\frac{15\pi}{2}$.  This is where the function switches from increasing to decreasing.


On our principal interval, $H(k)$ has a global and local maximum of $-1$ at $\frac{9\pi}{2}$.  This is where the function switches from decreasing to increasing.
