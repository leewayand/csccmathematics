...
We have two functions that we use to describe periodic measurements.  They come from the geometry of the Unit Circle.
...
The coordinates of points on the Unit Circle are $( \cos(\theta), \sin(\theta) )$, where $\theta$ is the angle measured counterclockwise from the positive $x$-axis.
...
From these two functions, we can also create a third function quotient function called \textbf{tangent}.
