...
We have a well-known method for calculating a rate of change of a function over an interval.
...
Obviously $a$ and $b$ need to be different numbers for this to work. Otherwise, the rate would be $\frac{0}{0}$, which makes no sense.

Well, we want to make some sense out of it.
