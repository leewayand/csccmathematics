...
To obtain the tangent line, zoom in on the g raph at the point. Keep zooming in until the graph loks like a straight line.
...
We are inventing a graphical intepretation and using that to help us think about functions.
...
\textbf{Vertical:} We are leaving out vertical lines, because they do not have a slope.  But, we will eventually include them to complete the story of derivaties.
...
To get the exact value of $m$, we are going to create a new quadratic function, which will be the difference between the original quadratic function, $Q$, and the linear function, $T$, which is the linear function coorresponding to the tangent line.
...
\textbf{Note:} This agrees with the orginal core parabola, because $a = 1$ for the core quadratic.
