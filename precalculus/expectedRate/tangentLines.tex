...
\pdfOnly{
\textbf{$\mathcal{Desmos}$: Tangent Line}
}
\begin{onlineOnly}
\begin{explanation} \textbf{\textcolor{teal}{$\blacktriangleright \mathcal{Desmos}$: Tangent Line}} 

[ Click on the arrow to the right to expand for the Desmos graph. ]
\begin{expandable} 
\begin{center}
