...
\textbf{\textcolor{blue!55!black}{For instance,}}  
...
\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. Parabola opening up with vertex at $(3,-4)$.  The point $(4,-3)$ is plotted on the parabola.  
...
\textbf{First}, The graph has no break. The graph smoothly approaches the point $(4, -3)$ on both sides.  $f$ is continuous at $4$.
...
\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. Parabola opening up with vertex at $(3,-4)$.  The point $(4,-3)$ is plotted on the parabola. A tangent line is plotted through this point. 
...
\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. The graph begins with an arrow pointing up and to the left at $(0,5)$. The graph continues down to the point $(3,-4)$ and then turns upward to a solid dot at $(4,3)$.  \\
