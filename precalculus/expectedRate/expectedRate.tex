...
The idea is that we can select two points on the graph and a secant line will run through them. Since we have two points, we can calculate the slope of the secant line. We can keep selecting two points that get closer to the tangent point. The slopes of the secant lines should be getting closer to the slope of the tangent line. 




\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} There are two behaviors happening as we shift a secant line over to the tangent point. The graph has its own behavior and the moving secant lines have another behavior. 
...
\textcolor{gray!90}{\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. Parabola opening up with vertex at $(3,-4)$.  The point $(4,-3)$ is plotted on the parabola.}  
...
\textbf{First}, The graph has no breaks. The graph smoothly approaches the point $(4, -3)$ on both sides.  $f$ is continuous at $4$.


Here, the soon to be tangent point is $(4, -3)$ and a tangent line runs through it are shown together below.
...
\textbf{Graph Description:} Cartesian plane. Horizontal \textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. Parabola opening up with vertex at $(3,-4)$.  The point $(4,-3)$ is plotted on the parabola. A tangent line is plotted through this point.} 
...
A function with a discontinuity has a break in the graph, which means the points on the graph do not approach the same point.  This automatically results in the derivative not existing, because the derivative requires both sides to agree.
...
\textcolor{gray!90}{\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. The graph begins with an arrow pointing up and to the left at $(0,5)$. The graph continues down to the point $(3,-4)$ and then turns upward to a solid dot at $(4,3)$.}
