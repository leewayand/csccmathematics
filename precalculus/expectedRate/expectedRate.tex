...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} There are two changes happening as we shift a secant line over to the tangent point. The graph has its own twists and turns, and the moving secant lines are changing position. 



The graph is behaving (there is a pattern) and the secant lines are changing (there is a pattern). Hopefully, these seprate behaviors will converge to the same behavior at the tangent point.
...
\textbf{\textcolor{red!70!black}{$\blacktriangleright$ Two Sides}}
...
\begin{itemize}
\item We'll have one secant line through the left selected point and the tangent point.
\item We'll have another secant line through the right selected point and the tangent point.
\end{itemize}
...
\textbf{Note:} We are considering the situation where we have both sides, which means the domain number corresponding to the tangent line must be inside an open interval in the domain. 
...
\textbf{Second}, For every other point on the parabola, there is a line through that point and the tangent point.  These are called \textit{secant lines}. These secant lines run through a point on the graph and the tangent point. The sequence of secant lines smoothly turn into the tangent line at the tangent point...on both sides.
...
\textcolor{gray!90}{\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. The point $(2,0)$ is plotted on the curve.  The curve begins with an arrow pointing down and to the left at $(-5,-8)$. From there, the curve moves up and to the right slowly becoming vertical. The curve goes through the point $(2,0)$ vertically. The curve the moves up and to the right slowly flattening out until it arrives at an arrow point up and to the right at $(9,8)$.}
...
\textcolor{gray!90}{\textbf{Graph Description:} Cartesian plane. Horizontal axis labeled $x$. Vertical axis labeled $y$. The point $(2,0)$ is plotted on the curve.  The curve begins with an arrow pointing down and to the left at $(-5,-8)$. From there, the curve moves up and to the right slowly becoming vertical. The curve goes through the point $(2,0)$ vertically. The curve the moves up and to the right slowly flattening out until it arrives at an arrow point up and to the right at $(9,8)$. There is a vertical line running through $(2,0)$.}  
...
We are just beginning to think about these types of mental exercises. We want to think about how to think about them.  Calculus will officially take over this story and give all of the details.
