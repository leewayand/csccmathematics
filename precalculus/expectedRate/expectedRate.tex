...
A function with a discontinuity has a break in the graph, which means the points on the graph do not approach the same point.  This automatically results in the derivative not existing. \\
