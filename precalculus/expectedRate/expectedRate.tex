...
\textbf{Rmember:} We are considering the situation where we have both sides, which means the domain number corresponding to the tangent line must be inside an open interval in the domain. 
