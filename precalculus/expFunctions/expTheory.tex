...
Exponential functions exhibit a constant percentage growth rate. The same change anywhere in the domain produces the same percentage change in the function value. That means the function value at the beginning of the domain interval is multiplied by the same constant to produce the function value at the end of the domain interval.
