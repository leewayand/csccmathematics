...
Every time the domain interval changes by $3$, then the function value is multiplied by $1.1$ (an change/increase of $10\%$).
...
We can think of exponential functions as shifts and stretches of a basic exponential function. 
...
The \textbf{basic exponential function}. 
...
It just depends on how you like to see exponential functions.  Algebra let's us see exponential funcitons in many different forms.
...
\begin{definition} \textbf{\textcolor{green!50!black}{General Exponential Functions}}
...
\begin{warning}  Sign vs. Behavior


Exponential functions are eiher always positive or always negative. The sign of the leading coeffcient dictates this.


However, behavior is not so simple.


Behavior is controlled by three pieces of the formula.
...
One way to watch this is to think of how the exponential function is built from a basic exponential function through composition.


Begin with the base, is it greater than or less than $1$.  That will tell you if the basic exponential function is increasing or decreasing.

Then look at the signs of the leading coefficients. If they have the same sign, then the bhavior doesn't change. If they have different signs, then the behavior changes.
...
\textbf{\textcolor{red!70!black}{IDEA: Formula dissection:}}  
