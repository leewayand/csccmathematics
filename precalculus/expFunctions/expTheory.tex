...
We have two types of core exponential functions. Their different behaviors are dictated by the base.
...
Functions that possess this constant percentage growth proprty are called exponential functions.

We can think of exponential functions as shifts and stretches of a core exponential function. 
...
\begin{itemize}
\item Let $L_{out}(u) = A \,$, a linear function
...
With these graphical ideas, we can create an algebraic analysis. 
...
With these ideas guiding us, we can write an algebraic analysis. 
...
\textbf{Thinking with the Chain Rule...}
...
\textbf{Thinking of the formula pieces...}
