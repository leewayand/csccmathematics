...
Basic exponential functions, are those functions which \textbf{\textcolor{red!70!black}{CAN}} be represented by formulas of the form $A \cdot r^x$.  
...
Basic exponential functions, are those functions which \textbf{\textcolor{red!70!black}{CAN}} be represented by formulas of the form $A \cdot r^{B \, x}$, where $r > 1$ and $A \ne 0$.  
