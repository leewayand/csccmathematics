...
Basic exponential functions, are those functions which \textbf{\textcolor{red!80!black}{CAN}} be represented by formulas of the form $a \cdot r^{b \, x}$, where $r > 1$ and $a \ne 0$.  
...
ALgebra always us to change our exponential funcitons to any base.  We might as well always choose bases greater than $1$.
