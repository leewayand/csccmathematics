...
Algebraically, the constant term, the ``+ d'' cannot be absorbed into the exponential form.  Adding a constant onto an exponential function breaks the constant percentage growth.
