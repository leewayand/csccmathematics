...
The domain of $f \circ g$ includes all of the domain numbers for $g$ such that their $g$-value is in the domain of $f$.

The range of $f \circ g$ includes all of the range numbers for $f$ such that there is a $g$-value in the domain of $f$.
...
We'll begin with a graphical description and then translate to an algebraic description. 
...
Induced domain means that the domain of $B$ will deduced from the domain of $T$.
...
$T$ is $B$ with the domain shifted. All of the values of $B$ are still there. They just have new domain partners.  

All of the points from the graph of $B$ are still there.  They just have new first coordinates.  They have moved horizontally.
...
The first part of the defintion of $T$ says $T(v) = 2v - 1$ on $(-4,-1]$.
...
The first part of the defintion of $T$ says $T(v) = -v + 3$ on $[1,7)$.
