...
\begin{definition}  \textbf{\textcolor{green!50!black}{Definition}}
...
Thsi domain was ``induced'' from the domain of $T$ through the definition of $B$, which is using $T$.  The values in the domain of $B$ are real numbers, $k$, such that $k+3$ is in the domain of $T$.
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Formula (first interval)}} 
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Formula (second interval)}} 
