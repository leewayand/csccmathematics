...
\textbf{\textcolor{blue!55!black}{Inside}}
...
With $T$ as our initial function, we can build a new funciton through composition.
...
\begin{explanation} Domain (first interval)
...
\begin{explanation} Domain (second interval)
