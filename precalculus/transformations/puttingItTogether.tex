...
\item The leading coefficient is $-2$, which speeds up the input into $K$, which compresses the graph horizontally.
...
All height measurements are half what they were to begin with.



We can trace the solid left endpoint of the line segment: $(-3, K(-3)) = (-3, -6)$ on the graph of $K$ through the transformations:
