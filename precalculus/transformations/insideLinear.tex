...
\begin{observation} \textbf{\textcolor{-red!75}{Hidden Exchange}}
...
\begin{observation} \textbf{\textcolor{-red!75}{Distances}}
...
All the $Q$ values are still there.  The output of $Q \circ inside$ are the same values of $Q$.  They are just connected to faster running domain values than before.
...
The vertical heights haven't changed. The formula $Q(L(x))$ still says that the values of $Q$ will be the outputs - just not at the same places.
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Separate Variables}} 
