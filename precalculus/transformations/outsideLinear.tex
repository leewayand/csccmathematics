...
\item Then $L$ will add $3$ to all the values.  This will shift the parabola up by $3$.
\end{itemize}
...
The vertical measurements have all been processed linearly, which means the shape doesn't change.  It is still a parabola, and all its features are relatively in the same place.
...
\textbf{\textcolor{blue!55!black}{Graphical Movement}} 
...
\textbf{Note:} All the endpoints are the same type.  
...
The solid endpoint of the horizontal line segment becomes $(-3, 1)$.
\end{procedure}
...
The solid endpoint of the horizontal line segment becomes $(-6, -1)$.
\end{procedure}
