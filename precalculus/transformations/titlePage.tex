...
We often investigate composition with linear functions graphically, which is know as \textbf{transformations}.



For our transformation story, we begin with a function, $f(x)$, and think about composing it with linear functions.
