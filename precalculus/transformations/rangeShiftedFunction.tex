...
On the interval $[1, 7)$, the graph should be another line segment for $T(v) = \answer{-v+3}$. There should be a(n) \wordChoice{\choice{open} \choice[correct]{closed}} dot when $v = 1$.  
