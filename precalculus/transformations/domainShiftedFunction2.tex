...
\item The solid and hollow endpoint dots are still in the same position. 
\end{itemize}
...
This is a shift from the core absolute value graph.  All we really need to know is location of the corner.  
...
For example, the core logarithmic functions $y = \log_r(t)$ [ including $y = \ln(t)$ ] have a vertical asymptote when the inside of the logarithm equals $0$. The zero, and corresponding horizontal intercept, occurs when the inside equals $1$.   
