...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled w. Vertical axis labeled y=P(w).  The graph begins with an arrow point up and to the left at (-2.5,8.25), then moves down to (1,-4), then up to an arrow pointing up and right at (4.5,8.25)}
...
For most functions, their rate of change fluctuate throughout the domain.  We have two functions which have constant aspects to their rates of change.  Let's begin our investigation with these functions.
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled t. Vertical axis labeled y=E(t).  The graph begins with an arrow pointing left at (-10,0.1), moves to the left to (0,2), continues to move left and up to an arrow pointing up and right at (7,9.8). There is also a dashed line plotted on top of the t-axis.}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled t. Vertical axis labeled y=X(t).  The graph begins with an arrow pointing left and up at (-7,9.8), moves to the right and down to (0,2), continues to move right to an arrow pointing right at (10,0.1). There is also a dashed line plotted on top of the t-axis.}
