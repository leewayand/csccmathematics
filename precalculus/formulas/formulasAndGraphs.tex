...
All of the domain numbers are pictured as lying on the horizontal axis in a graph.  They are not plotted as graph points on the horizontal axis, unless the function value just happens to equal $0$ at a domain number.
...
\pdfOnly{
\textbf{$\mathcal{VIDEO}$: Formulas and Graphs}
}

\begin{explanation} \textbf{\textcolor{red!75!green}{Video: Formulas and Graphs}}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled x. Vertical axis labeled y=L(x).  A line is plotted through the highlighted points (-2,-7) and (4,5).}
...
The real numbers experience a significant change in behavior at $0$.  The positive and negative numbers possess drastically different algebraic properties. We also interpret them differently, especially if they are describing rates of change.  $0$ also sets itself aside with properties different from both the negative and positive real numbers. 
...
\begin{definition}  \textbf{\textcolor{green!50!black}{a (Function) Zero}} 
...
We have language for graphs.  We have language for functions.  They are different.
...
\pdfOnly{
\textbf{$\mathcal{VIDEO}$: Function Zeros}
}

\begin{explanation} \textbf{\textcolor{red!75!green}{Video: Function Zeros}}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled w. Vertical axis labeled y=P(w).  The graph begins with an arrow point up and to the left at (-2.5,8.25), then moves down to (1,-4), then up to an arrow opint up and right at (4.5,8.25)}

\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Intercepts}
}
\begin{onlineOnly}
...
\pdfOnly{
\textbf{$\mathcal{VIDEO}$: Domain Types}
}

\begin{explanation} \textbf{\textcolor{red!75!green}{Video: Domain Types}}
...
\textbf{\textcolor{blue!55!black}{Exponential Functions}}
...
Whenever the domain changes by a given amount, then the exponential function changes by a \textbf{\textcolor{blue!55!black}{constant percentage}} of the current \textbf{\textcolor{blue!55!black}{function value}}.  
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled t. Vertical axis labeled y=E(t).  The graph begins with an arrow pointing left at (-10,0.1), moves to the left to (0,2), continuues to move left and up to an arrow pointing up and right at (7,9.8). There is also a dashed line plotted on top of the t-axis.}

\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Constant Percentage Growth}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled t. Vertical axis labeled y=X(t).  The graph begins with an arrow pointing left and up at (-7,9.8), moves to the right and down to (0,2), continuues to move right to an arrow pointing right at (10,0.1). There is also a dashed line plotted on top of the t-axis.}
