...
Or, the inside of the parenthses may hold an expression, which involves the variable.  In this case, the variable is not the whole expression and is not representing the domain values. The expression is representing the domain values.
