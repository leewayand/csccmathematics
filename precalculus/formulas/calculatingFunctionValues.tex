...
\textbf{Note:} The variable involved in function notation does not always represent the domain values. It will become very important to identify when the variable is representing the domain values and when it is not. 
...
We do this by creating an equation involving function notation.
