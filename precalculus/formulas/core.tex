...
There is only one Identity function. The Identity function pairs every domain number with itself. The value of the Idenity function is just the domain value where it is evaluated. 
