...
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$}} Basic exponential functions don't have zeros.  Basic logarithmic functions have a zero when the inside of the formula equals $1$. For more complicated exponential and logarithmic functions, we can use transformations and the algebra rules. 
...
We have only one more method.  It is specific and yet mysterious at the same time.
...
That is one of our best tools for locating zeros of functions (or critical numbers for derivatives). 
