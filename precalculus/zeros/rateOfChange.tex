...
All the tangent lines at $(a, k(a))$, where $a \in (-\infty, c)$ have \wordChoice{\choice[correct]{positive} \choice{negative}}  slopes, which means $k'(a) > 0$. 

All the tangent lines at $(a, k(a))$, where $a \in (-c, \infty)$ have \wordChoice{\choice{positive} \choice[correct]{negative}}  slopes, which means $k'(a) < 0$. 
\end{explanation}
...
Places in the domain of $f$, where $f' = 0$ are critically important to function analysis. The function may switch its type of growth at these numbers.  Such numbers in the domain are called \textbf{\textcolor{purple!85!blue}{critical numbers}}.
...
Therefore, we are collecting all these types of domain numbers and calling them \textbf{\textcolor{purple!85!blue}{critical numbers}}.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} Our goal is to be precise with our descriptions of functions.


We will encounter many functions whose graphs are misleading - because they have no choice but to be inaccurate.

\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} We want our descriptions to be exact and offer nothing to question.
...
However, now that our algebra has cleared the way, we can zoom in right where our algebra tells us.
