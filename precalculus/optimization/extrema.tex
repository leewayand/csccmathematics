...
\begin{definition} \textbf{\textcolor{green!50!black}{Local Extrema}}
...
Following the example above and Fermat's Theorem, it is believable that the only numbers at which a function can
...
\begin{definition} (from earlier) \textbf{\textcolor{green!50!black}{Critical Number}}
...
more examples can be found by following this link\\ \link[More Examples of Optimization]{https://ximera.osu.edu/csccmathematics/precalculus/precalculus/optimization/examples/exampleList}
