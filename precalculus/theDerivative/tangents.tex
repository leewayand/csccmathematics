...
\begin{tikzpicture}
  \begin{axis}[
          ...
          \addplot [line width=2, penColor, smooth,domain=(-6.2:1.5),<->] {0.1*(3*x-2)*(x+5)*(x+3)};

          \addplot [line width=1, penColor2, smooth,domain=(-2:4),<->] {2.9*x-3};
...
\begin{tikzpicture}
  \begin{axis}[
            domain=-0.02:0.02, ymax=-2.9, xmax=0.02, ymin=-3.1, xmin=-002,
            axis lines =center, xlabel=$x$, ylabel=$y$, grid = major,
            ytick={-3.05,-3,-2.95},
            xtick={--0.02,-0.1,0.1,0.02},
            ticklabel style={font=\scriptsize},
            every axis y label/.style={at=(current axis.above origin),anchor=south},
            every axis x label/.style={at=(current axis.right of origin),anchor=west},
            axis on top
          ...
          \addplot [line width=2, penColor, smooth,domain=(-0.02:0.02),<->] {0.1*(3*x-2)*(x+5)*(x+3)};

          \addplot [line width=1, penColor2, smooth,domain=(-0.02:0.02),<->] {2.9*x-3};
