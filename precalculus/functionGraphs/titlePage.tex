...
\begin{center}
  \textbf{\textcolor{red!70!darkgray}{Each domain number is in exactly one pair.}}
\end{center}
...
Our plan is to introduce function analysis via graphs.  However, this is not where we want to stay.  Graphs are inherently inaccurate and we want to be not only accurate, but exact.  

We will introduce function analysis with graphs and then translate those graphical thoughts over to algebra. Algebra is our language for exactness, so we want our function analysis to be over inside algebra. 

Algebra is where we want to be.  We'll be there soon enough. 
