...
\begin{center}
\large{\textbf{\textcolor{red!70!darkgray}{That's It!}}}  
\end{center}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled domain. Vertical axis labeled codomain.  Dot plotted in the first quadrant and labeled (d,f(d)).  The dot is plotted a horizontal distance of d from the origin. The dot is plotted a vertical distance of f(d) from the origin.}
...
The point is a visual encoding of our function pair $(d, f(d))$.

\begin{itemize}
\item The horizontal coordinate equals the domain number.
\item The vertical coordinate equals the function value.
\end{itemize}
...
\pdfOnly{
\textbf{$\mathcal{VIDEO}$: Visually Encoding Function Pairs}
}

\begin{explanation} \textbf{\textcolor{red!75!green}{Video: Visually Encoding Function Pairs}}
...
\begin{example} Encoding Visually
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled domain. Vertical axis labeled codomain.  Dot plotted and labeled $(3,2)$.  The dot is plotted a horizontal distance of $3$ from the origin. The dot is plotted a vertical distance of $2$ from the origin.}
...
\textcolor{gray!90}{alternate text: There is one point plotted in each quadrant. The quadrant 1 point is labeled A and has coordinates (3,2). The quadrant 2 point is labeled B and has coordinates (-3,2). The quadrant 3 point is labeled C and has coordinates (-3,-2). The quadrant 4 point is labeled D and has coordinates (3,-2).}
...
\textbf{Note: } The horizontal axis is named $t$, because the function notation, $H(t)$, tells us that $t$ represents the domain numbers.  We generally name the horizontal axis the same name as the variable in the function notation.


We generally name the vertical axis with some name not already in use, like $y$.  Then, we let the reader know that the values of $y$ are representing values of the function, $y=H(t)$.
\end{question}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis is labeled t. Vertical axis is labeled y. First quadrant labeled I. Second quadrant labeled II. Third quadrant labeled III. Fourth quadrant labeled IV.}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis is labeled t. Vertical axis is labeled y=g(t). Six dots plotted outlining the shape of a parabola opening up}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis is labeled t. Vertical axis is labeled y=g(t). Twelve dots plotted filling in the outline of a parabola opening up}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis is labeled t. Vertical axis is labeled y=g(t). Dots plotted filling in the outline of a parabola opening up}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis is labeled t. Vertical axis is labeled y=g(t). Overlapping dots plotted in the outline of a parabola opening up}
...
\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Too Many Dots to See}
}
...
A graph is a bunch of individual dots very close together. They are forming a pattern that your eye likes. Your eye glues them together.  Much of this course is about these eye-pleasing patterns that function graphs create.
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled v. Vertical axis labeled y=K(v). Six singleton dots plotted at (-2,5), (-1,0), (0,-3), (1,-4), (2,-3), and (3,0)}
...
\pdfOnly{
\textbf{$\mathcal{VIDEO}$: Graphs are Inherently Inaccurate}
}

\begin{explanation} \textbf{\textcolor{red!75!green}{Video: Graphs are Inherently Inaccurate}}
...
\begin{itemize}
\item \textbf{\textcolor{blue!55!black}{DOMAIN:}} We think of the domain as sitting on the \textbf{\textcolor{blue!55!black}{horizontal axis}}.
\item \textbf{\textcolor{purple!30!blue}{RANGE:}} We think of the range as sitting on the \textbf{\textcolor{purple!30!blue}{vertical axis}}.
\end{itemize}
...
What if we want to visualize the domain and the range of the function, individually as sets by themselves?  When visualizing the domain and range, we would view each axes as an individual number line.  Rather than thinking of the axes as holding dots with two coordinates, we would think that the axes are number lines, holding numbers, and we would color in the intervals and numbers, like on a number line.
...
\pdfOnly{
\textbf{$\mathcal{VIDEO}$: Double Duty}
}

\begin{explanation} \textbf{\textcolor{red!75!green}{Video: Double Duty}}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled f. Vertical axis labeled y=h(f). The graph consists of two line segments. The first line segment connects two solid dots at (-4,3) and (0,1). The second line segment connects a hollow dot at (1,-6.5) to a solid dot at (7,-3.5).}




\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Graph of y = h(t)}
}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labeled f. Vertical axis labeled y=h(f). The graph of h is drawn in blue and consists of two line segments. The first blue line segment connects two solid dots at (-4,3) and (0,1). The second blue line segment connects a hollow dot at (1,-6.5) to a solid dot at (7,-3.5). The domain is drawn in red and consists of two horizontal line segments. The first red line segment connects two solid dots at (-4,0) and (0,0). The second red line segment connects a hollow dot at (1,0) to a solid dot at (7,0).}




\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Drawing the Domain}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labled f. Vertical axis labeled y=h(f). The graph of h is drawn in blue and consists of two line segments. The first blue line segment connects two solid dots at (-4,3) and (0,1). The second blue line segment connects a hollow dot at (1,-6.5) to a solid dot at (7,-3.5). The range is drawn in red and consists of two vertical line segments. The first red line segment connects two solid dots at (0,1) and (0,3). The second red line segment connects a hollow dot at (0,-6.5) to a solid dot at (0,-3.5).}


\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Drawing the Range}
}
\begin{onlineOnly}
\textbf{\textcolor{blue!55!black}{$\blacktriangleright$ desmos graph}} 
\begin{center}
...
When we were drawing intervals on numbers lines, we used square brackets and parentheses to signal the inclusion or exclusion of numbers.  Now we are using solid and hollow dots. 
...
\begin{example} Decoding Domain and Range
...
\textcolor{gray!90}{alternate text: Cartesian plane. Horizontal axis labled k. Vertical axis labeled z=P(k). The graph of P consists of two pieces. The first pieces begins with a solid dot at (-5,0), moves up to (-2,9), the down to a hollow dot at (0,5). The second piece is a line segment connecting a hollow dot at (1,-2) to a solid dot at (5,-6).}


\pdfOnly{
\textbf{$\mathcal{DESMOS}$: Domain and Range}
}
