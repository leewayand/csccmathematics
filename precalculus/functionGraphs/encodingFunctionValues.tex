...
\textcolor{gray!90}{descriptions: Cartesian plane. Horizontal axis labeled domain. Vertical axis labeled codomain.  Dot plotted and labeled (d,f(d)).  The dot is plotted a horizontal distance of d from the origin. The dot is plotted a vertical distance of f(d) from the origin.}
...
\textcolor{gray!90}{descriptions: Cartesian plane. Horizontal axis labeled domain. Vertical axis labeled codomain.  Dot plotted and labeled $(2,3)$.  The dot is plotted a horizontal distance of $2$ from the origin. The dot is plotted a vertical distance of $3$ from the origin.}



\end{example}

\begin{question} Visually Encoding
