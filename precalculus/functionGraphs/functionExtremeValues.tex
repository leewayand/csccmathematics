...
\begin{idea} \textbf{\textcolor{blue!55!black}{Extreme Values}} 


$\blacktriangleright$ \textbf{\textcolor{blue!55!black}{Where}} is the maximum value of the function? 

Translation: Which \textbf{\textcolor{blue!55!black}{domain}} value results in the maximum value of the function? 


$\blacktriangleright$ \textbf{\textcolor{blue!55!black}{Where}} is the minimum value of the function? 

Translation: Which \textbf{\textcolor{blue!55!black}{domain}} value results in the minimum value of the function? 
...
The function in the example above has no minimum value. 


However, a quick glance at the graph would have suggested that there is an ``expected'' minimum value.  Upon closer examination, we see that the corner point is not included in the graph, which was the source of our expectation.


\textbf{\textcolor{red!70!black}{A Peek Ahead...}}


These expected values are important to our analysis.  We will want to communicate about them. Our language for expected values is called \textbf{limits}.


We would describe our expectations in the previous example like

\[
\lim\limits_{k \to 5} H(k) = -3
\]
