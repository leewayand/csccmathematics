...
\begin{example}
  ...
  \begin{explanation}
    ...
    $\theta=-\pi/6$ to $\pi/6$ will give us the area
      ...
      &= \frac{1}{4}\bigg[\theta-\frac{\sin(6\theta)}{6}\bigg]_{-\pi/6}^{\pi/6}\\
...
&= \frac{1}{4}\bigg[\theta-\frac{\sin(6\theta)}{6}\bigg]_{0}^{2\pi}\\
&= \frac{\pi}{2}
\end{align*}
...
\begin{example}
  ...
  \begin{explanation}
    ...
    \begin{align*}
      ...
      &=  \frac{1}{4}\bigg[-4\cos(\theta) - \theta+\frac{\sin(2\theta)}{2}\bigg]_0^\pi \\
