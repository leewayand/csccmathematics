...
\begin{exercise}
Using the formula $V = \int_{y=c}^{y=d} 2\pi \rho h dy$, an integral that gives the volume of this solid of revolution is:

\[
V = \int_{y=\answer{-1}}^{y=\answer{1}} \answer{4 \pi (2-y)\sqrt{y+1}} dy
\]
...
\begin{exercise}
Using the formula $V = \int_{x=a}^{x=b} 2 \pi \rho h dx$, an integral that gives the volume of this solid of revolution is:

\[
V = \int_{x=\answer{-\sqrt{2}}}^{x=\answer{\sqrt{2}}} 2\pi \answer{(3-x)(2-x^2)} dx
\]
