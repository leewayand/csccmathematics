...
\begin{exercise}
Using the formula $V = \int_{y=c}^{y=d} \pi (R^2-r^2) dy$, an integral that gives the volume of this solid of revolution is:

\[
V = \int_{y=0}^{y=\sqrt[3]{2}} \pi \answer{(2^2-(y^3)^2)} dy
\]
