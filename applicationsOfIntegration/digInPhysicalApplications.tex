...
\begin{explanation}
Since we have reasoned that the right half of the rod has more mass than the left half, we expect that \wordChoice{\choice{$a<2$}
\choice{$a=2$}\choice[correct]{$a>2$}} .
