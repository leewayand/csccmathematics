...
\begin{align*}
  \frac{d}{dx} \left(xe^x-e^x \right) &=\frac{d}{dx} \left(xe^x\right)-\frac{d}{dx} e^x\\
  &=(xe^x+e^x)-e^x\\
  &=\answer[given]{x e^x}.
\end{align*}
\end{explanation}
...
Write with me
\begin{align*}
\frac{d}{dx} \frac{\sin{x}}{x} &=  \frac{\cos{x}\cdot x-\sin{x}\cdot1}{x^2}
\end{align*}
\end{explanation}
\end{example}
...
\begin{example}
  ...
  \begin{explanation}
	 ...
	 \begin{align*}
\bigg[ \frac{d}{dx}\frac{f(x)}{g(x)} \bigg]_{x=4} &=\bigg[ \frac{f'(x)g(x)-f(x)g'(x)}{\left(g(x)\right)^2} \bigg]_{x=4}\\
...
\begin{example}
  ...
  \begin{explanation}
	 ...
	 \begin{align*}
\bigg[ \frac{d}{dx}\frac{xf(x)}{g(x)} \bigg]_{x=4} &=\bigg[ \frac{(xf'(x)+f(x))g(x)-xf(x)g'(x)}{\left(g(x)\right)^2} \bigg]_{x=4}\\
