...
\draw[very thick,penColor2] (-2,0) arc (180:360:2 and .7);% bottom half of ellipse
 \draw [penColor, fill] (0,0) circle [radius=.06];
...
\begin{tikzpicture}
%\draw[very thick,penColor2!20!background] (2,0) arc (0:180:2 and .7);% top half of ellipse
\draw [penColor, very thin] (0,1) ellipse (1.7 and .5);
\draw[penColor, very thin] (1.7,.95) -- (0,-2);
\draw[penColor, very thin] (-1.7,.95) -- (0,-2);
%\draw[very thick,penColor2] (-2,0) arc (180:360:2 and .7);% bottom half of ellipse
\draw [penColor2, very thick] (0,0) circle [radius=2];
\draw[penColor2, very thick] (0,0) --(1.7,1);
\draw[penColor2, dashed] (0,0) --(0,-2);
\draw[penColor,  very thick] (0,1) -- (1.7,1);
\draw[penColor3, very thick] (0,0) -- (0,1);
\node [below,penColor2] at (0.8,0.5) {$R$};
\node [below,penColor2] at (0.2,-0.6) {$R$};
\node [above,penColor] at (.85,1) {$r$};
\node [left,penColor] at (0,-.33) {$h$};
\node [left,penColor3] at (0,.53){$h-R$};
\node [left,penColor2] at (-3,1){$R^2=r^2+(h-R)^2$};
 \draw [penColor, fill] (0,0) circle [radius=.045];
 %\draw[decoration={brace,raise=.02cm},decorate,thick] (0,0)--(0,1);
   % \draw[decoration={brace,mirror,raise=.02cm},decorate,thin] (0,-2)--(0,0);
%\node [penColor,left] at (-1.5,1.42) {$V_{\text{c}} = \frac{\pi r^2h}{3}$};
%\node [penColor2, right] at (1.5,-1.42) {$V_{s} = \frac{4\pi R^3}{3}$};
\end{tikzpicture}
\end{image}
