...
\begin{definition}\index{e@$e$}
  The number denoted by $e$, called \textbf{Euler's number}, is defined
...
Compute:
\[
\frac{d}{dx}\left(8\sqrt{x} + 7e^x \right)
\]
\begin{explanation}
Write with me:
\begin{align*}
\frac{d}{dx}\left(8\sqrt{x} + 7e^x \right) &= 8\frac{d}{dx} x^{1/2} + 7\frac{d}{dx} e^x\\
