...
\begin{itemize}
\item $\frac{d}{dx} k =0$
\item $\frac{d}{dx} x^n  = \answer[given]{n x^{n-1}}$
\end{itemize}

\paragraph{Exponentials:}
\begin{itemize}
\item $\frac{d}{dx} e^x = \answer[given]{e^x}$
...
\item $\frac{d}{dx} \log_a (x) = \frac{1}{\ln a} \frac{1}{x}$
\end{itemize}

\paragraph{Trigonometric Functions:}
\begin{itemize}
\item $\frac{d}{dx} \sin(x) = \answer[given]{\cos(x)}$
\item $\frac{d}{dx} \cos(x) = \answer[given]{-\sin(x)}$  
\item $\frac{d}{dx} \tan(x) = \sec^2(x)$  
\item $\frac{d}{dx} \sec(x) = \answer[given]{\sec(x)\tan(x)}$ 
\item $\frac{d}{dx} \csc(x) = -\csc(x)\cot(x)$
\item $\frac{d}{dx} \cot(x) = \answer[given]{-\csc^2(x)}$
\end{itemize}
...
\begin{question} 
  ...
  \begin{prompt} 
    \[
    \frac{d}{dx} \left(\frac{1}{\sqrt[4]{x^3}}\right) = \answer[given]{- \frac{3}{4} x^{-7/4}}
    \]
  \end{prompt}
\end{question}
...
\begin{itemize}
\item Addition: $\frac{d}{dx} \left( f(x) + g(x) \right) = f'(x) + g'(x)$
\item Scalar Multiplication: $\frac{d}{dx} \left( af(x) \right) = a f'(x)$
\item Product Rule: $\frac{d}{dx} \left( f(x) \cdot g(x) \right) = f(x)g'(x) + f'(x)g(x)$
...
\begin{question} 
  ...
  \begin{prompt} 
    \[
    \frac{d}{dx} \left(4x^2 +\frac{2}{3\sqrt{x}} \right) = \answer[given]{8x -\frac{1}{3} x^{-3/2}}
    \]
  \end{prompt}
\end{question}
