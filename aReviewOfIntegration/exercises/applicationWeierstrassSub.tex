...
\begin{exercise}
Consider the integral $I = \int_0^{\frac{\pi}{2}} \frac{dx}{3+\cos(x)}$.  

Use the substitution $t= \tan\bigg(\frac{x}{2}\bigg)$ and the previous results to write the integral in terms of $t$.  Simplify!

\[ \int_{x=0}^{x= \frac{\pi}{2}} \frac{dx}{3+\cos(x)}  = \int_{t=\begin{prompt}\answer{0}\end{prompt}}^{t=\begin{prompt}\answer{1}\end{prompt}} \begin{prompt} \answer{\frac{1}{t^2+2}} \end{prompt} dt \]
