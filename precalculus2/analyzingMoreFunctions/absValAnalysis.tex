...
\textbf{Note:}  In the template for absolute value functions, There are two leading coefficients.


There is a leading coefficient for the whole function, which is also the leading coefficient outer function, if you are viewing the absolute value function as a composition.



There is also a leading coefficient for the inner linear function inside the absolute value bars. This is also the leading coefficient inner function, if you are viewing the absolute value function as a composition.
...
Absolute Value functions are constructed by composing these component functions.
...
\begin{itemize}
\item $T$ is continuous, with no singularities
