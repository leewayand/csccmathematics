...
\begin{remark} \textbf{\textcolor{yellow!35!black}{Product}}

$p$ is not an elementary function.  It is a product of two functions. 

We will not be using the Chain Rule for the behavior of $p$.



The first factor is a linear function, $k$. 

The second factor, itself, is a composition of a root function and a quadratic function. We could use the Chain Rule just for the behavior of this factor. 
...
Here, the domain is $[-2, 2]$.  So, there is no end-behavior. 
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Just Thinking About $p$}} 
...
\textbf{\textcolor{red!75!green}{With this idea in mind, we can take an algebraic approach}} 


\textbf{Thinking with the Derivative...}


We can use the sign of the derivative to help us figure out where $p$ increases and decreases. 


Step #1 is finding the critical numbers. To do this, we need the derivative in factored form. This often means gathering everything into a single fraction.
...
Calculus will give us all the rules we need to obtaining formulas for any derivative.  In Precalculus, unless we have a linear or quadratic function, we will need to be given the formula for the derivative.
