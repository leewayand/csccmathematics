...
What is the slope of the tangent line to the graph of $y = -2 \sin\left( t - \frac{\pi}{6} \right) + 3$ at $\left( \frac{5 \pi}{6}, 3-\sqrt{3} \right)$?
...
\begin{tikzpicture}
  \begin{axis}[
            ...
            axis lines =center, xlabel={$t$}, ylabel={$y = \sin(t)$}, grid = major, grid style={dashed},
            ytick={-1,1,2,3,4,5,6},
...
\begin{explanation} Maximums and Minimums \\
...
\begin{explanation} Critical Numbers \\
