...
We do know that $\sin(\theta)$ can't get greater than $1$ or less than $-1$.  That tells us that $1 -2\cos(2\theta)$ can't get greater than $3$.   So, the range must be inside $[-3, 3]$.





This is confirmed with a better graph.
