...
Since our analysis rests on zeros of funcitons and zeros of their derivatives, the standard form for a polynomial is just not that helpful.  Our analysis prefers a factored form. 
...
\item If our polynomial is a constant function, then it always has a $0$ derivative and $0$ rate of change.


\item If our polynomial is a linear function, then it has a constant rate of change. The leading coefficent tells us if the linear function is always increasing or always decreasing.


\item If our polynomial is a quadratic function, then it has a linear derivative. The leading coefficent tells us if the quadratic function increases and then decreases or the other way around.  This coincides with the sign of the derivative.
...
For polynomials, we can get some information exactly and must approximate other information.
