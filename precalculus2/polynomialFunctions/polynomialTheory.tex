...
\item $a_1 x^1$ is called the \textbf{linear term}, usually just writte as $a_1 x$.
\item $a_0 x^0$ is called the \textbf{constant term}, usually just written as $a_0$.
...
Either the sign of the polynomial switches or it stays the same across the root.  How can we see this in the formula?
...
In between these zeros, the values of the polynomial function has a positive or negative sign. It can't change, since polynomials are continuous. 
...
$p'$ is a quadratic function with apositive leading coefficent, so we know it is postive : negative : positive, swicthing at is zeros.
