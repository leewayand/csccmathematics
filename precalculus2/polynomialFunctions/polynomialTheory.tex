...
\begin{tikzpicture}
  \begin{axis}[
          ...
          %\addplot [<-, line width=10, penColor!10!background] plot coordinates {(-2,-25) (-1,7)}; 
            ...
            \addplot [line width=10, enColor!10!background, smooth,samples=100,domain=(-9:-7),<-] {-(x+4)};
            \addplot [line width=10, enColor!10!background, smooth,samples=100,domain=(-5:-3)] {-(x+4)};
            \addplot [line width=10, enColor!10!background, smooth,samples=100,domain=(2:4)] {-(x-3)^2)};
            \addplot [line width=10, enColor!10!background, smooth,samples=100,domain=(7:9),->] {-(x-4)};
