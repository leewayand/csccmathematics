...
Calculus would give us the derivative, $p'(w) = -\frac{1}{5}(3w^2 - 4w - 15)$. The derivatives zeros would be critical numbers.  $p'(w)$ is a quadratic.  We can obtain its zeros via the quadratic formula.
