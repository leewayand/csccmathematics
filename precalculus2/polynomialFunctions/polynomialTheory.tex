...
Formulas for polynomial functions have three forms:
...
\item \textbf{\textcolor{purple!85!blue}{Vertex Form:}}  The vertex form for a polynomial function involves a \textbf{\textcolor{purple!85!blue}{square}}. It looks like 
\[ a(x - h) + k \]
This is also called the \textbf{\textcolor{purple!85!blue}{Completed Square Form}}.
\end{itemize}
