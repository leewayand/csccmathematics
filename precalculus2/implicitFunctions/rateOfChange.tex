...
Let $y(x)$ be described by $x^3 + y^3 - 3 x y = 0$. \\
\textbf{Note: } $y(x)$ isn't a function.
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Approximating}} 
...
\textbf{\textcolor{red!70!black}{$\blacktriangleright$  [Weird Stuff]}}  Even though we cannot solve for $y$ and get a formula for $y(x)$, Calculus does give us a way to obtain a FORMULA for $y'(x)$.
...
This is called \textbf{linearization} and is a big topic in Calculus.
