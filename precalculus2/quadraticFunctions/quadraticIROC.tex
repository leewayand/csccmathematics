...
\begin{fact} \textbf{\textcolor{red!75!green}{Over an Interval}}    


The rate of change of the function $f$ over the interval $[a, b]$ is given by $\frac{f(b) - f(a)}{b - a}$. 


This is our algebraic version of rate of change. This is also referred to as the \textbf{average rate of change} over the interval $[a, b]$.
...
\begin{fact} \textbf{\textcolor{red!75!green}{At a Domain Number}}   
...
The rate of change over an interval and the instantaneous rate of change are different measurements of the change in a function's value compared to changes in the domain. 




\begin{notation} the \textbf{\textcolor{red!50!green}{derivative of $f$ at $a$}}
...
When thinking Aagebraically, we think of the funciton's change from one domain number to another. This describes function change over an interval. Calculus takes an extreme viewpoint on this.  

Calculus asks about the interval $[a,a]$. Algebra doesn't know what to do with this type of interval. The rate of change of a function at one domain number, $a$, makes no sense, algebraically. Calculus makes sense of it as the slope of a tangent line at $(a, f(a))$. 

This gives us two types of interpretations for increasing and decreasing. 


\textbf{\textcolor{red!70!black}{$\blacktriangleright$ Algebraic Increasing}} 



The function, $f$, is \textbf{\textcolor{purple!70!blue}{increasing on the interval}} $[a, b]$ if
...
\textbf{\textcolor{red!70!black}{$\blacktriangleright$ Calculus Increasing}} 



The function, $f$, is \textbf{\textcolor{purple!70!blue}{increasing at a}} if
...
\textbf{\textcolor{red!70!black}{$\blacktriangleright$ Algebraic Decreasing}} 
...
The instantaneous rate of change (a.k.a. the derivative) gives us a formula for the slopes of tangent lines, which are interpreted as rates of change of functions.

For a quadratic function, we have formulas for the derivative.



\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} From vertex form, $f(x) = a (x -h)^2 + k$, we have $iRoC_f(x) = f'(x) = 2 a \, (x-h)$. 



\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}} From standard form, $f(x) = a \, x^2 + b \, x + c$, we have $iRoC_f(x) = f'(x) = 2 a \, x + b$. 
