...
If the leading coefficient is positive, then the range is $\left[ Q\left( -\frac{b}{2a}, \infty \right)$. \\


If the leading coefficient is negative, then the range is $\left(-\infty, Q\left( -\frac{b}{2a} \right]$. \\
