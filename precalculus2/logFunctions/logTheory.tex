...
If we select a greater exponent in the domain, then we get a greater funciton value.  



We can evalute our exponential function:
\begin{itemize}
\item $E(0) = 2^0 = 2$
...
$\blacktriangleright$ The inside of the logarithm is $t+3$, and this is positive for $t>-3$.  The graph be on the right side of the vertical asymptote.
...
It might seem strange to select that number as the base for a logarithm and give it special notation.  However, it turns out the exponential functions with this base are intricately connected to natural growth in the universe.
