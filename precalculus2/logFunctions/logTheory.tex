...
\textbf{\textcolor{red!70!darkgray}{$\bigstar$}} For $E(t) = 2^t$, every positive function value has \textit{exactly one} associated domain number, one exponent, one \textbf{\textcolor{purple!85!blue}{logarithm}}. (That is eeriely similar to the function rule for pairs in the exponential function.) 
...
Genral \textbf{logarithmic functions} are functions that \textbf{\textcolor{red!70!black}{CAN}} be described by formulas of the form 
...
To calculate exctly, we solve $M(t) = \log_2(t+3) - 4 = 0$ 
...
Its end-behavior is a constant.   $e$ is this limiting value.
