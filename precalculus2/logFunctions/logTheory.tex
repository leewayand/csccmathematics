...
The basic logarithmic function just reverses the pairs in the basic exponential function.  If $(d, 2^d)$ is a pair in the exponential function, then $(2^d, d)$ is a pair in the corresponding logarithmic function.
...
\textbf{Note:} We are only considering $r > 0$.
