...
\begin{tikzpicture}
   \begin{axis}[name = leftgraph, 
          ...
          \addplot [line width=2, penColor, smooth,samples=300,domain=(0.005:9), <->] {ln(x)};
...
\begin{tikzpicture}
   \begin{axis}[name = leftgraph, 
          ...
          \addplot [line width=2, penColor, smooth,samples=300,domain=(-9:-0.005), <->] {ln(-x)};
          \addplot [color=penColor,only marks,mark=*] coordinates{(-1,0)};
  ...
  \begin{axis}[at={(leftgraph.outer east)},anchor=outer west, 
          ...
          \addplot [line width=1, gray, dashed, domain=(-9:-0.005),<->] ({0},{x});

          \addplot [line width=2, penColor, smooth,samples=300,domain=(-8:9),<->] {-ln(-x)};
          \addplot [color=penColor,only marks,mark=*] coordinates{(-1,0)};
