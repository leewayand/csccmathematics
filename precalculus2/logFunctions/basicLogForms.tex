...
\begin{tikzpicture}
   \begin{axis}[name = leftgraph, 
          ...
          \addplot [line width=2, penColor, smooth,samples=100,domain=(0.5:9), <->] {ln(x)};
...
\begin{tikzpicture}
   \begin{axis}[name = leftgraph, 
          ...
          \addplot [line width=2, penColor, smooth,samples=200,domain=(-9:-0.5), <->] {ln(-x)};
          \addplot [color=penColor,only marks,mark=*] coordinates{(-1,0)};
  ...
  \begin{axis}[at={(leftgraph.outer east)},anchor=outer west, 
          ...
          \addplot [line width=1, gray, dashed, domain=(-9:-0.5),<->] ({0},{x});

          \addplot [line width=2, penColor, smooth,samples=200,domain=(-8:9),<->] {-ln(-x)};
          \addplot [color=penColor,only marks,mark=*] coordinates{(-1,0)};
