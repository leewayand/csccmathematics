    ...
    \begin{tikzpicture}
      \begin{polaraxis}[
        ...
        \addplot[color=penColor,only marks,mark=*] coordinates{(35.5,4.3)}; 
         ...
         \node at (axis cs:-6,3.5) [penColor] {\scriptsize $x_0$};
         \node at (axis cs:90,2.75) [penColor] {\scriptsize $y_0$};
         \node at (axis cs:23,4.1) [penColor] {\scriptsize $(x_0,y_0)$};



         \addplot[line width=1,penColor,domain=-3:3,samples=100,smooth] {3.5};
         \addplot[line width=1,penColor,domain=87:93,samples=100,smooth] {2.5};
