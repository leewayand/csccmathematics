...
\textbf{Note:} We have seen a fourth Geometric view of the same information using vectors. Vectors will become more useful as you learn more mathematics. For now, they helped us form an arithmetic for our 2D-numbers and that was enough.  They will sit on the sidelines for a while until needed again.
...
\textbf{Note:} $r_0$ and $\theta_0$ are specific values measured in the $r$ and $\theta$ directions. 
