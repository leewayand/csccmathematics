...
\begin{tikzpicture}
  \begin{axis}[
          ...
          \addplot [line width=1, penColor, smooth,samples=100,domain=(-0.25:0.25)] ({4},{x});
          \addplot [line width=1, penColor, smooth,samples=100,domain=(-0.25:0.25)] ({x},{2});

          \node at (axis cs:4,-0.75) [penColor] {\scriptsize $A$};
          \node at (axis cs:-0.75,2) [penColor] {\scriptsize $B$};
