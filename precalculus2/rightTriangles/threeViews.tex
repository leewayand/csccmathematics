...
We now have four views of the same information.

We can view our 2-dimensional plane with rectangular coordinates. We can view it with vectors. We can view it with polar coordinates. We can view it with Complex Numbers.


We used vectors as a tool to develop the Complex Numbers.  We are not really using vectors in this course to help with our mathematics of functions. Vectors will return in Calculus 3 where they will help with functions of more than one variable.




In this course, we have three views of the same information.
...
Rectangular coordinates, Polar coordinates, and Complex Numbers are three ways to describe the same information.  They sit on top of each other and we choose which lens to look through.  This also allows us to quickly change lens.  We can begin thinking one way and then quickly change to a different perspective, where we might have better ideas. 
...
\textbf{\textcolor{blue!55!black}{These are three ways of describing the same information.}} 
...
The location or position of a point can be described with left/right and up/down measurements from the origin, $(0,0)$. These measurements are called \textit{coordinates}.  The coordinates are written as ordered pairs: $(x_0, y_0)$. The first coordinate gives the measurement in the horizontal direction and the second coordinate gives the measurement in a perpendicular, vertical direction.  Our favorite names for these directions are $x$ and $y$. 

\textbf{Note:} $x_0$ and $y_0$ denote constant values measured in the $x$ and $y$ directions. 
...
\textbf{Note:} $r_0$ and $\theta_0$ denote constant values measured in the $r$ and $\theta$ directions. 
...
We have adopted Greek names via Sanskirt for these functions.
