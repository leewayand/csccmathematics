...
\begin{theorem}   \textbf{\textcolor{-red!75!green}{Pythagorean Theorem}} 
...
Each point on the Unit Circle sits at the end of a radius and that radius makes an angle with the positive $x$-axis, which is labeled $\theta$ in the diagram.
