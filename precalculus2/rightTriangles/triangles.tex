...
Since the first right triangle was anchored to the unit circle, its hypotenuse had length $1$.  The hypotenuses of the other similar right triangles have a length, which we'll call $r$.
...
If we lable the sides relative to the angle $\theta$, then we obtain descriptive ratios.
