...
\begin{itemize}
\item The position of \textbf{\textcolor{red!70!black}{every}} point in the Cartesian plane can be described as a scalar times a direction vector.  A direction vector has unit length.
...
\begin{theorem} \textbf{\textcolor{-red!75!green}{Complex Multiplication (Polar Form)}}  
...
If we pick an angle  $\theta$, then we have defined a right triangle via the unit circle.
...
\subsection*{Extending Right Triangles}
...
In the third quadrant, sine is \wordChoice{\choice[correct]{negative} \choice{positive}}. 

In the fourth quadrant, sine is \wordChoice{\choice[correct]{negative} \choice{positive}}. 
...
In the second quadrant, cosine is \wordChoice{\choice[correct]{negative} \choice{positive}}. 

In the third quadrant, cosine is \wordChoice{\choice[correct]{negative} \choice{positive}}. 
...
\textbf{Note:}  Your calculator has two \text{modes} for angle measurements: degrees and radians.  Remember to switch between these \textbf{modes} when calculating.
