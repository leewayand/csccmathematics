...
The graph kind of looks like a stretched graph of tangent.  Something like $\tan\right( \frac{\theta}{2} \right)$, maybe.
...
\[   \tan\right( \frac{\theta}{2} \right)   = \frac{\sin(\theta)}{1 + \cos(\theta)}   \]
