...
The range is $[\ln(2), \infty)$.

$K(v)$ decreases on $(\infty, -1]$ and increases on $[-1, \infty)$.


$K(v)$ has a global minimum of $\ln(2)$, which occurs at $-1$.  This is also the only local minimum.

$K(v)$ has no global or local maximum.

$-1$ is the only critical number.
