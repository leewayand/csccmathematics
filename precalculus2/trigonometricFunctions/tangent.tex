...
Draw our usual right triangle for sine and cosine on the unit circle.  Draw a tangent line at the point on the circle and use this to draw a second right triangle.  The two right triangles have an angle $\theta$, which means all three angles are equal, which means the triangles are similar.
