...
\item $T(r)$ has a maximum of $-4$, which occurs at $\{  \frac{5 \pi}{4} \pm k \pi \, | \, k \in \mathbb{Z} \}$.

\item $T(r)$ decreasing on $[  \frac{3 \pi}{4} \pm k \pi,    \frac{5 \pi}{4} \pm k \pi    ]$, where $k \in \mathbb{Z}$.

\item $T(r)$ increasing on $[  \frac{5 \pi}{4} \pm k \pi,    \frac{3 \pi}{4} \pm (k+1) \pi    ]$, where $k \in \mathbb{Z}$.
\end{itemize}
