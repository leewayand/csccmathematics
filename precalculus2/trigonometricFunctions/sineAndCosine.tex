...
For every angle, $\theta$, measured from the positive $x$-axis, we have a point on the unit circle. The coordinates of this point are functions of $\theta$.  We call them \textbf{cosine} and \textbf{sine}.
...
Both are periodic functions with period $2\pi$.  Therefore, we can examine just one wave to understand the whole functions.
