...
It looks weird, but that won't bother us, because we are not memorizing this formula.

There is no need to memorize this formula, because we can just use the DIstributive Property.
...
\[     = a \cdot b + a \cdot d \, i + b \, i \cdot c + b \, i \cdot d \, i          \]

\[     = a \, b + (a \, d) \, i + (b \, c) \, i + (b \, d) \, i^2   \]

\[     = a \, b + (a \, d) \, i + (b \, c) \, i - (b \, d)    \]

Gather like terms (real and imaginary)
...
But, even real numbers stretch this story.  $10 \div \sqrt{2}$ ?  What does it mean to split a pile of $10$ marbles into $\sqrt{2}$ piles?
...
We now think of $10 \div 5$ in terms of fractions
...
Can we think of fractions with Complex Numbers?




Do comples numbers have reciprocals?  Does each complex number have a partner complex number such that their product equals $1$?
...
\begin{explanation} \textbf{\textcolor{red!75!green}{Reciprocals}} 
...
$\blacktriangleright$  Every nonzero complex number has a reciprocal!  

We will use this to define division as multiplication by the reciprocal.
