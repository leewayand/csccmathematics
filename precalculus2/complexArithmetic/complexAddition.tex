...
\textbf{\textcolor{red!90!darkgray}{$\blacktriangleright$}} If $z = a + b \, i$ is a Complex Number, then $\bar{z} = \bar{a + b \, i} = a - b \, i$ is called the \textbf{\textcolor{purple!85!blue}{complex conjugate}} of $z = a + b \, i$.
