...
The two Complex numbers could be the same number. $\frac{1}{\sqrt{2}} + \frac{1}{\sqrt{2}} \, i = \left(1, \frac{\pi}{2} \right)$


\[
\left( \frac{1}{\sqrt{2}} + \frac{1}{\sqrt{2}} \right)^2 = \left(1, \frac{\pi}{2} \right) \cdot \left(1, \frac{\pi}{2} \right)
\]

\[
= \left(1, \frac{\pi}{2} + \frac{\pi}{2} \right) = (1, \pi) = i
\]
