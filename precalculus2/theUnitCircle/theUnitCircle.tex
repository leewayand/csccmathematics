...
The problem is that this second right triangle is too big. It is supposed to be a right triangle for $c + d \, i$.  That means the sides were suppose to be $c$ and $d$.  The hypotenuse was suppose to be of length $1$, to be a radius on the unit circle. Instead, in our diagram, the bottom leg has length $1$.  
...
\begin{itemize}
  ...
  \item The right side of the encompassing rectangle forms a straight angle and it is cut up into three angles: a right angle, $\beta$ on one side, and $\alpha$ on the other side.
\end{itemize}
...
The sum of the angles of the bottom right triangle is $\theta + \beta + 90^{\circ} = 180^{\circ}$ and the angles forming the straight angle sum to $\theta + \alpha + 90^{\circ} = 180^{\circ}$.  
...
The angles in the top-right right triangle are $\theta$ and $\beta$. 


The bottom right triangle representing $a + b \, i$ and the triangle formed in the upper-right corner of the rectangle are similar triangles.  We can get the lengths of the legs of the top right triangle.
...
The bottom exterior angle is the sum of $\theta$ and $\phi$.  It just our two original angles glued together.
