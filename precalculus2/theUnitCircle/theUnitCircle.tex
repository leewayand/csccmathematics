...
We can also tell something about another angle in this diagram.

\begin{itemize}
  \item The bottom right triangle as a right angle, the angle $\theta$, and then a third angle.
  \item The right side of the rectanghle forms a straight angle and it is cut up into three angles: a right angle, $\theta$ on one side, and then this same third angle.
\end{itemize}


The sum of the angles of the right triangle is $180^{\circ}$ and the angles forming the straight angle sum to $180^{\circ}$.  Plus, both sums contain that same third angle inside the bottom right triangle.  That means, the top angle 
...
We can also tell something about another angle in this diagram. We can get the measurement for angle $A$.

\begin{itemize}
  \item The bottom right triangle as a right angle, the angle $\theta$, and angle $B$.
...
\begin{image}[3in]
  ...
  \draw (2.9,1.5) node {\scriptsize{$A$}};
  \draw (2.9,0.75) node {\scriptsize{$B$}};
  \draw (2.6,2.2) node {\tiny{$\tfrac{d}{c}$}};
