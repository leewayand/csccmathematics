...
Back in the Real Numbers, there was only two directions $0$ and $\pi$ radians.  Therefore, there was only two direction vectors, $\langle 1, 0 \rangle$, which we call $1$ and $\langle -1, 0 \rangle$, which we call $-1$. 


With the Complex Numbers we have an infinite number of directions.
