...
$\blacktriangleright$  $K$ is a composition of a logarithm function and a quadratic function. Therefore, the natural or implied domain is all real numbers that make the inside function, $inside(v)=v^2+2v+3$, greater than $0$.  So, we need some information about $inside(v)=v^2+2v+3$.   
