...
$\blacktriangleright$  $K$ is a logarithm function, therefore, the implied domain is all real numbers that make the inside function, $v^2+2v+3$, greater than $0$.  So, we need some information about $v^2+2v+3$.   Let's give this inner function the name $inside(v) = v^2+2v+3$
...
$\blacktriangleright$  $K(x)$ has no global or local maximum, because $x^2 + 2x + 3$ is unbounded and $ln(t)$ is unbounded.
