...
The minimum value of $inside(v)$ is $inside(-1) = 2$.  Therefore, $inside(v) > 0$ for all $v$. Therefore, all values of $inside(v)$ are in the domain of the natural logarithm.
...
$K(-1) = \ln(2)$ is the minimum value of $K$.  The graph has a lowest point at $(-1, \ln(2))$ and the graph must go up in both directions from there.
...
\[  \lim\limits_{v \to \infty}inside(v) = \infty  \, \text{ and } \,  \lim\limits_{v \to -\infty}inside(v) = \infty  \]
...
$\blacktriangleright$  $K(x)$ has a global minimum of $\ln(2)$, which occurs at $-1$.  This is also the only local minimum, because $K$ is decreasing and then increasing.
