...
We can't even restrict our domain to one period, becasue of the hills and valleys in the graph.

Therefore, our plan is to restrict the domain to half one period of sine.  We can select any interval of length $\pi$.  The usual choice is $\left[-\frac{\pi}{2},\frac{\pi}{2}\right]$.  
...
Therefore, our plan is to restrict the domain to half one period of cosine.  We can select any interval of length $\pi$.  The usual choice is $[0,\pi]$.  
