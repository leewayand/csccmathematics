...
We would like to extend this picture system from one copy of \textbf{$\mathbb{R}$} to two copies of \textbf{$\mathbb{R}$}. \textbf{$\mathbb{R} \times \mathbb{R}$} is shorthand notation for two copies of the real line forming the Cartesian plane.  \textbf{$\mathbb{R}^2$} is even shorter shorthand notation.
