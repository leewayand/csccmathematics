...
\begin{idea} \textbf{\textcolor{blue!55!black}{$\sqrt{-1}$}} 
...
It is feeling like we need two versions of real numbers. Maybe that is the answer. We just need two versions of the real numbers: the old real numbers and the new additional real numbers.
...
We would like to extend this graphical system from one copy of \textbf{$\mathbb{R}$} to two copies of \textbf{$\mathbb{R}$}. 



\begin{center}
\textbf{\textcolor{red!70!darkgray}{We would like to expand this number system from 1-dimension to 2-dimensions.}}
\end{center}
...
\subsection*{2D Operations}


Our plan is to enhance the plane with an arithmetic.  We are just going to adopt the arrow rules.  
...
\begin{example} Vector Subtraction
