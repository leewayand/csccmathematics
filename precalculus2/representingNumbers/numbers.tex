...
Our new numbers also include $\sqrt{-1}$, which the real numbers do not.  So, our new system is actually a larger number system than the real numbers.  In fact, the ``number line'' here is two dimensional.
...
\textbf{\textcolor{red!70!black}{Luckily}}, we have laid the foundation for transitioning to symbols and notation that looks more like what we are used to.   

Most importantly, we have forced the \textbf{\textcolor{purple!85!blue}{distributive property}} to hold.
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Sneak Peek Ahead}} 
...
We want to transition over to that langugage and leave the vector langugage for when we are talking about geometry.
