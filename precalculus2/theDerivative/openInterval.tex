...
We are just getting started with the derivative and the more we examine it, the more intricate it will become. 

We are ready for the next layer to this derivative story. 
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Slope}} 
...
BOth sides matching is a key idea to the derivative.
...
This graph does not have a tangent line at $(-1,-5)$.  When you approach $(-1,-5)$ from the right or left, you get two different lines that describe the graph upon approaching.  They don't match. Both sides do not match each other.
...
Critical numbers are domain numbers where the derivative equals $0$ or does not exist. 
...
We picture maximums and minimums graphically as tops of hills and bottoms of valley, however, there are other places where a function might exhibit a maximum or minimum. 
...
If we just consider slopes of tangent lines, then $-1$ is not a critical number. 


\begin{center}
\textbf{\textcolor{red!70!black}{We would prefer that $-1$ be a critical number for this function.}}
\end{center}
...
\begin{idea} \textbf{\textcolor{blue!55!black}{Changing Behavior}} 
