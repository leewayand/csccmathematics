...
The derivative of a function is another function, which measures the instantaneous rate of change of the original function.


The derivative is a magical tool that encodes relative movement information into arithmetic information. It gives us a way to ``calculate'' increasing and decreasing. 


Calculus will provide a procedure for deriving the derivative of any function.  With the derivative, we will be able to, algebraically, calculate where a function is increasing and decreasing.  This will give us methods for tracking down local maximums and minimums, which is a mostpopular goal in science.
