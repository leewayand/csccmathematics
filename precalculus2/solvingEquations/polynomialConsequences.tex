...
According to the Fundamental Theorem of Algebra, $w(v)$ factors in an odd number of linear factors over the complex numbers.
...
There must be at least one factor without a partner.  This factor cannot have a complex root, because then it would have been paired already.  Therefore, this factor has to correspond to a real root.
