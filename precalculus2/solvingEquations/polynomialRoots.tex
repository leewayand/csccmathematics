...
\begin{theorem} \textbf{\textcolor{-red!75!green}{Conjugate Roots}}   
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright$}}   If $p(x)$ is a polynomial with real coefficients and $z$ is a complex zero, then $p$ must factor like
