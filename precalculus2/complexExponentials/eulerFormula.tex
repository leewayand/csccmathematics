...
One of the biggest surprises in mathematics is the fact that trigonometric functions and exponential functions are the same building blocks, provide we use Complex numbers. \\

To see this, we need another piece of information. \\
