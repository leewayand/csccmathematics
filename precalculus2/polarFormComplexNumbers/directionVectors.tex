...
We do the same thing for the Complex numbers.
...
\begin{center}
\textbf{\textcolor{red!70!black}{How can we do this with rectangular coordinates?}}
\end{center}
...
\begin{example} Unit Coordinate Vectors
...
But, we want just a single vector, not a sum of two vectors. 
...
\[   \left | \left\langle \frac{3}{5}, \frac{4}{5} \right\rangle  \right | = 1   \]
...
\begin{summary} \textbf{\textcolor{red!70!yellow}{All, Every, Each}}  
