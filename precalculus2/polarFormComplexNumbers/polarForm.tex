...
\textbf{\textcolor{red!70!black}{$\blacktriangleright (4, 8)$}}: We represent complex numbers visually with points or dots on the Cartesian plane.  
...
\textbf{\textcolor{red!70!black}{$\blacktriangleright \langle 4, 8 \rangle$}}: We represent complex numbers with vectors.  These are illustrated with arrows on the Cartesian plane.  Algebraically, we write vectors using triangular brackets.
...
\textbf{\textcolor{red!70!darkgray}{$\blacktriangleright 4 + 8 \, i$}}: We represent complex numbers as a 2-dimensional sum.
...
\begin{warning} \textbf{\textcolor{red!70!black}{Context}}
...
$(a, b)$ might represent an interval in the real numbers.  It might represent the coordinates of a point in the Cartesian plane.  
...
We will use the form $a + b \, i$ when we want to express a Complex number.
...
Our number line is now 2-dimensional and we have several ways of representing measurements in these 2 directions.

We are familiar with rectangular measurements. 

We have locations expressed as left/right and up/down distance, $(a,b)$.

We have locations expressed as left/right and up/down movements, $\langle a,b \rangle$.

We have Complex numbers expressed as left/right and up/down distance, $a + b \, i$.

We have a different direction measurement system in addition to rectangular measurements.
...
We need $\theta$ to give us $\tan(\theta) = \frac{8}{4} = 2$, which is approximately $\theta \approx 63.43^{\circ}$ 
...
\begin{warning} \textbf{\textcolor{red!70!black}{Multiple Polar Coordinates}}
...
\begin{warning} \textbf{\textcolor{red!70!black}{Negative ``Distance''}}
...
A full circle is $2\pi$ radians. This is a litte more than $6$, which means $6$ radians is just a little short of a full circle.

A half circle is $\pi$ radians. This is a litte more than $3$, which means $3$ radians is just a little short of a half circle.


From this we can deduce that $1$ radian is a little short of a third of half a circle. A little short of $60^{\circ}$.

One radian is about $57.295^{\circ}$.
...
\begin{tikzpicture}
  \begin{axis}[
          ...
          \addplot [textColor,smooth, domain=(0:5.1),->] {tan(deg(1))*x};
          \addplot [textColor,smooth, domain=(-3.66:0),<-] {tan(deg(2))*x};
          \addplot [textColor,smooth, domain=(-7.9:0),<-] {tan(deg(3))*x};
          \addplot [textColor,smooth, domain=(-5.4:0),<-] {tan(deg(4))*x};
          \addplot [textColor,smooth, domain=(0:2.2),->] {tan(deg(5))*x};
          \addplot [textColor,smooth, domain=(0:7.7),->] {tan(deg(6))*x};
