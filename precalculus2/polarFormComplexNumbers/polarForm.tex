...
\begin{tikzpicture}
  \begin{axis}[
          ...
          \addplot [textColor,smooth, domain=(0:8),->] {tan(deg(1))*x};
          \addplot [textColor,smooth, domain=(0:8),->] {tan(deg(2))*x};
          \addplot [textColor,smooth, domain=(0:8),->] {tan(deg(3))*x};
          \addplot [textColor,smooth, domain=(0:8),->] {tan(deg(4))*x};
          \addplot [textColor,smooth, domain=(0:8),->] {tan(deg(5))*x};
          \addplot [textColor,smooth, domain=(0:8),->] {tan(deg(6))*x};
