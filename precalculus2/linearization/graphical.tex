...
\begin{tikzpicture}
  \begin{axis}[
            xmin=0,xmax=6,ymin=-50,ymax=220,
            axis lines=center,
          ...
          \addplot [very thick, penColor, samples=150,smooth,domain=(0:6)] {x^3 - 50};

          \addplot [very thick, penColor2, domain=(0:5)] {27*(x-3)+77};
          \addplot [very thick, penColor2, domain=(0:5)] {48*(x-4)+114};
          ...
          \node at (axis cs:2,58.3) [penColor] {$f$};
          \node at (axis cs:2,40.3) [penColor2] {$L$};

          \addplot[color=penColor3,fill=penColor3,only marks,mark=*] coordinates{(4,114)};  %% closed hole    
          \addplot[color=penColor3,fill=penColor3,only marks,mark=*] coordinates{(3,77)};  %% closed hole    
