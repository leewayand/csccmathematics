...
\begin{tikzpicture}
  \begin{axis}[
            xmin=0,xmax=5,ymin=0,ymax=200,
            axis lines=center,
            ytick={0, 20, 40, 50, 64, 80, 90, 100},
            yticklabels={0, 20, 40, 50, 64, 80, 90, 100},
            xlabel=$x$, ylabel=$y$,
            every axis y label/.style={at=(current axis.above origin),anchor=south},
            every axis x label/.style={at=(current axis.right of origin),anchor=west},
          ]        
          \addplot [very thick, penColor, samples=150,smooth,domain=(0:5)] {x^3};
