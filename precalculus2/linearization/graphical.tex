...
\begin{tikzpicture}
  \begin{axis}[
            xmin=0,xmax=5,ymin=-55,ymax=100,
            axis lines=center,
            ytick={-50, 0, 20, 40, 50, 64, 80, 90, 100},
            yticklabels={-50, 0, 20, 40, 50, 64, 80, 90, 100},
            xlabel=$x$, ylabel=$y$,
            every axis y label/.style={at=(current axis.above origin),anchor=south},
            every axis x label/.style={at=(current axis.right of origin),anchor=west},
          ]        
          \addplot [very thick, penColor, samples=150,smooth,domain=(0:5)] {x^3 - 50};
          ...
          \node at (axis cs:2,-30) [penColor] {$f$};
          \node at (axis cs:2,40.3) [penColor2] {$L_{3}$};
          \node at (axis cs:2,45.3) [penColor2] {$L_{4}$};
