...
The Complex Numbers are our algebraic view of these 2-dimensional numbers.  In our story, the line between geometry and algebra is very blurry. It is almost like having double vision.  
...
\item We have a algebraic shorthand symbols where $i$ represents $\langle 0, 1 \rangle$.
\item We have our old real numbers, which are embedded in the new system sa horizontal vectors or points on the horizontal axis. $1$ is represented by $\langle 1, 0 \rangle$ and is written as $1 + 0 \, i$.
\end{itemize}
...
We hold all of these views on top of each other simultaneously and use the strength of each to reason.
...
Mathematics has been a part of human thought for thousands of years.  Many people in many different countries have thought about mathematics over centuries.  And, unlike today communication was not easy.  Therefore, we have many groups of people inventing different notation and language for the same thing.  
