...
$\blacktriangleright$ $\langle 1, 0 \rangle$ is often written as $\hat{x}$. It represents a vector of length $1$ pointing in the $x$-direction.

$\blacktriangleright$ $\langle 0, 1 \rangle$ is often written as $\hat{y}$. It represents a vector of length $1$ pointing in the $y$-direction.
