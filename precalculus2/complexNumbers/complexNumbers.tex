...
\item We have our old real numbers, which are embedded in the new system as horizontal vectors or points on the horizontal axis. $1$ is represented by $\langle 1, 0 \rangle$ and is can be written as $1 + 0 \, i$ or just $1$.
\end{itemize}
...
We were looking for this number when studying the quadratic formula.  
...
The length of $\langle a, b \rangle$ equals the modulus of $a + b \, i$, which is $\sqrt{a + b \, i}$
