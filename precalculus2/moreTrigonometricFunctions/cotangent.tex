...
Thus, its reciprocal is the ration of cosine of sine.  It is called \textbf{cotangent}.
...
\begin{tikzpicture} 
  \begin{axis}[
            ...
            \addplot [line width=2, penColor, smooth,samples=100,domain=(-6.26:-3.14), <->] {cot(deg(x))};
            \addplot [line width=2, penColor, smooth,samples=100,domain=(-3.14:0), <->] {cot(deg(x))};
            \addplot [line width=2, penColor, smooth,samples=100,domain=(0:3.14), <->] {cot(deg(x))};
            \addplot [line width=2, penColor, smooth,samples=100,domain=(3.14:6.28), <->] {cot(deg(x))};
