...
This means intercepts at the whol-$\pi$'s and vertical asymptotes at the half-$\pi$'s.
...
In the diagram above, we know that $a = \cos(\theta)$ and $b = \sin(\theta)$ $h = \tan(\theta)$.


The outer line is the hypotenuse for a large right triangle.  That right triangle is cut into two right triangles by the radius of the unit circle.  These two right triangles are similar.
