...
If we divide everything by $(\cos(\theta))^2$, we get some algebraic relationships for our new functions.
...
\begin{example} Square Roots of Differences
...
\begin{example} Square Roots of Sums
...
This situation comes in three types.
