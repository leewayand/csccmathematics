...
Consider the fraction $\frac{A}{B}$.  The \textbf{reciprocal} of this fraction is the fraction $\frac{B}{A}$.
...
However, if $A= 0$, then the reciprocal of $\frac{A}{B}$ would not be a fraction, because its denominator would be $A$, which equals $0$.
...
$-1$ and $1$ are the only numbers that equal their own reciprocal. 
...
The domain of $g$ does not include $2$, since that would make the denominator equal to $0$. 
...
\begin{fact} \textbf{\textcolor{red!75!green}{Sign}} 
...
Consider the two quotient functions from the previous example.
...
The fraction for $f$ becomes greater as the domain becomes greater. 

That means its reciprocal becomes lesser as the domain becomes greater. 
...
\begin{fact} \textbf{\textcolor{red!75!green}{Behavior}} 
