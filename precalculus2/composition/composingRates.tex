...
Rate of Change is our measurement of \textbf{function behavior}.
...
$\vartriangleright$ That means that when the numbers going into $F$ are becoming greater, then the numbers coming out of $F$ are becoming greater. 

$\vartriangleright$ That means that when the numbers going into $G$ are becoming greater, then the numbers coming out of $G$ are becoming greater. 
...
Suppose the numbers going in $F \circ G$ are becoming greater.  What are the output numbers doing? 
...
Pretend that the values of $x$ are becoming greater. Then the values of $G(x)$ are becoming greater, since $G$ is an increasing function.

These values of $G(x)$, which are becoming greater, are going into $F$.  Therefore, the output of $F$ is becoming greater.  But, these are the values of the composition.
...
$\vartriangleright$ It also means that when the numbers going into $F$ are becoming lesser, then the numbers coming out of $F$ are becoming lesser. 



$\vartriangleright$ That means that when the numbers going into $G$ are becoming greater, then the numbers coming out of $G$ are becoming lesser. 
...
Pretend that the values of $x$ are becoming greater. Then the values of $G(x)$ are becoming lesser, since $G$ is a decreasing function.

These values of $G(x)$, which are becoming lesser, are going into $F$.  Therefore, the output of $F$ is becoming lesser, since $F$ is an increasing function.  But, these are the values of the composition.
...
$\vartriangleright$ That means that when the numbers going into $F$ are becoming greater, then the numbers coming out of $F$ are becoming lesser. 

$\vartriangleright$ It also means that when the numbers going into $F$ are becoming lesser, then the numbers coming out of $F$ are becoming greater. 
...
$\vartriangleright$ It also means that when the numbers going into $G$ are becoming lesser, then the numbers coming out of $G$ are becoming lesser. 
...
Pretend that the values of $x$ are becoming greater. Then the values of $G(x)$ are becoming greater, since $G$ is a increasing function.

These values of $G(x)$, which are becoming greater, are going into $F$.  Therefore, the output of $F$ is becoming lesser, since $F$ is an decreasing function.  But, these are the values of the composition.
...
$\vartriangleright$ It also means that when the numbers going into $G$ are becoming lesser, then the numbers coming out of $G$ are becoming greater. 
...
Pretend that the values of $x$ are becoming greater. Then the values of $G(x)$ are becoming lesser, since $G$ is an decreasing function.

These values of $G(x)$, which are becoming lesser, are going into $F$.  Therefore, the output of $F$ is becoming greater, because $F$ is a decreasing function.  But, these are the values of the composition.
...
where $F(t) = e^t$ and $G(w) = -(w+3)^2$.


$F$ is a core exponential function with a base greater than $1$, so it is an increasing function.


$G$ is a quadratic function with a negative leading coefficient. It increases and then decreases, switching at $-3$.

$G$ is increasing on $(-\infty, -3)$.\\
$G$ is decreasing on $(-3, \infty)$.



On $(-\infty, -3)$, $F \circ G = inc \circ inc = inc$.

On $(-3, \infty)$, $F \circ G = inc \circ dec = dec$.
...
Since the function values of $F$ are domain values of $G$, we need to know where $F = -3$.

$F(t) = -3$ has no solution, because the values of $F$ are always positive. In the composition, the values of $F$ will always be in $(-3, \infty)$, where $G$ is decreasing.



On $(-\infty, \infty)$, $F \circ G = inc \circ dec = dec$.
...
\[  \ln(x^2 + 3x + 5)   = (H \circ M)(x)\]

where $H(w) = \ln(w)$ and $M(t) = x^2 + 3x + 5$.


$H$ is a core loagrithmic function with a base greater than $1$, so it is an increasing function.


$M$ is a quadratic function with a positive leading coefficient. It decreases and then increases, switching at $-\frac{3}{2}$.

$M$ is decreasing on $\left( -\infty, -\frac{3}{2} \right)$.\\
$M$ is increasing on $\left( -\frac{3}{2}, \infty \right)$.
...
On $\left( -\infty, -\frac{3}{2} \right)$, $H \circ M = inc \circ dec = dec$.


On $\left( -\frac{3}{2}, \infty \right)$, $H \circ M = inc \circ inc = inc$.
...
\begin{example}   Quartic Polynomial
...
Both $F$ and $G$ have a positive leading coefficient.  Therefore, they both decrease and then increase. The derivative will reveal the specifics.
...
\textbf{\textcolor{purple!85!blue}{$\blacktriangleright$}} \textbf{\textcolor{purple!85!blue}{Overlaping Intervals}}  
...
\begin{center}
\textbf{\textcolor{red!70!black}{Wonderful !!!}}
\end{center}
