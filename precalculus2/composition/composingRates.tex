...
$F(t) = -3$ has no solution, because hte values of $F$ are always positive. In the composition, the values of $F$ will always be in $(-3, \infty)$, where $G$ is decreasing.
