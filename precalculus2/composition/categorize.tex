...
If a function is one of our elementary functions, then that is how we would like ot categorize it. If a function is not one of our elementary functions, then our next preference is to see it ias an operation.
...
\textbf{Note:} A constant multiple is a product in which one factor is a constant. This distinciton is just helpful for Calculus.
