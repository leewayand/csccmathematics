...
The range of $g$ is $(-4, 2)$.  However, the domain of $f$ is $(0, 6)$.   We cannot use the whole range of $g$, which means we camnnot use the whole domain of $g$.  Which part of the domain of $g$ does $g$ map into $(0, 6)$? \\
