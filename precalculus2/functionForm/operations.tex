...
When categorizing a function by its formula, our first thought is that the function is an elementary function and we would categorize it from our library. 

\textbf{That is step 1).}  If is an elementary function, than that is how we would like categorize it.


If it is not, then we turn to \textbf{That is step 2)}.



If it is not an elementary function, then we turn to the arithmtic structure of the expression where the \textbf{Order of Operations} dictates how we view the algebra. 
...
If  $f$ is a function and $A$ is a constant, then $A \, f$ is called a \textbf{constant multiple} of $f$. 
...
If  $f$ and $g$ are functions, then $f + g$ is called the \textbf{sum} of $f$ and $g$. 
...
If $f$ or $g$ belongs to a nice category of elementary functions, their sum usually does not.
...
If  $f$ and $g$ are functions, then $f - g$ is called the \textbf{difference} of $f$ and $g$. 
...
If $f$ or $g$ belongs to a nice category of elementary functions, their difference usually does not.
...
If  $f$ and $g$ are functions, then $f \cdot g$, or just $f g$, is called the \textbf{product} of $f$ and $g$. 
...
If $f$ or $g$ belongs to a nice category of elementary functions, their product usually does not.
...
If  $f$ and $g$ are functions, then $\frac{f}{g}$ is called the \textbf{quotient} of $f$ and $g$. 
...
If $f$ or $g$ belongs to a nice category of elementary functions, their quotient usually does not.
...
They could just be part of a larger formula.
