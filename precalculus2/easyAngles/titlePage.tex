...
The values of sine and cosine vary between $-1$ and $1$.  This means they take on every value in the interval $[-1, 1]$.  However, it is rare that the angle and the value of either function are both nice. 


For us ``nice'' means a fraction involving whole numbers, $\pi$ or square roots. 
