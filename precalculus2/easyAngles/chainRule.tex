...
\begin{center}
The third quadrant of sine corresponds to $\left( \frac{3}{2} - \frac{3\pi}{2}, \frac{3}{2} - \frac{\pi}{2} \right)$.
...
\begin{center}
The fourth quadrant of sine corresponds to $\left( \frac{3}{2} - \pi, \frac{3}{2} - \frac{3\pi}{2} \right)$.
...
\textbf{\textcolor{blue!55!black}{On $\left( \frac{3}{2} - \pi, \frac{3}{2} - \frac{3\pi}{2} \right)$}} $H$ is decreasing.


\textbf{\textcolor{blue!55!black}{On $\left( \frac{3}{2} - \frac{3\pi}{2}, \frac{3}{2} - \frac{\pi}{2} \right)$}} $H$ is increasing.
...
\begin{tikzpicture}
  \begin{axis}[
            ...
            axis on top
			   ...
			   \addplot [line width=2, penColor, smooth,samples=200,domain=(-6:7)] {0.5*sin(deg(3-2*x)) - 4};

          \addplot [line width=2, penColor2, smooth,samples=200,domain=(-1.64:1.5)] {0.5*sin(deg(3-2*x)) - 4};
