...
As a segue from the first half of Precalculus, let's quickly review our growing library of Elementary Functions, which are compositions of the Core Funcitons with linear functions.


\subsection*{Core Functions} 

The Core Functions are our basic building blocks. The Elementary Functions will grow out of the Core Functions.
...
Algebraically, the constant term, ``+ D'', cannot be absorbed into the exponential form.  However, shifting functions is a very common operation and so, we'll include $A \cdot r^{B \, x + C} + D$ in our general ideas of exponential functions.
