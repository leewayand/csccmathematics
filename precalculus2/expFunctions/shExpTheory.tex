...
\begin{definition} \textbf{\textcolor{green!50!black}{Basic Shifted Exponential Functions}}
...
\begin{itemize}
\item Let $L_{out}(u) = \frac{1}{3} \, u - 7$, an increasing linear function
\item Let $E(t) = 2^t$, an increasing core shifted exponential function
\item Let $L_{in}(v) = v + 2$, an increasing linear function
\end{itemize}


\[
f(x) = \frac{1}{3} \cdot \, 2^{x+5} - 7 = (L_{out}(u) \circ E \circ L_{in}(u))(x)
\]
...
\item Let $E(x) = \left( \frac{2}{3} \right)^x$, a decreasing core shifted exponential function
\item Let $L_{in}(v) = 3 - v$, a decreasing linear function
\end{itemize}


\[
B(t) = -2 \, \left( \frac{2}{3} \right)^{3-t} + 4 = (L_{out}(u) \circ E \circ L_{in}(u))(t)
\]
