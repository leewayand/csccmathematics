...
If $r > 1$, core exponential functions tend to $0$ as the domain becomes unbounded negatively. Core exponential functions tend to $\infty$ as the domain becomes unbounded positively.
