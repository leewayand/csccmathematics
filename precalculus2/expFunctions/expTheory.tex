...
When $r$ \wordChoice{\choice[correct]{$<$} \choice{$>$}} $1$, the horizontal axis is still a horizontal asymptote, just iin the direction where $x$ is large and positive. The function now decays.
