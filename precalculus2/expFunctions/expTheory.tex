...
\[ \lim\limits_{t \to -\infty} \frac{2}{3}^{-t} = 0 \]
...
\[ \lim\limits_{t \to \infty} \frac{2}{3}^{-t} = \lim\limits_{t \to \infty} \frac{3}{2}^t = \infty \]
...
Since $a = -2 < 0$ these smaller/larger values of $-2 \, \frac{2}{3}^{-t}$ are smaller/larger negative values.
