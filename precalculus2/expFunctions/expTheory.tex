...
\textbf{\textcolor{purple!85!blue}{Basic formula dissection:}}  \\
...
This is a transformed version of the basic exponential function template $\left( \frac{2}{3} \right)^{-t} = \frac{3}{2}^t$.  
...
\[ \lim\limits_{t \to -\infty} \left( \frac{2}{3}^{-t} \right) = 0 \]
...
\[ \lim\limits_{t \to \infty} \left( \frac{2}{3}^{-t} \right) = \lim\limits_{t \to \infty} \left( \frac{3}{2}^t \right) = \infty \]
...
Since $a = -2 < 0$ these smaller/larger values of $-2 \, \left( \frac{2}{3}^{-t} \right)$ are smaller/larger negative values.
...
In the example above, could have algebraically moved the horizontal shift to the leading coefficient.
...
We could have further transferred the negative sign in the exponent to the base by reciprocating the base.
...
Algebra provides many tools for modifying the representation. \\
