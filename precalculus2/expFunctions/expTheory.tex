...
Constant percentage growth means that the value  of our function grows by equal percentage over equal size intervals in the domain.
...
Graphs of basic exponential functions have one strategic point, which occurs when the exponent equals zero. For the basic exponential function, this point is $(0, a)$.
...
$f(x) = \frac{1}{3} \, 2^{x+5} - 7$ is the funciton in the last example.  We could take advantage of exponential algebra to simplify the formula.   \\
