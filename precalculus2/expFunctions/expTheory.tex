...
The functions with these graphs are all described by a similar formula we call the basic exponential formula.
...
\item In the other direction, they grow unbounded. This depends on the sign of $a$.
...
The other direction ios where the shifted exponential function is uunbounded.  Since the leading coefficient of $f$ is positive, $f$ is unbounded positively. \\
