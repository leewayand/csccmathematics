...
By the Mean Value Theorem, there exists $c$ in $(0,10)$ such that $f'(c) = 1$.  In fact, this happens twice: when $c_1=\answer{\frac{5}{2}}$ and when $c_2=\answer{\frac{15}{2}}$ (assume $c_1<c_2$).
