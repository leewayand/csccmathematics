...
\begin{exercise}
  ...
  side.  What is the largest possible area (in square feet)?
...
\end{hint}
\begin{hint}
We have to find all the critical numbers of $A$ on $[0,50]$.
Since

$A'(x)=\answer{100}-4x$,

it follows that  the function $A$ has its only critical number at $x=\answer{25}$.

\end{hint}
\begin{hint}
We have to evaluate $A$ at the end points and the critical number.
