...
The known rate is
 \[
\dfrac{d\theta=\answer{ - 0.25}}{dt} \text{  rad}/hr
\]

The  rate  to be determined is
\[
\dfrac{\answer{x}}{dt} \text{    , when    } \theta=\frac{\pi}{6}
\]
...
\[
\answer{\sec^{2}{(\theta)}}\cdot \frac{d\answer{\theta}}{dt} =\answer{-72/x^{2}} \cdot \frac{d\answer{x}}{dt} 
\]
...
Solve for $ \left[\frac{dx}{dt} \right]_{\theta=\frac{\pi}{6}}$.
