...
\node[right, penColor] at (.4,5.6) {$\frac{dV}{dt} = 10$ cm$^3$/sec;};
\node[right, penColor2] at (3.9,5.6) {$\frac{dh}{dt} = $ ?, when $h=4$ cm};
...
\[
\frac{dV}{dt} = \frac{\pi}{27} \cdot 3\cdot h^2\cdot \frac{dh}{dt}.
\]
