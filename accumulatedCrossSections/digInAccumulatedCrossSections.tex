...
\[
V = \int_{y=\answer[given]{-3}}^{y=\answer[given]{15}} \answer[given]{\frac{1}{2} \pi\left(\frac{5}{2} - \frac{1}{6}y\right)^2} dy.
\]
...
\[V= \int_{y= 0}^{y=1}\frac{\sqrt{3}}{4} dy + \int_{y= 1}^{y=e} \frac{\sqrt{3}}{4}(1-\ln(y))^2 dy \]
