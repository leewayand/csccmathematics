...
of) the real numbers (denoted by $\mathbb{R}$) to (a subset of) the real
numbers.

\begin{definition}
  We call the set of the inputs of a function the
  \textbf{domain}\index{domain}, and we call the set of the outputs of a
  function the \textbf{range}\index{range}.
\end{definition}
...
numbers, denoted by $\mathbb{R}$. In our next examples we show that this is
not always the case.
